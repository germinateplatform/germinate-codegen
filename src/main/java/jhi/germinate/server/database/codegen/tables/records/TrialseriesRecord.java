...
public class TrialseriesRecord extends UpdatableRecordImpl<TrialseriesRecord> implements Record4<Integer, String, Timestamp, Timestamp> {
    ...
    private static final long serialVersionUID = -1848457356;

    /**
     * Setter for <code>germinate_db.trialseries.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Getter for <code>germinate_db.trialseries.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Setter for <code>germinate_db.trialseries.seriesname</code>. The description of the trial series name.
     */
    ...
    /**
     * Getter for <code>germinate_db.trialseries.seriesname</code>. The description of the trial series name.
     */
    ...
    /**
     * Setter for <code>germinate_db.trialseries.created_on</code>. When the record was created.
     */
    ...
    /**
     * Getter for <code>germinate_db.trialseries.created_on</code>. When the record was created.
     */
    ...
    /**
     * Setter for <code>germinate_db.trialseries.updated_on</code>. When the record was updated. This may be different from the created on date if changes have been made subsequently to the underlying record.
     */
    ...
    /**
     * Getter for <code>germinate_db.trialseries.updated_on</code>. When the record was updated. This may be different from the created on date if changes have been made subsequently to the underlying record.
     */
