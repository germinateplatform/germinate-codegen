...
public class ViewTableDatasetAttributesRecord extends TableRecordImpl<ViewTableDatasetAttributesRecord> implements Record10<Integer, String, String, Integer, String, String, ViewTableDatasetAttributesAttributeType, String, Integer, String> {
    ...
    /**
     * Getter for <code>germinate_db.view_table_dataset_attributes.dataset_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_dataset_attributes.dataset_name</code>. Describes the dataset.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_dataset_attributes.dataset_name</code>. Describes the dataset.
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_dataset_attributes.dataset_description</code>. The name of this dataset.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_dataset_attributes.dataset_description</code>. The name of this dataset.
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_dataset_attributes.attribute_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_dataset_attributes.attribute_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_dataset_attributes.attribute_name</code>. Defines the name of the attribute.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_dataset_attributes.attribute_name</code>. Defines the name of the attribute.
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_dataset_attributes.attribute_description</code>. Describes the attribute. This should expand on the name to make it clear what the attribute actually is.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_dataset_attributes.attribute_description</code>. Describes the attribute. This should expand on the name to make it clear what the attribute actually is.
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_dataset_attributes.target_table</code>.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_dataset_attributes.target_table</code>.
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_dataset_attributes.foreign_id</code>. Foreign key to germinatebase (germinatebase.id).
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_dataset_attributes.foreign_id</code>. Foreign key to germinatebase (germinatebase.id).
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_dataset_attributes.attribute_value</code>. The value of the attribute.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_dataset_attributes.attribute_value</code>. The value of the attribute.
     */
