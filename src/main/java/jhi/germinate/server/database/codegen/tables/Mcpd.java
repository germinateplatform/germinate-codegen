...
public class Mcpd extends TableImpl<McpdRecord> {
     ...
     */
    public final TableField<McpdRecord, Timestamp> CREATED_ON = createField(DSL.name("created_on"), SQLDataType.TIMESTAMP(0).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMP)), this, "Date and time when this record was created.");

    /**
     * The column <code>germinate_db.mcpd.updated_on</code>. Timestamp of the
     * last update to this record.
     */
    public final TableField<McpdRecord, Timestamp> UPDATED_ON = createField(DSL.name("updated_on"), SQLDataType.TIMESTAMP(0).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMP)), this, "Timestamp of the last update to this record.");

    private Mcpd(Name alias, Table<McpdRecord> aliased) {
        this(alias, aliased, (Field<?>[]) null, null);
    }

    private Mcpd(Name alias, Table<McpdRecord> aliased, Field<?>[] parameters, Condition where) {
    ...
    @Override
    public Mcpd as(Table<?> alias) {
        return new Mcpd(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public Mcpd rename(Table<?> name) {
        return new Mcpd(name.getQualifiedName(), null);
    }
     ...
     */
    @Override
    public Mcpd where(Condition condition) {
        return new Mcpd(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public Mcpd where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public Mcpd where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public Mcpd where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public Mcpd where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public Mcpd where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public Mcpd where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public Mcpd where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public Mcpd whereExists(Select<?> select) {
     ...
     */
    @Override
    public Mcpd whereNotExists(Select<?> select) {
