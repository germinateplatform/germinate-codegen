...
public class GroupmembersRecord extends UpdatableRecordImpl<GroupmembersRecord> implements Record5<Integer, Integer, Integer, Timestamp, Timestamp> {
    ...
    private static final long serialVersionUID = 1189105435;

    /**
     * Setter for <code>germinate_db.groupmembers.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Getter for <code>germinate_db.groupmembers.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Setter for <code>germinate_db.groupmembers.foreign_id</code>. Foreign key to [table] ([table].id).
     */
    ...
    /**
     * Getter for <code>germinate_db.groupmembers.foreign_id</code>. Foreign key to [table] ([table].id).
     */
    ...
    /**
     * Setter for <code>germinate_db.groupmembers.group_id</code>. Foreign key to groups (groups.id).
     */
    ...
    /**
     * Getter for <code>germinate_db.groupmembers.group_id</code>. Foreign key to groups (groups.id).
     */
    ...
    /**
     * Setter for <code>germinate_db.groupmembers.created_on</code>. When the record was created.
     */
    ...
    /**
     * Getter for <code>germinate_db.groupmembers.created_on</code>. When the record was created.
     */
    ...
    /**
     * Setter for <code>germinate_db.groupmembers.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Getter for <code>germinate_db.groupmembers.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
