...
public class ClimatesRecord extends UpdatableRecordImpl<ClimatesRecord> implements Record8<Integer, String, String, String, ClimatesDatatype, Integer, Timestamp, Timestamp> {
    ...
    /**
     * Getter for <code>germinate_db.climates.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Setter for <code>germinate_db.climates.name</code>. Describes the climate.
     */
    ...
    /**
     * Getter for <code>germinate_db.climates.name</code>. Describes the climate.
     */
    ...
    /**
     * Setter for <code>germinate_db.climates.short_name</code>. Shortened version of the climate name which is used in some table headers.
     */
    ...
    /**
     * Getter for <code>germinate_db.climates.short_name</code>. Shortened version of the climate name which is used in some table headers.
     */
    ...
    /**
     * Setter for <code>germinate_db.climates.description</code>. A longer description of the climate.
     */
    ...
    /**
     * Getter for <code>germinate_db.climates.description</code>. A longer description of the climate.
     */
    ...
    /**
     * Setter for <code>germinate_db.climates.unit_id</code>. Foreign key to units (units.id).
    ...
    /**
     * Getter for <code>germinate_db.climates.unit_id</code>. Foreign key to units (units.id).
    ...
    /**
     * Setter for <code>germinate_db.climates.created_on</code>. When the record was created.
     */
    ...
    /**
     * Getter for <code>germinate_db.climates.created_on</code>. When the record was created.
     */
    ...
    /**
     * Setter for <code>germinate_db.climates.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Getter for <code>germinate_db.climates.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
