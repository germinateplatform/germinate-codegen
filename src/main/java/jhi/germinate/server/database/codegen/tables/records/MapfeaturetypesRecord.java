...
public class MapfeaturetypesRecord extends UpdatableRecordImpl<MapfeaturetypesRecord> implements Record4<Integer, String, Timestamp, Timestamp> {
    ...
    private static final long serialVersionUID = -356269670;

    /**
     * Setter for <code>germinate_db.mapfeaturetypes.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Getter for <code>germinate_db.mapfeaturetypes.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Setter for <code>germinate_db.mapfeaturetypes.description</code>. Description of the feature type. This could include a definition of the marker type such as 'SNP', 'KASP' or 'AFLP'.
     */
    ...
    /**
     * Getter for <code>germinate_db.mapfeaturetypes.description</code>. Description of the feature type. This could include a definition of the marker type such as 'SNP', 'KASP' or 'AFLP'.
     */
    ...
    /**
     * Setter for <code>germinate_db.mapfeaturetypes.created_on</code>. When the record was created.
     */
    ...
    /**
     * Getter for <code>germinate_db.mapfeaturetypes.created_on</code>. When the record was created.
     */
    ...
    /**
     * Setter for <code>germinate_db.mapfeaturetypes.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Getter for <code>germinate_db.mapfeaturetypes.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
