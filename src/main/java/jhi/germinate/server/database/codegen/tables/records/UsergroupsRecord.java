...
public class UsergroupsRecord extends UpdatableRecordImpl<UsergroupsRecord> implements Record5<Integer, String, String, Timestamp, Timestamp> {
    ...
    private static final long serialVersionUID = -442527735;
    ...
    /**
     * Setter for <code>germinate_db.usergroups.name</code>. The name of the user group.
     */
    ...
    /**
     * Getter for <code>germinate_db.usergroups.name</code>. The name of the user group.
     */
    ...
    /**
     * Setter for <code>germinate_db.usergroups.description</code>. A description of the user group.
     */
    ...
    /**
     * Getter for <code>germinate_db.usergroups.description</code>. A description of the user group.
     */
    ...
    /**
     * Setter for <code>germinate_db.usergroups.created_on</code>. When the record was created.
     */
    ...
    /**
     * Getter for <code>germinate_db.usergroups.created_on</code>. When the record was created.
     */
    ...
    /**
     * Setter for <code>germinate_db.usergroups.updated_on</code>. When the record was updated. This may be different from the created on date if changes have been made subsequently to the underlying record.
     */
    ...
    /**
     * Getter for <code>germinate_db.usergroups.updated_on</code>. When the record was updated. This may be different from the created on date if changes have been made subsequently to the underlying record.
     */
