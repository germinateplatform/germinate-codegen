...
public class ViewTableTrialsData extends TableImpl<ViewTableTrialsDataRecord> {
    ...
    private static final long serialVersionUID = 814930144;
    ...
    /**
     * The column <code>germinate_db.view_table_trials_data.germplasm_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_trials_data.germplasm_gid</code>. A unique identifier.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_trials_data.germplasm_name</code>. A unique name which defines an entry in the germinatbase table.
     */
     ...
     */
    public final TableField<ViewTableTrialsDataRecord, String[]> GERMPLASM_SYNONYMS = createField("germplasm_synonyms", org.jooq.impl.DefaultDataType.getDefaultDataType("\"germinate_template_4_21_11_08\".\"view_table_trials_data_germplasm_synonyms\""), this, "The synonyms as a json array.", new SynonymBinding());
    ...
    /**
     * The column <code>germinate_db.view_table_trials_data.entity_parent_general_identifier</code>. A unique identifier.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_trials_data.entity_type</code>. The name of the entity type.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_trials_data.dataset_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_trials_data.dataset_name</code>. Describes the dataset.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_trials_data.dataset_description</code>. The name of this dataset.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_trials_data.location_name</code>. The site name where the location is.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_trials_data.country_name</code>. Country name.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_trials_data.country_code2</code>. ISO 2 Code for country.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_trials_data.trait_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_trials_data.trait_name</code>. Phenotype full name.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_trials_data.trait_name_short</code>. Shortened name for the phenotype. This is used in table columns where space is an issue.
     */
     ...
     */
    public final TableField<ViewTableTrialsDataRecord, TraitRestrictions> TRAIT_RESTRICTIONS = createField("trait_restrictions", org.jooq.impl.DefaultDataType.getDefaultDataType("\"germinate_template_4_21_11_08\".\"view_table_trials_data_trait_restrictions\""), this, "A json object describing the restrictions placed on this trait. It is an object containing a field called \"categories\" which is an array of arrays, each describing a categorical scale. Each scale must have the same length as they describe the same categories just using different terms or numbers. The other fields are \"min\" and \"max\" to specify upper and lower limits for numeric traits.", new TraitRestrictionBinding());
    ...
    /**
     * The column <code>germinate_db.view_table_trials_data.trait_value</code>. The phenotype value for this phenotype_id and germinatebase_id combination.
     */
    ...
    /**
     * Create a <code>germinate_db.view_table_trials_data</code> table reference
     */
    ...
    /**
     * Create an aliased <code>germinate_db.view_table_trials_data</code> table reference
     */
