...
public class ViewTableTrialsData extends TableImpl<ViewTableTrialsDataRecord> {
    ...
    private static final long serialVersionUID = -94796512;
     ...
     */
    public final TableField<ViewTableTrialsDataRecord, String[]> GERMPLASM_SYNONYMS = createField("germplasm_synonyms", org.jooq.impl.DefaultDataType.getDefaultDataType("\"germinate_template_4_22_03_08\".\"view_table_trials_data_germplasm_synonyms\""), this, "The synonyms as a json array.", new SynonymBinding());
     ...
     */
    public final TableField<ViewTableTrialsDataRecord, TraitRestrictions> TRAIT_RESTRICTIONS = createField("trait_restrictions", org.jooq.impl.DefaultDataType.getDefaultDataType("\"germinate_template_4_22_03_08\".\"view_table_trials_data_trait_restrictions\""), this, "A json object describing the restrictions placed on this trait. It is an object containing a field called \"categories\" which is an array of arrays, each describing a categorical scale. Each scale must have the same length as they describe the same categories just using different terms or numbers. The other fields are \"min\" and \"max\" to specify upper and lower limits for numeric traits.", new TraitRestrictionBinding());
