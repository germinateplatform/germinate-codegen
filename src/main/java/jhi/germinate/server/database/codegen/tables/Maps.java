...
public class Maps extends TableImpl<MapsRecord> {
    ...
    private static final long serialVersionUID = -432233612;
    ...
    /**
     * The column <code>germinate_db.maps.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.maps.description</code>. The name of this map.
     */
    ...
    /**
     * The column <code>germinate_db.maps.visibility</code>. Determines if the map is visible to the Germinate interface or hidden.
     */
    ...
    /**
     * The column <code>germinate_db.maps.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.maps.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    public final TableField<MapsRecord, Timestamp> UPDATED_ON = createField("updated_on", org.jooq.impl.SQLDataType.TIMESTAMP.defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.");

    /**
     * The column <code>germinate_db.maps.user_id</code>. Foreign key to Gatekeeper users (Gatekeeper users.id).
     */
    ...
    public Identity<MapsRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Maps.MAPS, jhi.germinate.server.database.codegen.tables.Maps.MAPS.ID);
    }
    ...
    public UniqueKey<MapsRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Maps.MAPS, "KEY_maps_PRIMARY", jhi.germinate.server.database.codegen.tables.Maps.MAPS.ID);
    }
    ...
    public List<UniqueKey<MapsRecord>> getKeys() {
        return Arrays.<UniqueKey<MapsRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Maps.MAPS, "KEY_maps_PRIMARY", jhi.germinate.server.database.codegen.tables.Maps.MAPS.ID)
        );
    }
