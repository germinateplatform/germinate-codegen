...
public class MarkertypesRecord extends UpdatableRecordImpl<MarkertypesRecord> implements Record4<Integer, String, Timestamp, Timestamp> {
    ...
    private static final long serialVersionUID = -2001975575;

    /**
     * Setter for <code>germinate_db.markertypes.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Getter for <code>germinate_db.markertypes.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Setter for <code>germinate_db.markertypes.description</code>. Describes the marker type. Markers (markers) have a defined type. This could be AFLP, MicroSat, SNP and so on.
     */
    ...
    /**
     * Getter for <code>germinate_db.markertypes.description</code>. Describes the marker type. Markers (markers) have a defined type. This could be AFLP, MicroSat, SNP and so on.
     */
    ...
    /**
     * Setter for <code>germinate_db.markertypes.created_on</code>. When the record was created.
     */
    ...
    /**
     * Getter for <code>germinate_db.markertypes.created_on</code>. When the record was created.
     */
    ...
    /**
     * Setter for <code>germinate_db.markertypes.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Getter for <code>germinate_db.markertypes.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
