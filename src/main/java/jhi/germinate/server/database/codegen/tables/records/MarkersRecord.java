...
public class MarkersRecord extends UpdatableRecordImpl<MarkersRecord> implements Record5<Integer, Integer, String, Timestamp, Timestamp> {
    ...
    private static final long serialVersionUID = 1122387489;

    /**
     * Setter for <code>germinate_db.markers.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Getter for <code>germinate_db.markers.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Setter for <code>germinate_db.markers.markertype_id</code>. Foreign key to locations (locations.id).
     */
    ...
    /**
     * Getter for <code>germinate_db.markers.markertype_id</code>. Foreign key to locations (locations.id).
     */
    ...
    /**
     * Setter for <code>germinate_db.markers.marker_name</code>. The name of the marker. This should be a unique name which identifies the marker.
     */
    ...
    /**
     * Getter for <code>germinate_db.markers.marker_name</code>. The name of the marker. This should be a unique name which identifies the marker.
     */
    ...
    /**
     * Setter for <code>germinate_db.markers.created_on</code>. When the record was created.
    ...
    /**
     * Getter for <code>germinate_db.markers.created_on</code>. When the record was created.
    ...
    /**
     * Setter for <code>germinate_db.markers.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Getter for <code>germinate_db.markers.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
