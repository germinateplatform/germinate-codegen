...
public class Locales extends TableImpl<LocalesRecord> {
    ...
    private static final long serialVersionUID = 715715986;
    ...
    /**
     * The column <code>germinate_db.locales.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.locales.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    public Identity<LocalesRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Locales.LOCALES, jhi.germinate.server.database.codegen.tables.Locales.LOCALES.ID);
    }
    ...
    public UniqueKey<LocalesRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Locales.LOCALES, "KEY_locales_PRIMARY", jhi.germinate.server.database.codegen.tables.Locales.LOCALES.ID);
    }
    ...
    public List<UniqueKey<LocalesRecord>> getKeys() {
        return Arrays.<UniqueKey<LocalesRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Locales.LOCALES, "KEY_locales_PRIMARY", jhi.germinate.server.database.codegen.tables.Locales.LOCALES.ID)
        );
    }
