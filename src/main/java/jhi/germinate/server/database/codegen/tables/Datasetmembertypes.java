...
public class Datasetmembertypes extends TableImpl<DatasetmembertypesRecord> {
    ...
    private static final long serialVersionUID = -1610230391;
    ...
    /**
     * The column <code>germinate_db.datasetmembertypes.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.datasetmembertypes.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Create an aliased <code>germinate_db.datasetmembertypes</code> table reference
     */
    ...
    public Identity<DatasetmembertypesRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Datasetmembertypes.DATASETMEMBERTYPES, jhi.germinate.server.database.codegen.tables.Datasetmembertypes.DATASETMEMBERTYPES.ID);
    }
    ...
    public UniqueKey<DatasetmembertypesRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Datasetmembertypes.DATASETMEMBERTYPES, "KEY_datasetmembertypes_PRIMARY", jhi.germinate.server.database.codegen.tables.Datasetmembertypes.DATASETMEMBERTYPES.ID);
    }
    ...
    public List<UniqueKey<DatasetmembertypesRecord>> getKeys() {
        return Arrays.<UniqueKey<DatasetmembertypesRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Datasetmembertypes.DATASETMEMBERTYPES, "KEY_datasetmembertypes_PRIMARY", jhi.germinate.server.database.codegen.tables.Datasetmembertypes.DATASETMEMBERTYPES.ID)
        );
    }
