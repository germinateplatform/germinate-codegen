...
public class ViewTableProjects extends TableImpl<ViewTableProjectsRecord> {
    ...
    private ViewTableProjects(Name alias, Table<ViewTableProjectsRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.view("create view `view_table_projects` as select `germinate_template_5_26_01_28`.`projects`.`id` AS `project_id`,`germinate_template_5_26_01_28`.`projects`.`name` AS `project_name`,`germinate_template_5_26_01_28`.`projects`.`description` AS `project_description`,`germinate_template_5_26_01_28`.`projects`.`page_content` AS `project_page_content`,`germinate_template_5_26_01_28`.`projects`.`external_url` AS `project_external_url`,`germinate_template_5_26_01_28`.`projects`.`image_id` AS `project_image_id`,`germinate_template_5_26_01_28`.`projects`.`start_date` AS `project_start_date`,`germinate_template_5_26_01_28`.`projects`.`end_date` AS `project_end_date`,`germinate_template_5_26_01_28`.`projects`.`created_on` AS `project_created_on`,`germinate_template_5_26_01_28`.`projects`.`updated_on` AS `project_updated_on`,json_arrayagg(json_object('datasetId',`germinate_template_5_26_01_28`.`datasets`.`id`,'datasetName',`germinate_template_5_26_01_28`.`datasets`.`name`,'datasetType',`germinate_template_5_26_01_28`.`datasettypes`.`description`,'datasetIsExternal',`germinate_template_5_26_01_28`.`datasets`.`is_external`)) AS `datasets` from (((`germinate_template_5_26_01_28`.`projects` left join `germinate_template_5_26_01_28`.`experiments` on((`germinate_template_5_26_01_28`.`experiments`.`project_id` = `germinate_template_5_26_01_28`.`projects`.`id`))) left join `germinate_template_5_26_01_28`.`datasets` on((`germinate_template_5_26_01_28`.`datasets`.`experiment_id` = `germinate_template_5_26_01_28`.`experiments`.`id`))) left join `germinate_template_5_26_01_28`.`datasettypes` on((`germinate_template_5_26_01_28`.`datasettypes`.`id` = `germinate_template_5_26_01_28`.`datasets`.`datasettype_id`))) group by `germinate_template_5_26_01_28`.`projects`.`id`"), where);
    }
