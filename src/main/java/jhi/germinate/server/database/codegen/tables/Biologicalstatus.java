...
public class Biologicalstatus extends TableImpl<BiologicalstatusRecord> {
    ...
    private static final long serialVersionUID = 1375830659;
    ...
    /**
     * The column <code>germinate_db.biologicalstatus.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.biologicalstatus.sampstat</code>. Previoulsy known as sampstat.
     */
    ...
    /**
     * The column <code>germinate_db.biologicalstatus.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.biologicalstatus.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Create an aliased <code>germinate_db.biologicalstatus</code> table reference
     */
    ...
    public Identity<BiologicalstatusRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Biologicalstatus.BIOLOGICALSTATUS, jhi.germinate.server.database.codegen.tables.Biologicalstatus.BIOLOGICALSTATUS.ID);
    }
    ...
    public UniqueKey<BiologicalstatusRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Biologicalstatus.BIOLOGICALSTATUS, "KEY_biologicalstatus_PRIMARY", jhi.germinate.server.database.codegen.tables.Biologicalstatus.BIOLOGICALSTATUS.ID);
    }
    ...
    public List<UniqueKey<BiologicalstatusRecord>> getKeys() {
        return Arrays.<UniqueKey<BiologicalstatusRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Biologicalstatus.BIOLOGICALSTATUS, "KEY_biologicalstatus_PRIMARY", jhi.germinate.server.database.codegen.tables.Biologicalstatus.BIOLOGICALSTATUS.ID)
        );
    }
