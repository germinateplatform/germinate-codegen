...
public class Entitytypes extends TableImpl<EntitytypesRecord> {
    ...
    private static final long serialVersionUID = 599976128;
    ...
    /**
     * The column <code>germinate_db.entitytypes.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.entitytypes.name</code>. The name of the entity type.
     */
    ...
    /**
     * The column <code>germinate_db.entitytypes.description</code>. Describes the entity type.
     */
    ...
    /**
     * The column <code>germinate_db.entitytypes.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.entitytypes.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    public Identity<EntitytypesRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Entitytypes.ENTITYTYPES, jhi.germinate.server.database.codegen.tables.Entitytypes.ENTITYTYPES.ID);
    }
    ...
    public UniqueKey<EntitytypesRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Entitytypes.ENTITYTYPES, "KEY_entitytypes_PRIMARY", jhi.germinate.server.database.codegen.tables.Entitytypes.ENTITYTYPES.ID);
    }
    ...
    public List<UniqueKey<EntitytypesRecord>> getKeys() {
        return Arrays.<UniqueKey<EntitytypesRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Entitytypes.ENTITYTYPES, "KEY_entitytypes_PRIMARY", jhi.germinate.server.database.codegen.tables.Entitytypes.ENTITYTYPES.ID)
        );
    }
