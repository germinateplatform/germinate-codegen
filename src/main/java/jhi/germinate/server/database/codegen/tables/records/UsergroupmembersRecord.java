...
public class UsergroupmembersRecord extends UpdatableRecordImpl<UsergroupmembersRecord> implements Record5<Integer, Integer, Integer, Timestamp, Timestamp> {
    ...
    private static final long serialVersionUID = 1740301201;
    ...
    /**
     * Setter for <code>germinate_db.usergroupmembers.created_on</code>. When the record was created.
     */
    ...
    /**
     * Getter for <code>germinate_db.usergroupmembers.created_on</code>. When the record was created.
     */
    ...
    /**
     * Setter for <code>germinate_db.usergroupmembers.updated_on</code>. When the record was updated. This may be different from the created on date if changes have been made subsequently to the underlying record.
     */
    ...
    /**
     * Getter for <code>germinate_db.usergroupmembers.updated_on</code>. When the record was updated. This may be different from the created on date if changes have been made subsequently to the underlying record.
     */
