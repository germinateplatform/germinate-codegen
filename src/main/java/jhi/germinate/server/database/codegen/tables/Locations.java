...
public class Locations extends TableImpl<LocationsRecord> {
    ...
    private static final long serialVersionUID = 5484553;
    ...
    /**
     * The column <code>germinate_db.locations.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.locations.locationtype_id</code>. Foreign key to locations (locations.id).
     */
    ...
    /**
     * The column <code>germinate_db.locations.country_id</code>. Foreign key to countries (countries.id).
     */
    ...
    /**
     * The column <code>germinate_db.locations.state</code>. The state where the location is if this exists.
     */
    ...
    /**
     * The column <code>germinate_db.locations.region</code>. The region where the location is if this exists.
     */
    ...
    /**
     * The column <code>germinate_db.locations.site_name</code>. The site name where the location is.
     */
    ...
    /**
     * The column <code>germinate_db.locations.site_name_short</code>. Shortened site name which can be used in tables within Germinate.
     */
    ...
    /**
     * The column <code>germinate_db.locations.elevation</code>. The elevation of the site in metres.
     */
    ...
    /**
     * The column <code>germinate_db.locations.latitude</code>. Latitude of the location.
     */
    ...
    /**
     * The column <code>germinate_db.locations.longitude</code>. Longitude of the location.
     */
    ...
    /**
     * The column <code>germinate_db.locations.coordinate_uncertainty</code>. Uncertainty associated with the coordinates in metres. Leave the value empty if the uncertainty is unknown. 
     */
    ...
    /**
     * The column <code>germinate_db.locations.coordinate_datum</code>. The geodetic datum or spatial reference system upon which the coordinates given in decimal latitude and decimal longitude are based (e.g. WGS84, ETRS89, NAD83). The GPS uses the WGS84 datum.
     */
    ...
    /**
     * The column <code>germinate_db.locations.georeferencing_method</code>. The georeferencing method used (GPS, determined from map, gazetteer, or estimated using software). Leave the value empty if georeferencing method is not known.
     */
    ...
    /**
     * The column <code>germinate_db.locations.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.locations.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    public Identity<LocationsRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Locations.LOCATIONS, jhi.germinate.server.database.codegen.tables.Locations.LOCATIONS.ID);
    }
    ...
    public UniqueKey<LocationsRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Locations.LOCATIONS, "KEY_locations_PRIMARY", jhi.germinate.server.database.codegen.tables.Locations.LOCATIONS.ID);
    }
    ...
    public List<UniqueKey<LocationsRecord>> getKeys() {
        return Arrays.<UniqueKey<LocationsRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Locations.LOCATIONS, "KEY_locations_PRIMARY", jhi.germinate.server.database.codegen.tables.Locations.LOCATIONS.ID)
        );
    }
