...
public class ViewTableMarkers extends TableImpl<ViewTableMarkersRecord> {
    ...
    private ViewTableMarkers(Name alias, Table<ViewTableMarkersRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_markers` as select `germinate_template_4_22_09_26`.`markers`.`id` AS `marker_id`,`germinate_template_4_22_09_26`.`markers`.`marker_name` AS `marker_name`,`germinate_template_4_22_09_26`.`markertypes`.`description` AS `marker_type`,`germinate_template_4_22_09_26`.`synonyms`.`synonyms` AS `marker_synonyms`,`germinate_template_4_22_09_26`.`markers`.`created_on` AS `created_on`,`germinate_template_4_22_09_26`.`markers`.`updated_on` AS `updated_on` from ((`germinate_template_4_22_09_26`.`markers` left join `germinate_template_4_22_09_26`.`markertypes` on((`germinate_template_4_22_09_26`.`markertypes`.`id` = `germinate_template_4_22_09_26`.`markers`.`markertype_id`))) left join `germinate_template_4_22_09_26`.`synonyms` on(((`germinate_template_4_22_09_26`.`synonyms`.`foreign_id` = `germinate_template_4_22_09_26`.`markers`.`id`) and (`germinate_template_4_22_09_26`.`synonyms`.`synonymtype_id` = 2))))"));
    }
