...
public class ViewTableMarkers extends TableImpl<ViewTableMarkersRecord> {
    ...
    private ViewTableMarkers(Name alias, Table<ViewTableMarkersRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_markers` as select `germinate_template_4_22_09_02`.`markers`.`id` AS `marker_id`,`germinate_template_4_22_09_02`.`markers`.`marker_name` AS `marker_name`,`germinate_template_4_22_09_02`.`markertypes`.`description` AS `marker_type`,`germinate_template_4_22_09_02`.`synonyms`.`synonyms` AS `marker_synonyms`,`germinate_template_4_22_09_02`.`markers`.`created_on` AS `created_on`,`germinate_template_4_22_09_02`.`markers`.`updated_on` AS `updated_on` from ((`germinate_template_4_22_09_02`.`markers` left join `germinate_template_4_22_09_02`.`markertypes` on((`germinate_template_4_22_09_02`.`markertypes`.`id` = `germinate_template_4_22_09_02`.`markers`.`markertype_id`))) left join `germinate_template_4_22_09_02`.`synonyms` on(((`germinate_template_4_22_09_02`.`synonyms`.`foreign_id` = `germinate_template_4_22_09_02`.`markers`.`id`) and (`germinate_template_4_22_09_02`.`synonyms`.`synonymtype_id` = 2))))"));
    }
