...
public class Compounddata extends TableImpl<CompounddataRecord> {
    ...
    private static final long serialVersionUID = -1713047485;
    ...
    /**
     * The column <code>germinate_db.compounddata.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.compounddata.compound_id</code>. Foreign key compounds (compounds.id).
     */
    ...
    /**
     * The column <code>germinate_db.compounddata.germinatebase_id</code>. Foreign key germinatebase (germinatebase.id).
     */
    ...
    /**
     * The column <code>germinate_db.compounddata.dataset_id</code>. Foreign key datasets (datasets.id).
     */
    ...
    /**
     * The column <code>germinate_db.compounddata.analysismethod_id</code>. Foreign key analysismethods (analysismethods.id).
     */
    ...
    /**
     * The column <code>germinate_db.compounddata.compound_value</code>. The compound value for this compound_id and germinatebase_id combination.
     */
    ...
    /**
     * The column <code>germinate_db.compounddata.recording_date</code>. Date when the phenotypic result was recorded. Should be formatted 'YYYY-MM-DD HH:MM:SS' or just 'YYYY-MM-DD' where a timestamp is not available.
     */
    ...
    /**
     * The column <code>germinate_db.compounddata.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.compounddata.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    public Identity<CompounddataRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Compounddata.COMPOUNDDATA, jhi.germinate.server.database.codegen.tables.Compounddata.COMPOUNDDATA.ID);
    }
    ...
    public UniqueKey<CompounddataRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Compounddata.COMPOUNDDATA, "KEY_compounddata_PRIMARY", jhi.germinate.server.database.codegen.tables.Compounddata.COMPOUNDDATA.ID);
    }
    ...
    public List<UniqueKey<CompounddataRecord>> getKeys() {
        return Arrays.<UniqueKey<CompounddataRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Compounddata.COMPOUNDDATA, "KEY_compounddata_PRIMARY", jhi.germinate.server.database.codegen.tables.Compounddata.COMPOUNDDATA.ID)
        );
    }
