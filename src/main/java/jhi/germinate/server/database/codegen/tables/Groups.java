...
public class Groups extends TableImpl<GroupsRecord> {
    ...
    private static final long serialVersionUID = -1740013065;
    ...
    /**
     * The column <code>germinate_db.groups.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.groups.grouptype_id</code>. Foreign key to grouptypes (grouptypes.id).
     */
    ...
    /**
     * The column <code>germinate_db.groups.name</code>. The name of the group which can be used to identify it.
     */
    ...
    /**
     * The column <code>germinate_db.groups.description</code>. A free text description of the group. This has no length limitations.
     */
    ...
    /**
     * The column <code>germinate_db.groups.visibility</code>. Defines if the group is visuble or hidden from the Germinate user interface.
     */
    ...
    /**
     * The column <code>germinate_db.groups.created_by</code>. Defines who created the group. Foreign key to Gatekeeper users (Gatekeeper users.id).
     */
    ...
    /**
     * The column <code>germinate_db.groups.created_on</code>. Foreign key to locations (locations.id).
     */
    ...
    /**
     * The column <code>germinate_db.groups.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    public Identity<GroupsRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Groups.GROUPS, jhi.germinate.server.database.codegen.tables.Groups.GROUPS.ID);
    }
    ...
    public UniqueKey<GroupsRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Groups.GROUPS, "KEY_groups_PRIMARY", jhi.germinate.server.database.codegen.tables.Groups.GROUPS.ID);
    }
    ...
    public List<UniqueKey<GroupsRecord>> getKeys() {
        return Arrays.<UniqueKey<GroupsRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Groups.GROUPS, "KEY_groups_PRIMARY", jhi.germinate.server.database.codegen.tables.Groups.GROUPS.ID)
        );
    }
