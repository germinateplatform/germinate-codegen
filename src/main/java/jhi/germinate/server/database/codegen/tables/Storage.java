...
public class Storage extends TableImpl<StorageRecord> {
    ...
    private static final long serialVersionUID = 1119172168;
    ...
    /**
     * The column <code>germinate_db.storage.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.storage.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    public UniqueKey<StorageRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Storage.STORAGE, "KEY_storage_PRIMARY", jhi.germinate.server.database.codegen.tables.Storage.STORAGE.ID);
    }
    ...
    public List<UniqueKey<StorageRecord>> getKeys() {
        return Arrays.<UniqueKey<StorageRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Storage.STORAGE, "KEY_storage_PRIMARY", jhi.germinate.server.database.codegen.tables.Storage.STORAGE.ID)
        );
    }
