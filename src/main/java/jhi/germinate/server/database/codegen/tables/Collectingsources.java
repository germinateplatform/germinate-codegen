...
public class Collectingsources extends TableImpl<CollectingsourcesRecord> {
    ...
    private static final long serialVersionUID = 1596415033;
    ...
    /**
     * The column <code>germinate_db.collectingsources.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.collectingsources.collsrc</code>. collsrc in the Multi Crop Passport Descriptors (MCPD V2 2012)
    ...
    /**
     * The column <code>germinate_db.collectingsources.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.collectingsources.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Create an aliased <code>germinate_db.collectingsources</code> table reference
     */
    ...
    public Identity<CollectingsourcesRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Collectingsources.COLLECTINGSOURCES, jhi.germinate.server.database.codegen.tables.Collectingsources.COLLECTINGSOURCES.ID);
    }
    ...
    public UniqueKey<CollectingsourcesRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Collectingsources.COLLECTINGSOURCES, "KEY_collectingsources_PRIMARY", jhi.germinate.server.database.codegen.tables.Collectingsources.COLLECTINGSOURCES.ID);
    }
    ...
    public List<UniqueKey<CollectingsourcesRecord>> getKeys() {
        return Arrays.<UniqueKey<CollectingsourcesRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Collectingsources.COLLECTINGSOURCES, "KEY_collectingsources_PRIMARY", jhi.germinate.server.database.codegen.tables.Collectingsources.COLLECTINGSOURCES.ID)
        );
    }
