...
public class ViewTableImages extends TableImpl<ViewTableImagesRecord> {
    ...
    private ViewTableImages(Name alias, Table<ViewTableImagesRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_images` as select `images`.`image_id` AS `image_id`,`images`.`image_description` AS `image_description`,`images`.`image_foreign_id` AS `image_foreign_id`,`images`.`image_path` AS `image_path`,cast(`images`.`image_exif` as json) AS `image_exif`,`images`.`image_type` AS `image_type`,`images`.`image_ref_table` AS `image_ref_table`,`images`.`reference_name` AS `reference_name`,`images`.`created_on` AS `created_on`,(select json_arrayagg(json_object('tagId',`germinate_template_4_22_10_12`.`imagetags`.`id`,'tagName',`germinate_template_4_22_10_12`.`imagetags`.`tag_name`)) from (`germinate_template_4_22_10_12`.`image_to_tags` left join `germinate_template_4_22_10_12`.`imagetags` on((`germinate_template_4_22_10_12`.`imagetags`.`id` = `germinate_template_4_22_10_12`.`image_to_tags`.`imagetag_id`))) where ((`germinate_template_4_22_10_12`.`image_to_tags`.`image_id` = `images`.`image_id`) and (`germinate_template_4_22_10_12`.`image_to_tags`.`imagetag_id` is not null)) group by `germinate_template_4_22_10_12`.`image_to_tags`.`image_id`) AS `tags` from (select `germinate_template_4_22_10_12`.`images`.`id` AS `image_id`,`germinate_template_4_22_10_12`.`images`.`description` AS `image_description`,`germinate_template_4_22_10_12`.`images`.`foreign_id` AS `image_foreign_id`,`germinate_template_4_22_10_12`.`images`.`path` AS `image_path`,`germinate_template_4_22_10_12`.`images`.`exif` AS `image_exif`,`germinate_template_4_22_10_12`.`imagetypes`.`description` AS `image_type`,`germinate_template_4_22_10_12`.`imagetypes`.`reference_table` AS `image_ref_table`,`germinate_template_4_22_10_12`.`germinatebase`.`name` AS `reference_name`,`germinate_template_4_22_10_12`.`images`.`created_on` AS `created_on` from ((`germinate_template_4_22_10_12`.`images` left join `germinate_template_4_22_10_12`.`imagetypes` on((`germinate_template_4_22_10_12`.`imagetypes`.`id` = `germinate_template_4_22_10_12`.`images`.`imagetype_id`))) left join `germinate_template_4_22_10_12`.`germinatebase` on((`germinate_template_4_22_10_12`.`germinatebase`.`id` = `germinate_template_4_22_10_12`.`images`.`foreign_id`))) where (`germinate_template_4_22_10_12`.`imagetypes`.`reference_table` like 'germinatebase') union select `germinate_template_4_22_10_12`.`images`.`id` AS `image_id`,`germinate_template_4_22_10_12`.`images`.`description` AS `image_description`,`germinate_template_4_22_10_12`.`images`.`foreign_id` AS `image_foreign_id`,`germinate_template_4_22_10_12`.`images`.`path` AS `image_path`,`germinate_template_4_22_10_12`.`images`.`exif` AS `image_exif`,`germinate_template_4_22_10_12`.`imagetypes`.`description` AS `image_type`,`germinate_template_4_22_10_12`.`imagetypes`.`reference_table` AS `image_ref_table`,`germinate_template_4_22_10_12`.`phenotypes`.`name` AS `reference_name`,`germinate_template_4_22_10_12`.`images`.`created_on` AS `created_on` from ((`germinate_template_4_22_10_12`.`images` left join `germinate_template_4_22_10_12`.`imagetypes` on((`germinate_template_4_22_10_12`.`imagetypes`.`id` = `germinate_template_4_22_10_12`.`images`.`imagetype_id`))) left join `germinate_template_4_22_10_12`.`phenotypes` on((`germinate_template_4_22_10_12`.`phenotypes`.`id` = `germinate_template_4_22_10_12`.`images`.`foreign_id`))) where (`germinate_template_4_22_10_12`.`imagetypes`.`reference_table` like 'phenotypes')) `images`"));
    }
