...
public class MlsstatusRecord extends UpdatableRecordImpl<MlsstatusRecord> implements Record4<Integer, String, Timestamp, Timestamp> {
    ...
    private static final long serialVersionUID = -1364736475;
    ...
    /**
     * Setter for <code>germinate_db.mlsstatus.created_on</code>. When the record was created.
     */
    ...
    /**
     * Getter for <code>germinate_db.mlsstatus.created_on</code>. When the record was created.
     */
    ...
    /**
     * Setter for <code>germinate_db.mlsstatus.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Getter for <code>germinate_db.mlsstatus.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
