...
public class Datasetmeta extends TableImpl<DatasetmetaRecord> {
    ...
    private static final long serialVersionUID = 1322968679;
    ...
    /**
     * The column <code>germinate_db.datasetmeta.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.datasetmeta.dataset_id</code>. Foreign key to [datasets] ([datasets].id).
     */
    ...
    /**
     * The column <code>germinate_db.datasetmeta.nr_of_data_objects</code>. The number of data objects contained in this dataset.
     */
    ...
    /**
     * The column <code>germinate_db.datasetmeta.nr_of_data_points</code>. The number of individual data points contained in this dataset.
     */
    ...
    /**
     * The column <code>germinate_db.datasetmeta.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.datasetmeta.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    public Identity<DatasetmetaRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Datasetmeta.DATASETMETA, jhi.germinate.server.database.codegen.tables.Datasetmeta.DATASETMETA.ID);
    }
    ...
    public UniqueKey<DatasetmetaRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Datasetmeta.DATASETMETA, "KEY_datasetmeta_PRIMARY", jhi.germinate.server.database.codegen.tables.Datasetmeta.DATASETMETA.ID);
    }
    ...
    public List<UniqueKey<DatasetmetaRecord>> getKeys() {
        return Arrays.<UniqueKey<DatasetmetaRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Datasetmeta.DATASETMETA, "KEY_datasetmeta_PRIMARY", jhi.germinate.server.database.codegen.tables.Datasetmeta.DATASETMETA.ID)
        );
    }
