...
public class Linktypes extends TableImpl<LinktypesRecord> {
    ...
    private static final long serialVersionUID = -134821062;
    ...
    /**
     * The column <code>germinate_db.linktypes.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.linktypes.description</code>. A description of the link.
     */
    ...
    /**
     * The column <code>germinate_db.linktypes.target_table</code>. This is the table that the link links to.
     */
    ...
    /**
     * The column <code>germinate_db.linktypes.target_column</code>. This is the column that is used to generate the link.
     */
    ...
    /**
     * The column <code>germinate_db.linktypes.placeholder</code>. The part of the link that will be replaced by the value of the target column.
     */
    ...
    /**
     * The column <code>germinate_db.linktypes.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.linktypes.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    public Identity<LinktypesRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Linktypes.LINKTYPES, jhi.germinate.server.database.codegen.tables.Linktypes.LINKTYPES.ID);
    }
    ...
    public UniqueKey<LinktypesRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Linktypes.LINKTYPES, "KEY_linktypes_PRIMARY", jhi.germinate.server.database.codegen.tables.Linktypes.LINKTYPES.ID);
    }
    ...
    public List<UniqueKey<LinktypesRecord>> getKeys() {
        return Arrays.<UniqueKey<LinktypesRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Linktypes.LINKTYPES, "KEY_linktypes_PRIMARY", jhi.germinate.server.database.codegen.tables.Linktypes.LINKTYPES.ID)
        );
    }
