...
public class ViewTableComments extends TableImpl<ViewTableCommentsRecord> {
    ...
    private static final long serialVersionUID = 383275581;
    ...
    /**
     * The column <code>germinate_db.view_table_comments.comment_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_comments.comment_type_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_comments.comment_type</code>. This could include 'germinatebase' or 'markers' to define the table that the comment relates to.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_comments.comment_foreign_id</code>. Relates to the UID of the table to which the comment relates
     */
    ...
    /**
     * The column <code>germinate_db.view_table_comments.user_id</code>. Foreign key to Gatekeeper users (Gatekeeper users.id).
     */
    ...
    /**
     * The column <code>germinate_db.view_table_comments.comment_content</code>. The comment content.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_comments.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Create an aliased <code>germinate_db.view_table_comments</code> table reference
     */
