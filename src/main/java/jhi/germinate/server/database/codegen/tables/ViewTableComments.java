...
public class ViewTableComments extends TableImpl<ViewTableCommentsRecord> {
    ...
    private ViewTableComments(Name alias, Table<ViewTableCommentsRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.view("create view `view_table_comments` as select `germinate_template_5_26_08_13`.`comments`.`id` AS `comment_id`,`germinate_template_5_26_08_13`.`commenttypes`.`id` AS `comment_type_id`,`germinate_template_5_26_08_13`.`commenttypes`.`reference_table` AS `comment_type`,`germinate_template_5_26_08_13`.`comments`.`reference_id` AS `comment_foreign_id`,`germinate_template_5_26_08_13`.`comments`.`user_id` AS `user_id`,'' AS `user_name`,`germinate_template_5_26_08_13`.`comments`.`description` AS `comment_content`,`germinate_template_5_26_08_13`.`comments`.`updated_on` AS `updated_on` from (`germinate_template_5_26_08_13`.`comments` left join `germinate_template_5_26_08_13`.`commenttypes` on((`germinate_template_5_26_08_13`.`commenttypes`.`id` = `germinate_template_5_26_08_13`.`comments`.`commenttype_id`)))"), where);
    }
