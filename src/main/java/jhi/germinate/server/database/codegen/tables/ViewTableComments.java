...
public class ViewTableComments extends TableImpl<ViewTableCommentsRecord> {
    ...
    private ViewTableComments(Name alias, Table<ViewTableCommentsRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_comments` as select `germinate_template_4_22_10_03`.`comments`.`id` AS `comment_id`,`germinate_template_4_22_10_03`.`commenttypes`.`id` AS `comment_type_id`,`germinate_template_4_22_10_03`.`commenttypes`.`reference_table` AS `comment_type`,`germinate_template_4_22_10_03`.`comments`.`reference_id` AS `comment_foreign_id`,`germinate_template_4_22_10_03`.`comments`.`user_id` AS `user_id`,'' AS `user_name`,`germinate_template_4_22_10_03`.`comments`.`description` AS `comment_content`,`germinate_template_4_22_10_03`.`comments`.`updated_on` AS `updated_on` from (`germinate_template_4_22_10_03`.`comments` left join `germinate_template_4_22_10_03`.`commenttypes` on((`germinate_template_4_22_10_03`.`commenttypes`.`id` = `germinate_template_4_22_10_03`.`comments`.`commenttype_id`)))"));
    }
