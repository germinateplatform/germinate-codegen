...
public class SynonymsRecord extends UpdatableRecordImpl<SynonymsRecord> implements Record6<Integer, Integer, Integer, JsonArray, Timestamp, Timestamp> {
    ...
    private static final long serialVersionUID = -1072128208;

    /**
     * Setter for <code>germinate_db.synonyms.id</code>. Primary id for this table. This uniquely identifies the row.
    ...
    /**
     * Getter for <code>germinate_db.synonyms.id</code>. Primary id for this table. This uniquely identifies the row.
    ...
    /**
     * Setter for <code>germinate_db.synonyms.foreign_id</code>. Foreign key to target table (l[targettable].id).
     */
    ...
    /**
     * Getter for <code>germinate_db.synonyms.foreign_id</code>. Foreign key to target table (l[targettable].id).
     */
    ...
    /**
     * Setter for <code>germinate_db.synonyms.synonymtype_id</code>. Foreign key to synonymtypes (synonymnstypes.id).
     */
    ...
    /**
     * Getter for <code>germinate_db.synonyms.synonymtype_id</code>. Foreign key to synonymtypes (synonymnstypes.id).
     */
    ...
    /**
     * Setter for <code>germinate_db.synonyms.synonyms</code>. The synonyms as a json array.
     */
    ...
    /**
     * Getter for <code>germinate_db.synonyms.synonyms</code>. The synonyms as a json array.
     */
    ...
    /**
     * Setter for <code>germinate_db.synonyms.created_on</code>. When the record was created.
     */
    ...
    /**
     * Getter for <code>germinate_db.synonyms.created_on</code>. When the record was created.
     */
    ...
    /**
     * Setter for <code>germinate_db.synonyms.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Getter for <code>germinate_db.synonyms.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
