...
public class Pedigreedefinitions extends TableImpl<PedigreedefinitionsRecord> {
    ...
    private static final long serialVersionUID = -836685669;
    ...
    /**
     * The column <code>germinate_db.pedigreedefinitions.id</code>. Primary id for this table. This uniquely identifies the row.
     */
     ...
     */
    public final TableField<PedigreedefinitionsRecord, Integer> DATASET_ID = createField("dataset_id", org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>germinate_db.pedigreedefinitions.germinatebase_id</code>. Foreign key to germinatebase (germinatebase.id).
     */
    ...
    /**
     * The column <code>germinate_db.pedigreedefinitions.pedigreenotation_id</code>. Foreign key to pedigreenotations (pedigreenotations.id).
     */
    ...
    /**
     * The column <code>germinate_db.pedigreedefinitions.pedigreedescription_id</code>.
     */
    ...
    /**
     * The column <code>germinate_db.pedigreedefinitions.definition</code>. The pedigree string which is used to represent the germinatebase entry.
     */
    ...
    /**
     * The column <code>germinate_db.pedigreedefinitions.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.pedigreedefinitions.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Create an aliased <code>germinate_db.pedigreedefinitions</code> table reference
     */
    ...
    public Identity<PedigreedefinitionsRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Pedigreedefinitions.PEDIGREEDEFINITIONS, jhi.germinate.server.database.codegen.tables.Pedigreedefinitions.PEDIGREEDEFINITIONS.ID);
    }
    ...
    public UniqueKey<PedigreedefinitionsRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Pedigreedefinitions.PEDIGREEDEFINITIONS, "KEY_pedigreedefinitions_PRIMARY", jhi.germinate.server.database.codegen.tables.Pedigreedefinitions.PEDIGREEDEFINITIONS.ID);
    }
    ...
    public List<UniqueKey<PedigreedefinitionsRecord>> getKeys() {
        return Arrays.<UniqueKey<PedigreedefinitionsRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Pedigreedefinitions.PEDIGREEDEFINITIONS, "KEY_pedigreedefinitions_PRIMARY", jhi.germinate.server.database.codegen.tables.Pedigreedefinitions.PEDIGREEDEFINITIONS.ID)
        );
    }
