...
public class ViewTableGermplasmDeprecated extends TableImpl<ViewTableGermplasmDeprecatedRecord> {
    ...
    private ViewTableGermplasmDeprecated(Name alias, Table<ViewTableGermplasmDeprecatedRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_germplasm_deprecated` as select `germinate_template_4_22_05_04`.`germinatebase`.`name` AS `germplasm_name`,`germinate_template_4_22_05_04`.`germinatebase`.`id` AS `germplasm_id`,`germinate_template_4_22_05_04`.`germinatebase`.`general_identifier` AS `germplasm_gid`,`germinate_template_4_22_05_04`.`germinatebase`.`number` AS `germplasm_number`,`germinate_template_4_22_05_04`.`germinatebase`.`puid` AS `germplasm_puid`,`germinate_template_4_22_05_04`.`entitytypes`.`id` AS `entity_type_id`,`germinate_template_4_22_05_04`.`entitytypes`.`name` AS `entity_type_name`,`germinate_template_4_22_05_04`.`germinatebase`.`entityparent_id` AS `entity_parent_id`,`g`.`name` AS `entity_parent_name`,`g`.`general_identifier` AS `entity_parent_general_identifier`,`germinate_template_4_22_05_04`.`biologicalstatus`.`id` AS `biological_status_id`,`germinate_template_4_22_05_04`.`biologicalstatus`.`sampstat` AS `biological_status_name`,`germinate_template_4_22_05_04`.`synonyms`.`synonyms` AS `synonyms`,`germinate_template_4_22_05_04`.`germinatebase`.`collnumb` AS `collector_number`,`germinate_template_4_22_05_04`.`taxonomies`.`genus` AS `genus`,`germinate_template_4_22_05_04`.`taxonomies`.`species` AS `species`,`germinate_template_4_22_05_04`.`taxonomies`.`subtaxa` AS `subtaxa`,`germinate_template_4_22_05_04`.`institutions`.`id` AS `institution_id`,`germinate_template_4_22_05_04`.`institutions`.`name` AS `institution_name`,`germinate_template_4_22_05_04`.`locations`.`site_name` AS `location`,`germinate_template_4_22_05_04`.`locations`.`latitude` AS `latitude`,`germinate_template_4_22_05_04`.`locations`.`longitude` AS `longitude`,`germinate_template_4_22_05_04`.`locations`.`elevation` AS `elevation`,`germinate_template_4_22_05_04`.`countries`.`country_name` AS `country_name`,`germinate_template_4_22_05_04`.`countries`.`country_code2` AS `country_code`,`germinate_template_4_22_05_04`.`germinatebase`.`colldate` AS `coll_date`,`germinate_template_4_22_05_04`.`germinatebase`.`pdci` AS `pdci`,(select count(1) from (`germinate_template_4_22_05_04`.`images` left join `germinate_template_4_22_05_04`.`imagetypes` on((`germinate_template_4_22_05_04`.`imagetypes`.`id` = `germinate_template_4_22_05_04`.`images`.`imagetype_id`))) where ((`germinate_template_4_22_05_04`.`imagetypes`.`reference_table` = 'germinatebase') and (`germinate_template_4_22_05_04`.`images`.`foreign_id` = `germinate_template_4_22_05_04`.`germinatebase`.`id`))) AS `image_count`,(select `germinate_template_4_22_05_04`.`images`.`path` from (`germinate_template_4_22_05_04`.`images` left join `germinate_template_4_22_05_04`.`imagetypes` on((`germinate_template_4_22_05_04`.`imagetypes`.`id` = `germinate_template_4_22_05_04`.`images`.`imagetype_id`))) where ((`germinate_template_4_22_05_04`.`imagetypes`.`reference_table` = 'germinatebase') and (`germinate_template_4_22_05_04`.`images`.`foreign_id` = `germinate_template_4_22_05_04`.`germinatebase`.`id`)) limit 1) AS `first_image_path`,(select 1 from `germinate_template_4_22_05_04`.`phenotypedata` where (`germinate_template_4_22_05_04`.`phenotypedata`.`germinatebase_id` = `germinate_template_4_22_05_04`.`germinatebase`.`id`) limit 1) AS `has_trials_data`,(select 1 from (`germinate_template_4_22_05_04`.`datasetmembers` left join `germinate_template_4_22_05_04`.`datasets` on((`germinate_template_4_22_05_04`.`datasets`.`id` = `germinate_template_4_22_05_04`.`datasetmembers`.`dataset_id`))) where ((`germinate_template_4_22_05_04`.`datasetmembers`.`foreign_id` = `germinate_template_4_22_05_04`.`germinatebase`.`id`) and (`germinate_template_4_22_05_04`.`datasetmembers`.`datasetmembertype_id` = 2) and (`germinate_template_4_22_05_04`.`datasets`.`datasettype_id` = 1)) limit 1) AS `has_genotypic_data`,(select 1 from (`germinate_template_4_22_05_04`.`datasetmembers` left join `germinate_template_4_22_05_04`.`datasets` on((`germinate_template_4_22_05_04`.`datasets`.`id` = `germinate_template_4_22_05_04`.`datasetmembers`.`dataset_id`))) where ((`germinate_template_4_22_05_04`.`datasetmembers`.`foreign_id` = `germinate_template_4_22_05_04`.`germinatebase`.`id`) and (`germinate_template_4_22_05_04`.`datasetmembers`.`datasetmembertype_id` = 2) and (`germinate_template_4_22_05_04`.`datasets`.`datasettype_id` = 4)) limit 1) AS `has_allelefreq_data`,(select 1 from `germinate_template_4_22_05_04`.`compounddata` where (`germinate_template_4_22_05_04`.`compounddata`.`germinatebase_id` = `germinate_template_4_22_05_04`.`germinatebase`.`id`) limit 1) AS `has_compound_data` from ((((((((`germinate_template_4_22_05_04`.`germinatebase` left join `germinate_template_4_22_05_04`.`germinatebase` `g` on((`g`.`id` = `germinate_template_4_22_05_04`.`germinatebase`.`entityparent_id`))) left join `germinate_template_4_22_05_04`.`institutions` on((`germinate_template_4_22_05_04`.`institutions`.`id` = `germinate_template_4_22_05_04`.`germinatebase`.`institution_id`))) left join `germinate_template_4_22_05_04`.`entitytypes` on((`germinate_template_4_22_05_04`.`germinatebase`.`entitytype_id` = `germinate_template_4_22_05_04`.`entitytypes`.`id`))) left join `germinate_template_4_22_05_04`.`taxonomies` on((`germinate_template_4_22_05_04`.`germinatebase`.`taxonomy_id` = `germinate_template_4_22_05_04`.`taxonomies`.`id`))) left join `germinate_template_4_22_05_04`.`locations` on((`germinate_template_4_22_05_04`.`germinatebase`.`location_id` = `germinate_template_4_22_05_04`.`locations`.`id`))) left join `germinate_template_4_22_05_04`.`countries` on((`germinate_template_4_22_05_04`.`locations`.`country_id` = `germinate_template_4_22_05_04`.`countries`.`id`))) left join `germinate_template_4_22_05_04`.`biologicalstatus` on((`germinate_template_4_22_05_04`.`biologicalstatus`.`id` = `germinate_template_4_22_05_04`.`germinatebase`.`biologicalstatus_id`))) left join `germinate_template_4_22_05_04`.`synonyms` on(((`germinate_template_4_22_05_04`.`synonyms`.`foreign_id` = `germinate_template_4_22_05_04`.`germinatebase`.`id`) and (`germinate_template_4_22_05_04`.`synonyms`.`synonymtype_id` = 1))))"));
    }
