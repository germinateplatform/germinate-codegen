...
public class ViewTableGermplasmDeprecated extends TableImpl<ViewTableGermplasmDeprecatedRecord> {
     ...
     * each accession.
     */
    public final TableField<ViewTableGermplasmDeprecatedRecord, String> GERMPLASM_PUID = createField(DSL.name("germplasm_puid"), SQLDataType.VARCHAR(255), this, "Any persistent, unique identifier assigned to the accession so it can be unambiguously referenced at the global level and the information associated with it harvested through automated means. Report one PUID for each accession.");
     ...
     */
    public final TableField<ViewTableGermplasmDeprecatedRecord, String> COLLECTOR_NUMBER = createField(DSL.name("collector_number"), SQLDataType.VARCHAR(255), this, "Original identifier assigned by the collector(s) of the sample, normally composed of the name or\ninitials of the collector(s) followed by a number (e.g. ‘FM9909’). This identifier is essential for\nidentifying duplicates held in different collections.");
     ...
     * Primary id for this table. This uniquely identifies the row.
     */
    public final TableField<ViewTableGermplasmDeprecatedRecord, Integer> INSTITUTION_ID = createField(DSL.name("institution_id"), SQLDataType.INTEGER.defaultValue(DSL.inline("0", SQLDataType.INTEGER)), this, "Primary id for this table. This uniquely identifies the row.");
     ...
     * The institute name.
     */
    public final TableField<ViewTableGermplasmDeprecatedRecord, String> INSTITUTION_NAME = createField(DSL.name("institution_name"), SQLDataType.VARCHAR(255).defaultValue(DSL.inline("", SQLDataType.VARCHAR)), this, "The institute name.");
     ...
     * zero]. 
     */
    public final TableField<ViewTableGermplasmDeprecatedRecord, Date> COLL_DATE = createField(DSL.name("coll_date"), SQLDataType.DATE, this, "Collecting date of the sample, where YYYY is the year, MM is the month and DD is the day.\nMissing data (MM or DD) should be indicated with hyphens or ‘00’ [double zero]. ");
    ...
    private ViewTableGermplasmDeprecated(Name alias, Table<ViewTableGermplasmDeprecatedRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_germplasm_deprecated` as select `germinate_template_4_22_08_18`.`germinatebase`.`name` AS `germplasm_name`,`germinate_template_4_22_08_18`.`germinatebase`.`id` AS `germplasm_id`,`germinate_template_4_22_08_18`.`germinatebase`.`general_identifier` AS `germplasm_gid`,`germinate_template_4_22_08_18`.`germinatebase`.`number` AS `germplasm_number`,`germinate_template_4_22_08_18`.`germinatebase`.`puid` AS `germplasm_puid`,`germinate_template_4_22_08_18`.`entitytypes`.`id` AS `entity_type_id`,`germinate_template_4_22_08_18`.`entitytypes`.`name` AS `entity_type_name`,`germinate_template_4_22_08_18`.`germinatebase`.`entityparent_id` AS `entity_parent_id`,`g`.`name` AS `entity_parent_name`,`g`.`general_identifier` AS `entity_parent_general_identifier`,`germinate_template_4_22_08_18`.`biologicalstatus`.`id` AS `biological_status_id`,`germinate_template_4_22_08_18`.`biologicalstatus`.`sampstat` AS `biological_status_name`,`germinate_template_4_22_08_18`.`synonyms`.`synonyms` AS `synonyms`,`germinate_template_4_22_08_18`.`germinatebase`.`collnumb` AS `collector_number`,`germinate_template_4_22_08_18`.`taxonomies`.`genus` AS `genus`,`germinate_template_4_22_08_18`.`taxonomies`.`species` AS `species`,`germinate_template_4_22_08_18`.`taxonomies`.`subtaxa` AS `subtaxa`,`germinate_template_4_22_08_18`.`institutions`.`id` AS `institution_id`,`germinate_template_4_22_08_18`.`institutions`.`name` AS `institution_name`,`germinate_template_4_22_08_18`.`locations`.`site_name` AS `location`,`germinate_template_4_22_08_18`.`locations`.`latitude` AS `latitude`,`germinate_template_4_22_08_18`.`locations`.`longitude` AS `longitude`,`germinate_template_4_22_08_18`.`locations`.`elevation` AS `elevation`,`germinate_template_4_22_08_18`.`countries`.`country_name` AS `country_name`,`germinate_template_4_22_08_18`.`countries`.`country_code2` AS `country_code`,`germinate_template_4_22_08_18`.`germinatebase`.`colldate` AS `coll_date`,`germinate_template_4_22_08_18`.`germinatebase`.`pdci` AS `pdci`,(select count(1) from (`germinate_template_4_22_08_18`.`images` left join `germinate_template_4_22_08_18`.`imagetypes` on((`germinate_template_4_22_08_18`.`imagetypes`.`id` = `germinate_template_4_22_08_18`.`images`.`imagetype_id`))) where ((`germinate_template_4_22_08_18`.`imagetypes`.`reference_table` = 'germinatebase') and (`germinate_template_4_22_08_18`.`images`.`foreign_id` = `germinate_template_4_22_08_18`.`germinatebase`.`id`))) AS `image_count`,(select `germinate_template_4_22_08_18`.`images`.`path` from (`germinate_template_4_22_08_18`.`images` left join `germinate_template_4_22_08_18`.`imagetypes` on((`germinate_template_4_22_08_18`.`imagetypes`.`id` = `germinate_template_4_22_08_18`.`images`.`imagetype_id`))) where ((`germinate_template_4_22_08_18`.`imagetypes`.`reference_table` = 'germinatebase') and (`germinate_template_4_22_08_18`.`images`.`foreign_id` = `germinate_template_4_22_08_18`.`germinatebase`.`id`)) limit 1) AS `first_image_path`,(select 1 from `germinate_template_4_22_08_18`.`phenotypedata` where (`germinate_template_4_22_08_18`.`phenotypedata`.`germinatebase_id` = `germinate_template_4_22_08_18`.`germinatebase`.`id`) limit 1) AS `has_trials_data`,(select 1 from (`germinate_template_4_22_08_18`.`datasetmembers` left join `germinate_template_4_22_08_18`.`datasets` on((`germinate_template_4_22_08_18`.`datasets`.`id` = `germinate_template_4_22_08_18`.`datasetmembers`.`dataset_id`))) where ((`germinate_template_4_22_08_18`.`datasetmembers`.`foreign_id` = `germinate_template_4_22_08_18`.`germinatebase`.`id`) and (`germinate_template_4_22_08_18`.`datasetmembers`.`datasetmembertype_id` = 2) and (`germinate_template_4_22_08_18`.`datasets`.`datasettype_id` = 1)) limit 1) AS `has_genotypic_data`,(select 1 from (`germinate_template_4_22_08_18`.`datasetmembers` left join `germinate_template_4_22_08_18`.`datasets` on((`germinate_template_4_22_08_18`.`datasets`.`id` = `germinate_template_4_22_08_18`.`datasetmembers`.`dataset_id`))) where ((`germinate_template_4_22_08_18`.`datasetmembers`.`foreign_id` = `germinate_template_4_22_08_18`.`germinatebase`.`id`) and (`germinate_template_4_22_08_18`.`datasetmembers`.`datasetmembertype_id` = 2) and (`germinate_template_4_22_08_18`.`datasets`.`datasettype_id` = 4)) limit 1) AS `has_allelefreq_data`,(select 1 from `germinate_template_4_22_08_18`.`compounddata` where (`germinate_template_4_22_08_18`.`compounddata`.`germinatebase_id` = `germinate_template_4_22_08_18`.`germinatebase`.`id`) limit 1) AS `has_compound_data` from ((((((((`germinate_template_4_22_08_18`.`germinatebase` left join `germinate_template_4_22_08_18`.`germinatebase` `g` on((`g`.`id` = `germinate_template_4_22_08_18`.`germinatebase`.`entityparent_id`))) left join `germinate_template_4_22_08_18`.`institutions` on((`germinate_template_4_22_08_18`.`institutions`.`id` = `germinate_template_4_22_08_18`.`germinatebase`.`institution_id`))) left join `germinate_template_4_22_08_18`.`entitytypes` on((`germinate_template_4_22_08_18`.`germinatebase`.`entitytype_id` = `germinate_template_4_22_08_18`.`entitytypes`.`id`))) left join `germinate_template_4_22_08_18`.`taxonomies` on((`germinate_template_4_22_08_18`.`germinatebase`.`taxonomy_id` = `germinate_template_4_22_08_18`.`taxonomies`.`id`))) left join `germinate_template_4_22_08_18`.`locations` on((`germinate_template_4_22_08_18`.`germinatebase`.`location_id` = `germinate_template_4_22_08_18`.`locations`.`id`))) left join `germinate_template_4_22_08_18`.`countries` on((`germinate_template_4_22_08_18`.`locations`.`country_id` = `germinate_template_4_22_08_18`.`countries`.`id`))) left join `germinate_template_4_22_08_18`.`biologicalstatus` on((`germinate_template_4_22_08_18`.`biologicalstatus`.`id` = `germinate_template_4_22_08_18`.`germinatebase`.`biologicalstatus_id`))) left join `germinate_template_4_22_08_18`.`synonyms` on(((`germinate_template_4_22_08_18`.`synonyms`.`foreign_id` = `germinate_template_4_22_08_18`.`germinatebase`.`id`) and (`germinate_template_4_22_08_18`.`synonyms`.`synonymtype_id` = 1))))"));
    }
