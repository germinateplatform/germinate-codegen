...
public class ViewTableGermplasmDeprecated extends TableImpl<ViewTableGermplasmDeprecatedRecord> {
    ...
    private ViewTableGermplasmDeprecated(Name alias, Table<ViewTableGermplasmDeprecatedRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_germplasm_deprecated` as select `germinate_template_4_23_02_08`.`germinatebase`.`name` AS `germplasm_name`,`germinate_template_4_23_02_08`.`germinatebase`.`id` AS `germplasm_id`,`germinate_template_4_23_02_08`.`germinatebase`.`general_identifier` AS `germplasm_gid`,`germinate_template_4_23_02_08`.`germinatebase`.`number` AS `germplasm_number`,`germinate_template_4_23_02_08`.`mcpd`.`puid` AS `gerplasm_puid`,`germinate_template_4_23_02_08`.`entitytypes`.`id` AS `entity_type_id`,`germinate_template_4_23_02_08`.`entitytypes`.`name` AS `entity_type_name`,`germinate_template_4_23_02_08`.`germinatebase`.`entityparent_id` AS `entity_parent_id`,`g`.`name` AS `entity_parent_name`,`g`.`general_identifier` AS `entity_parent_general_identifier`,`germinate_template_4_23_02_08`.`biologicalstatus`.`id` AS `biological_status_id`,`germinate_template_4_23_02_08`.`biologicalstatus`.`sampstat` AS `biological_status_name`,`germinate_template_4_23_02_08`.`synonyms`.`synonyms` AS `synonyms`,`germinate_template_4_23_02_08`.`mcpd`.`collnumb` AS `collector_number`,`germinate_template_4_23_02_08`.`taxonomies`.`genus` AS `genus`,`germinate_template_4_23_02_08`.`taxonomies`.`species` AS `species`,`germinate_template_4_23_02_08`.`taxonomies`.`subtaxa` AS `subtaxa`,(select json_arrayagg(json_object('id',`germinate_template_4_23_02_08`.`institutions`.`id`,'code',`germinate_template_4_23_02_08`.`institutions`.`code`,'name',`germinate_template_4_23_02_08`.`institutions`.`name`,'type',`germinate_template_4_23_02_08`.`germplasminstitutions`.`type`)) from (`germinate_template_4_23_02_08`.`germplasminstitutions` left join `germinate_template_4_23_02_08`.`institutions` on((`germinate_template_4_23_02_08`.`institutions`.`id` = `germinate_template_4_23_02_08`.`germplasminstitutions`.`institution_id`))) where (`germinate_template_4_23_02_08`.`germplasminstitutions`.`germinatebase_id` = `germinate_template_4_23_02_08`.`germinatebase`.`id`) group by `germinate_template_4_23_02_08`.`germplasminstitutions`.`germinatebase_id`) AS `institutions`,`germinate_template_4_23_02_08`.`locations`.`site_name` AS `location`,`germinate_template_4_23_02_08`.`locations`.`latitude` AS `latitude`,`germinate_template_4_23_02_08`.`locations`.`longitude` AS `longitude`,`germinate_template_4_23_02_08`.`locations`.`elevation` AS `elevation`,`germinate_template_4_23_02_08`.`countries`.`country_name` AS `country_name`,`germinate_template_4_23_02_08`.`countries`.`country_code2` AS `country_code`,`germinate_template_4_23_02_08`.`mcpd`.`colldate` AS `coll_date`,`germinate_template_4_23_02_08`.`germinatebase`.`pdci` AS `pdci`,(select count(1) from (`germinate_template_4_23_02_08`.`images` left join `germinate_template_4_23_02_08`.`imagetypes` on((`germinate_template_4_23_02_08`.`imagetypes`.`id` = `germinate_template_4_23_02_08`.`images`.`imagetype_id`))) where ((`germinate_template_4_23_02_08`.`imagetypes`.`reference_table` = 'germinatebase') and (`germinate_template_4_23_02_08`.`images`.`foreign_id` = `germinate_template_4_23_02_08`.`germinatebase`.`id`))) AS `image_count`,(select `germinate_template_4_23_02_08`.`images`.`path` from (`germinate_template_4_23_02_08`.`images` left join `germinate_template_4_23_02_08`.`imagetypes` on((`germinate_template_4_23_02_08`.`imagetypes`.`id` = `germinate_template_4_23_02_08`.`images`.`imagetype_id`))) where ((`germinate_template_4_23_02_08`.`imagetypes`.`reference_table` = 'germinatebase') and (`germinate_template_4_23_02_08`.`images`.`foreign_id` = `germinate_template_4_23_02_08`.`germinatebase`.`id`)) limit 1) AS `first_image_path`,(select 1 from `germinate_template_4_23_02_08`.`phenotypedata` where (`germinate_template_4_23_02_08`.`phenotypedata`.`germinatebase_id` = `germinate_template_4_23_02_08`.`germinatebase`.`id`) limit 1) AS `has_trials_data`,(select 1 from (`germinate_template_4_23_02_08`.`datasetmembers` left join `germinate_template_4_23_02_08`.`datasets` on((`germinate_template_4_23_02_08`.`datasets`.`id` = `germinate_template_4_23_02_08`.`datasetmembers`.`dataset_id`))) where ((`germinate_template_4_23_02_08`.`datasetmembers`.`foreign_id` = `germinate_template_4_23_02_08`.`germinatebase`.`id`) and (`germinate_template_4_23_02_08`.`datasetmembers`.`datasetmembertype_id` = 2) and (`germinate_template_4_23_02_08`.`datasets`.`datasettype_id` = 1)) limit 1) AS `has_genotypic_data`,(select 1 from (`germinate_template_4_23_02_08`.`datasetmembers` left join `germinate_template_4_23_02_08`.`datasets` on((`germinate_template_4_23_02_08`.`datasets`.`id` = `germinate_template_4_23_02_08`.`datasetmembers`.`dataset_id`))) where ((`germinate_template_4_23_02_08`.`datasetmembers`.`foreign_id` = `germinate_template_4_23_02_08`.`germinatebase`.`id`) and (`germinate_template_4_23_02_08`.`datasetmembers`.`datasetmembertype_id` = 2) and (`germinate_template_4_23_02_08`.`datasets`.`datasettype_id` = 4)) limit 1) AS `has_allelefreq_data` from ((((((((`germinate_template_4_23_02_08`.`germinatebase` left join `germinate_template_4_23_02_08`.`mcpd` on((`germinate_template_4_23_02_08`.`mcpd`.`germinatebase_id` = `germinate_template_4_23_02_08`.`germinatebase`.`id`))) left join `germinate_template_4_23_02_08`.`germinatebase` `g` on((`g`.`id` = `germinate_template_4_23_02_08`.`germinatebase`.`entityparent_id`))) left join `germinate_template_4_23_02_08`.`entitytypes` on((`germinate_template_4_23_02_08`.`germinatebase`.`entitytype_id` = `germinate_template_4_23_02_08`.`entitytypes`.`id`))) left join `germinate_template_4_23_02_08`.`taxonomies` on((`germinate_template_4_23_02_08`.`germinatebase`.`taxonomy_id` = `germinate_template_4_23_02_08`.`taxonomies`.`id`))) left join `germinate_template_4_23_02_08`.`locations` on((`germinate_template_4_23_02_08`.`germinatebase`.`location_id` = `germinate_template_4_23_02_08`.`locations`.`id`))) left join `germinate_template_4_23_02_08`.`countries` on((`germinate_template_4_23_02_08`.`locations`.`country_id` = `germinate_template_4_23_02_08`.`countries`.`id`))) left join `germinate_template_4_23_02_08`.`biologicalstatus` on((`germinate_template_4_23_02_08`.`biologicalstatus`.`id` = `germinate_template_4_23_02_08`.`mcpd`.`sampstat`))) left join `germinate_template_4_23_02_08`.`synonyms` on(((`germinate_template_4_23_02_08`.`synonyms`.`foreign_id` = `germinate_template_4_23_02_08`.`germinatebase`.`id`) and (`germinate_template_4_23_02_08`.`synonyms`.`synonymtype_id` = 1))))"));
    }
