...
public class ViewTableGermplasmDeprecated extends TableImpl<ViewTableGermplasmDeprecatedRecord> {
    ...
    private ViewTableGermplasmDeprecated(Name alias, Table<ViewTableGermplasmDeprecatedRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_germplasm_deprecated` as select `germinate_template_4_22_08_10`.`germinatebase`.`name` AS `germplasm_name`,`germinate_template_4_22_08_10`.`germinatebase`.`id` AS `germplasm_id`,`germinate_template_4_22_08_10`.`germinatebase`.`general_identifier` AS `germplasm_gid`,`germinate_template_4_22_08_10`.`germinatebase`.`number` AS `germplasm_number`,`germinate_template_4_22_08_10`.`germinatebase`.`puid` AS `germplasm_puid`,`germinate_template_4_22_08_10`.`entitytypes`.`id` AS `entity_type_id`,`germinate_template_4_22_08_10`.`entitytypes`.`name` AS `entity_type_name`,`germinate_template_4_22_08_10`.`germinatebase`.`entityparent_id` AS `entity_parent_id`,`g`.`name` AS `entity_parent_name`,`g`.`general_identifier` AS `entity_parent_general_identifier`,`germinate_template_4_22_08_10`.`biologicalstatus`.`id` AS `biological_status_id`,`germinate_template_4_22_08_10`.`biologicalstatus`.`sampstat` AS `biological_status_name`,`germinate_template_4_22_08_10`.`synonyms`.`synonyms` AS `synonyms`,`germinate_template_4_22_08_10`.`germinatebase`.`collnumb` AS `collector_number`,`germinate_template_4_22_08_10`.`taxonomies`.`genus` AS `genus`,`germinate_template_4_22_08_10`.`taxonomies`.`species` AS `species`,`germinate_template_4_22_08_10`.`taxonomies`.`subtaxa` AS `subtaxa`,`germinate_template_4_22_08_10`.`institutions`.`id` AS `institution_id`,`germinate_template_4_22_08_10`.`institutions`.`name` AS `institution_name`,`germinate_template_4_22_08_10`.`locations`.`site_name` AS `location`,`germinate_template_4_22_08_10`.`locations`.`latitude` AS `latitude`,`germinate_template_4_22_08_10`.`locations`.`longitude` AS `longitude`,`germinate_template_4_22_08_10`.`locations`.`elevation` AS `elevation`,`germinate_template_4_22_08_10`.`countries`.`country_name` AS `country_name`,`germinate_template_4_22_08_10`.`countries`.`country_code2` AS `country_code`,`germinate_template_4_22_08_10`.`germinatebase`.`colldate` AS `coll_date`,`germinate_template_4_22_08_10`.`germinatebase`.`pdci` AS `pdci`,(select count(1) from (`germinate_template_4_22_08_10`.`images` left join `germinate_template_4_22_08_10`.`imagetypes` on((`germinate_template_4_22_08_10`.`imagetypes`.`id` = `germinate_template_4_22_08_10`.`images`.`imagetype_id`))) where ((`germinate_template_4_22_08_10`.`imagetypes`.`reference_table` = 'germinatebase') and (`germinate_template_4_22_08_10`.`images`.`foreign_id` = `germinate_template_4_22_08_10`.`germinatebase`.`id`))) AS `image_count`,(select `germinate_template_4_22_08_10`.`images`.`path` from (`germinate_template_4_22_08_10`.`images` left join `germinate_template_4_22_08_10`.`imagetypes` on((`germinate_template_4_22_08_10`.`imagetypes`.`id` = `germinate_template_4_22_08_10`.`images`.`imagetype_id`))) where ((`germinate_template_4_22_08_10`.`imagetypes`.`reference_table` = 'germinatebase') and (`germinate_template_4_22_08_10`.`images`.`foreign_id` = `germinate_template_4_22_08_10`.`germinatebase`.`id`)) limit 1) AS `first_image_path`,(select 1 from `germinate_template_4_22_08_10`.`phenotypedata` where (`germinate_template_4_22_08_10`.`phenotypedata`.`germinatebase_id` = `germinate_template_4_22_08_10`.`germinatebase`.`id`) limit 1) AS `has_trials_data`,(select 1 from (`germinate_template_4_22_08_10`.`datasetmembers` left join `germinate_template_4_22_08_10`.`datasets` on((`germinate_template_4_22_08_10`.`datasets`.`id` = `germinate_template_4_22_08_10`.`datasetmembers`.`dataset_id`))) where ((`germinate_template_4_22_08_10`.`datasetmembers`.`foreign_id` = `germinate_template_4_22_08_10`.`germinatebase`.`id`) and (`germinate_template_4_22_08_10`.`datasetmembers`.`datasetmembertype_id` = 2) and (`germinate_template_4_22_08_10`.`datasets`.`datasettype_id` = 1)) limit 1) AS `has_genotypic_data`,(select 1 from (`germinate_template_4_22_08_10`.`datasetmembers` left join `germinate_template_4_22_08_10`.`datasets` on((`germinate_template_4_22_08_10`.`datasets`.`id` = `germinate_template_4_22_08_10`.`datasetmembers`.`dataset_id`))) where ((`germinate_template_4_22_08_10`.`datasetmembers`.`foreign_id` = `germinate_template_4_22_08_10`.`germinatebase`.`id`) and (`germinate_template_4_22_08_10`.`datasetmembers`.`datasetmembertype_id` = 2) and (`germinate_template_4_22_08_10`.`datasets`.`datasettype_id` = 4)) limit 1) AS `has_allelefreq_data`,(select 1 from `germinate_template_4_22_08_10`.`compounddata` where (`germinate_template_4_22_08_10`.`compounddata`.`germinatebase_id` = `germinate_template_4_22_08_10`.`germinatebase`.`id`) limit 1) AS `has_compound_data` from ((((((((`germinate_template_4_22_08_10`.`germinatebase` left join `germinate_template_4_22_08_10`.`germinatebase` `g` on((`g`.`id` = `germinate_template_4_22_08_10`.`germinatebase`.`entityparent_id`))) left join `germinate_template_4_22_08_10`.`institutions` on((`germinate_template_4_22_08_10`.`institutions`.`id` = `germinate_template_4_22_08_10`.`germinatebase`.`institution_id`))) left join `germinate_template_4_22_08_10`.`entitytypes` on((`germinate_template_4_22_08_10`.`germinatebase`.`entitytype_id` = `germinate_template_4_22_08_10`.`entitytypes`.`id`))) left join `germinate_template_4_22_08_10`.`taxonomies` on((`germinate_template_4_22_08_10`.`germinatebase`.`taxonomy_id` = `germinate_template_4_22_08_10`.`taxonomies`.`id`))) left join `germinate_template_4_22_08_10`.`locations` on((`germinate_template_4_22_08_10`.`germinatebase`.`location_id` = `germinate_template_4_22_08_10`.`locations`.`id`))) left join `germinate_template_4_22_08_10`.`countries` on((`germinate_template_4_22_08_10`.`locations`.`country_id` = `germinate_template_4_22_08_10`.`countries`.`id`))) left join `germinate_template_4_22_08_10`.`biologicalstatus` on((`germinate_template_4_22_08_10`.`biologicalstatus`.`id` = `germinate_template_4_22_08_10`.`germinatebase`.`biologicalstatus_id`))) left join `germinate_template_4_22_08_10`.`synonyms` on(((`germinate_template_4_22_08_10`.`synonyms`.`foreign_id` = `germinate_template_4_22_08_10`.`germinatebase`.`id`) and (`germinate_template_4_22_08_10`.`synonyms`.`synonymtype_id` = 1))))"));
    }
