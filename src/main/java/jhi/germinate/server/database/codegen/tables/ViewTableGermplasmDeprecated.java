...
public class ViewTableGermplasmDeprecated extends TableImpl<ViewTableGermplasmDeprecatedRecord> {
    ...
    private ViewTableGermplasmDeprecated(Name alias, Table<ViewTableGermplasmDeprecatedRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_germplasm_deprecated` as select `germinate_template_4_25_01_23`.`germinatebase`.`name` AS `germplasm_name`,`germinate_template_4_25_01_23`.`germinatebase`.`id` AS `germplasm_id`,`germinate_template_4_25_01_23`.`germinatebase`.`general_identifier` AS `germplasm_gid`,`germinate_template_4_25_01_23`.`germinatebase`.`number` AS `germplasm_number`,`germinate_template_4_25_01_23`.`mcpd`.`puid` AS `gerplasm_puid`,`germinate_template_4_25_01_23`.`entitytypes`.`id` AS `entity_type_id`,`germinate_template_4_25_01_23`.`entitytypes`.`name` AS `entity_type_name`,`germinate_template_4_25_01_23`.`germinatebase`.`entityparent_id` AS `entity_parent_id`,`g`.`name` AS `entity_parent_name`,`g`.`general_identifier` AS `entity_parent_general_identifier`,`germinate_template_4_25_01_23`.`biologicalstatus`.`id` AS `biological_status_id`,`germinate_template_4_25_01_23`.`biologicalstatus`.`sampstat` AS `biological_status_name`,`germinate_template_4_25_01_23`.`synonyms`.`synonyms` AS `synonyms`,`germinate_template_4_25_01_23`.`mcpd`.`collnumb` AS `collector_number`,`germinate_template_4_25_01_23`.`taxonomies`.`genus` AS `genus`,`germinate_template_4_25_01_23`.`taxonomies`.`species` AS `species`,`germinate_template_4_25_01_23`.`taxonomies`.`subtaxa` AS `subtaxa`,(select json_arrayagg(json_object('id',`germinate_template_4_25_01_23`.`institutions`.`id`,'code',`germinate_template_4_25_01_23`.`institutions`.`code`,'name',`germinate_template_4_25_01_23`.`institutions`.`name`,'type',`germinate_template_4_25_01_23`.`germplasminstitutions`.`type`)) from (`germinate_template_4_25_01_23`.`germplasminstitutions` left join `germinate_template_4_25_01_23`.`institutions` on((`germinate_template_4_25_01_23`.`institutions`.`id` = `germinate_template_4_25_01_23`.`germplasminstitutions`.`institution_id`))) where (`germinate_template_4_25_01_23`.`germplasminstitutions`.`germinatebase_id` = `germinate_template_4_25_01_23`.`germinatebase`.`id`) group by `germinate_template_4_25_01_23`.`germplasminstitutions`.`germinatebase_id`) AS `institutions`,`germinate_template_4_25_01_23`.`locations`.`site_name` AS `location`,`germinate_template_4_25_01_23`.`locations`.`latitude` AS `latitude`,`germinate_template_4_25_01_23`.`locations`.`longitude` AS `longitude`,`germinate_template_4_25_01_23`.`locations`.`elevation` AS `elevation`,`germinate_template_4_25_01_23`.`countries`.`country_name` AS `country_name`,`germinate_template_4_25_01_23`.`countries`.`country_code2` AS `country_code`,`germinate_template_4_25_01_23`.`mcpd`.`colldate` AS `coll_date`,`germinate_template_4_25_01_23`.`germinatebase`.`pdci` AS `pdci`,(select count(1) from (`germinate_template_4_25_01_23`.`images` left join `germinate_template_4_25_01_23`.`imagetypes` on((`germinate_template_4_25_01_23`.`imagetypes`.`id` = `germinate_template_4_25_01_23`.`images`.`imagetype_id`))) where ((`germinate_template_4_25_01_23`.`imagetypes`.`reference_table` = 'germinatebase') and (`germinate_template_4_25_01_23`.`images`.`foreign_id` = `germinate_template_4_25_01_23`.`germinatebase`.`id`))) AS `image_count`,(select `germinate_template_4_25_01_23`.`images`.`path` from (`germinate_template_4_25_01_23`.`images` left join `germinate_template_4_25_01_23`.`imagetypes` on((`germinate_template_4_25_01_23`.`imagetypes`.`id` = `germinate_template_4_25_01_23`.`images`.`imagetype_id`))) where ((`germinate_template_4_25_01_23`.`imagetypes`.`reference_table` = 'germinatebase') and (`germinate_template_4_25_01_23`.`images`.`foreign_id` = `germinate_template_4_25_01_23`.`germinatebase`.`id`)) limit 1) AS `first_image_path`,(select 1 from `germinate_template_4_25_01_23`.`trialsetup` where (`germinate_template_4_25_01_23`.`trialsetup`.`germinatebase_id` = `germinate_template_4_25_01_23`.`germinatebase`.`id`) limit 1) AS `has_trials_data`,(select 1 from (`germinate_template_4_25_01_23`.`datasetmembers` left join `germinate_template_4_25_01_23`.`datasets` on((`germinate_template_4_25_01_23`.`datasets`.`id` = `germinate_template_4_25_01_23`.`datasetmembers`.`dataset_id`))) where ((`germinate_template_4_25_01_23`.`datasetmembers`.`foreign_id` = `germinate_template_4_25_01_23`.`germinatebase`.`id`) and (`germinate_template_4_25_01_23`.`datasetmembers`.`datasetmembertype_id` = 2) and (`germinate_template_4_25_01_23`.`datasets`.`datasettype_id` = 1)) limit 1) AS `has_genotypic_data`,(select 1 from (`germinate_template_4_25_01_23`.`datasetmembers` left join `germinate_template_4_25_01_23`.`datasets` on((`germinate_template_4_25_01_23`.`datasets`.`id` = `germinate_template_4_25_01_23`.`datasetmembers`.`dataset_id`))) where ((`germinate_template_4_25_01_23`.`datasetmembers`.`foreign_id` = `germinate_template_4_25_01_23`.`germinatebase`.`id`) and (`germinate_template_4_25_01_23`.`datasetmembers`.`datasetmembertype_id` = 2) and (`germinate_template_4_25_01_23`.`datasets`.`datasettype_id` = 4)) limit 1) AS `has_allelefreq_data` from ((((((((`germinate_template_4_25_01_23`.`germinatebase` left join `germinate_template_4_25_01_23`.`mcpd` on((`germinate_template_4_25_01_23`.`mcpd`.`germinatebase_id` = `germinate_template_4_25_01_23`.`germinatebase`.`id`))) left join `germinate_template_4_25_01_23`.`germinatebase` `g` on((`g`.`id` = `germinate_template_4_25_01_23`.`germinatebase`.`entityparent_id`))) left join `germinate_template_4_25_01_23`.`entitytypes` on((`germinate_template_4_25_01_23`.`germinatebase`.`entitytype_id` = `germinate_template_4_25_01_23`.`entitytypes`.`id`))) left join `germinate_template_4_25_01_23`.`taxonomies` on((`germinate_template_4_25_01_23`.`germinatebase`.`taxonomy_id` = `germinate_template_4_25_01_23`.`taxonomies`.`id`))) left join `germinate_template_4_25_01_23`.`locations` on((`germinate_template_4_25_01_23`.`germinatebase`.`location_id` = `germinate_template_4_25_01_23`.`locations`.`id`))) left join `germinate_template_4_25_01_23`.`countries` on((`germinate_template_4_25_01_23`.`locations`.`country_id` = `germinate_template_4_25_01_23`.`countries`.`id`))) left join `germinate_template_4_25_01_23`.`biologicalstatus` on((`germinate_template_4_25_01_23`.`biologicalstatus`.`id` = `germinate_template_4_25_01_23`.`mcpd`.`sampstat`))) left join `germinate_template_4_25_01_23`.`synonyms` on(((`germinate_template_4_25_01_23`.`synonyms`.`foreign_id` = `germinate_template_4_25_01_23`.`germinatebase`.`id`) and (`germinate_template_4_25_01_23`.`synonyms`.`synonymtype_id` = 1))))"));
    }
