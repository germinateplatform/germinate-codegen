...
public class ViewTableGermplasmDeprecated extends TableImpl<ViewTableGermplasmDeprecatedRecord> {
     ...
     */
    public final TableField<ViewTableGermplasmDeprecatedRecord, String> GERMPLASM_NAME = createField(DSL.name("germplasm_name"), SQLDataType.VARCHAR(255), this, "A unique name which defines an entry in the germinatbase table.");
     ...
     */
    public final TableField<ViewTableGermplasmDeprecatedRecord, Integer> GERMPLASM_ID = createField(DSL.name("germplasm_id"), SQLDataType.INTEGER.defaultValue(DSL.inline("0", SQLDataType.INTEGER)), this, "Primary id for this table. This uniquely identifies the row.");
     ...
     * A unique identifier.
     */
    public final TableField<ViewTableGermplasmDeprecatedRecord, String> GERMPLASM_GID = createField(DSL.name("germplasm_gid"), SQLDataType.VARCHAR(255), this, "A unique identifier.");
    ...
    private ViewTableGermplasmDeprecated(Name alias, Table<ViewTableGermplasmDeprecatedRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.view("create view `view_table_germplasm_deprecated` as select `germinate_template_5_26_01_28`.`germinatebase`.`name` AS `germplasm_name`,`germinate_template_5_26_01_28`.`germinatebase`.`id` AS `germplasm_id`,`germinate_template_5_26_01_28`.`germinatebase`.`general_identifier` AS `germplasm_gid`,`germinate_template_5_26_01_28`.`germinatebase`.`number` AS `germplasm_number`,`germinate_template_5_26_01_28`.`mcpd`.`puid` AS `gerplasm_puid`,`germinate_template_5_26_01_28`.`entitytypes`.`id` AS `entity_type_id`,`germinate_template_5_26_01_28`.`entitytypes`.`name` AS `entity_type_name`,`germinate_template_5_26_01_28`.`germinatebase`.`entityparent_id` AS `entity_parent_id`,`g`.`name` AS `entity_parent_name`,`g`.`general_identifier` AS `entity_parent_general_identifier`,`germinate_template_5_26_01_28`.`biologicalstatus`.`id` AS `biological_status_id`,`germinate_template_5_26_01_28`.`biologicalstatus`.`sampstat` AS `biological_status_name`,`germinate_template_5_26_01_28`.`synonyms`.`synonyms` AS `synonyms`,`germinate_template_5_26_01_28`.`mcpd`.`collnumb` AS `collector_number`,`germinate_template_5_26_01_28`.`taxonomies`.`genus` AS `genus`,`germinate_template_5_26_01_28`.`taxonomies`.`species` AS `species`,`germinate_template_5_26_01_28`.`taxonomies`.`subtaxa` AS `subtaxa`,(select json_arrayagg(json_object('id',`germinate_template_5_26_01_28`.`institutions`.`id`,'code',`germinate_template_5_26_01_28`.`institutions`.`code`,'name',`germinate_template_5_26_01_28`.`institutions`.`name`,'type',`germinate_template_5_26_01_28`.`germplasminstitutions`.`type`)) from (`germinate_template_5_26_01_28`.`germplasminstitutions` left join `germinate_template_5_26_01_28`.`institutions` on((`germinate_template_5_26_01_28`.`institutions`.`id` = `germinate_template_5_26_01_28`.`germplasminstitutions`.`institution_id`))) where (`germinate_template_5_26_01_28`.`germplasminstitutions`.`germinatebase_id` = `germinate_template_5_26_01_28`.`germinatebase`.`id`) group by `germinate_template_5_26_01_28`.`germplasminstitutions`.`germinatebase_id`) AS `institutions`,`germinate_template_5_26_01_28`.`locations`.`site_name` AS `location`,`germinate_template_5_26_01_28`.`locations`.`latitude` AS `latitude`,`germinate_template_5_26_01_28`.`locations`.`longitude` AS `longitude`,`germinate_template_5_26_01_28`.`locations`.`elevation` AS `elevation`,`germinate_template_5_26_01_28`.`countries`.`country_name` AS `country_name`,`germinate_template_5_26_01_28`.`countries`.`country_code2` AS `country_code`,`germinate_template_5_26_01_28`.`mcpd`.`colldate` AS `coll_date`,`germinate_template_5_26_01_28`.`germinatebase`.`pdci` AS `pdci`,(select count(1) from (`germinate_template_5_26_01_28`.`images` left join `germinate_template_5_26_01_28`.`imagetypes` on((`germinate_template_5_26_01_28`.`imagetypes`.`id` = `germinate_template_5_26_01_28`.`images`.`imagetype_id`))) where ((`germinate_template_5_26_01_28`.`imagetypes`.`reference_table` = 'germinatebase') and (`germinate_template_5_26_01_28`.`images`.`foreign_id` = `germinate_template_5_26_01_28`.`germinatebase`.`id`))) AS `image_count`,(select `germinate_template_5_26_01_28`.`images`.`path` from (`germinate_template_5_26_01_28`.`images` left join `germinate_template_5_26_01_28`.`imagetypes` on((`germinate_template_5_26_01_28`.`imagetypes`.`id` = `germinate_template_5_26_01_28`.`images`.`imagetype_id`))) where ((`germinate_template_5_26_01_28`.`imagetypes`.`reference_table` = 'germinatebase') and (`germinate_template_5_26_01_28`.`images`.`foreign_id` = `germinate_template_5_26_01_28`.`germinatebase`.`id`)) limit 1) AS `first_image_path`,(select 1 from `germinate_template_5_26_01_28`.`trialsetup` where (`germinate_template_5_26_01_28`.`trialsetup`.`germinatebase_id` = `germinate_template_5_26_01_28`.`germinatebase`.`id`) limit 1) AS `has_trials_data`,(select 1 from (`germinate_template_5_26_01_28`.`datasetmembers` left join `germinate_template_5_26_01_28`.`datasets` on((`germinate_template_5_26_01_28`.`datasets`.`id` = `germinate_template_5_26_01_28`.`datasetmembers`.`dataset_id`))) where ((`germinate_template_5_26_01_28`.`datasetmembers`.`foreign_id` = `germinate_template_5_26_01_28`.`germinatebase`.`id`) and (`germinate_template_5_26_01_28`.`datasetmembers`.`datasetmembertype_id` = 2) and (`germinate_template_5_26_01_28`.`datasets`.`datasettype_id` = 1)) limit 1) AS `has_genotypic_data`,(select 1 from (`germinate_template_5_26_01_28`.`datasetmembers` left join `germinate_template_5_26_01_28`.`datasets` on((`germinate_template_5_26_01_28`.`datasets`.`id` = `germinate_template_5_26_01_28`.`datasetmembers`.`dataset_id`))) where ((`germinate_template_5_26_01_28`.`datasetmembers`.`foreign_id` = `germinate_template_5_26_01_28`.`germinatebase`.`id`) and (`germinate_template_5_26_01_28`.`datasetmembers`.`datasetmembertype_id` = 2) and (`germinate_template_5_26_01_28`.`datasets`.`datasettype_id` = 4)) limit 1) AS `has_allelefreq_data` from ((((((((`germinate_template_5_26_01_28`.`germinatebase` left join `germinate_template_5_26_01_28`.`mcpd` on((`germinate_template_5_26_01_28`.`mcpd`.`germinatebase_id` = `germinate_template_5_26_01_28`.`germinatebase`.`id`))) left join `germinate_template_5_26_01_28`.`germinatebase` `g` on((`g`.`id` = `germinate_template_5_26_01_28`.`germinatebase`.`entityparent_id`))) left join `germinate_template_5_26_01_28`.`entitytypes` on((`germinate_template_5_26_01_28`.`germinatebase`.`entitytype_id` = `germinate_template_5_26_01_28`.`entitytypes`.`id`))) left join `germinate_template_5_26_01_28`.`taxonomies` on((`germinate_template_5_26_01_28`.`germinatebase`.`taxonomy_id` = `germinate_template_5_26_01_28`.`taxonomies`.`id`))) left join `germinate_template_5_26_01_28`.`locations` on((`germinate_template_5_26_01_28`.`germinatebase`.`location_id` = `germinate_template_5_26_01_28`.`locations`.`id`))) left join `germinate_template_5_26_01_28`.`countries` on((`germinate_template_5_26_01_28`.`locations`.`country_id` = `germinate_template_5_26_01_28`.`countries`.`id`))) left join `germinate_template_5_26_01_28`.`biologicalstatus` on((`germinate_template_5_26_01_28`.`biologicalstatus`.`id` = `germinate_template_5_26_01_28`.`mcpd`.`sampstat`))) left join `germinate_template_5_26_01_28`.`synonyms` on(((`germinate_template_5_26_01_28`.`synonyms`.`foreign_id` = `germinate_template_5_26_01_28`.`germinatebase`.`id`) and (`germinate_template_5_26_01_28`.`synonyms`.`synonymtype_id` = 1))))"), where);
    }
    ...
    @Override
    public ViewTableGermplasmDeprecated as(Table<?> alias) {
        return new ViewTableGermplasmDeprecated(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public ViewTableGermplasmDeprecated rename(Table<?> name) {
        return new ViewTableGermplasmDeprecated(name.getQualifiedName(), null);
    }
     ...
     */
    @Override
    public ViewTableGermplasmDeprecated where(Condition condition) {
        return new ViewTableGermplasmDeprecated(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public ViewTableGermplasmDeprecated where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public ViewTableGermplasmDeprecated where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public ViewTableGermplasmDeprecated where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public ViewTableGermplasmDeprecated where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public ViewTableGermplasmDeprecated where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public ViewTableGermplasmDeprecated where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public ViewTableGermplasmDeprecated where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public ViewTableGermplasmDeprecated whereExists(Select<?> select) {
     ...
     */
    @Override
    public ViewTableGermplasmDeprecated whereNotExists(Select<?> select) {
