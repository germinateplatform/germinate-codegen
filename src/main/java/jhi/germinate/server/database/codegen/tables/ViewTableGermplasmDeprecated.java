...
public class ViewTableGermplasmDeprecated extends TableImpl<ViewTableGermplasmDeprecatedRecord> {
    ...
    private ViewTableGermplasmDeprecated(Name alias, Table<ViewTableGermplasmDeprecatedRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_germplasm_deprecated` as select `germinate_template_4_24_09_27`.`germinatebase`.`name` AS `germplasm_name`,`germinate_template_4_24_09_27`.`germinatebase`.`id` AS `germplasm_id`,`germinate_template_4_24_09_27`.`germinatebase`.`general_identifier` AS `germplasm_gid`,`germinate_template_4_24_09_27`.`germinatebase`.`number` AS `germplasm_number`,`germinate_template_4_24_09_27`.`mcpd`.`puid` AS `gerplasm_puid`,`germinate_template_4_24_09_27`.`entitytypes`.`id` AS `entity_type_id`,`germinate_template_4_24_09_27`.`entitytypes`.`name` AS `entity_type_name`,`germinate_template_4_24_09_27`.`germinatebase`.`entityparent_id` AS `entity_parent_id`,`g`.`name` AS `entity_parent_name`,`g`.`general_identifier` AS `entity_parent_general_identifier`,`germinate_template_4_24_09_27`.`biologicalstatus`.`id` AS `biological_status_id`,`germinate_template_4_24_09_27`.`biologicalstatus`.`sampstat` AS `biological_status_name`,`germinate_template_4_24_09_27`.`synonyms`.`synonyms` AS `synonyms`,`germinate_template_4_24_09_27`.`mcpd`.`collnumb` AS `collector_number`,`germinate_template_4_24_09_27`.`taxonomies`.`genus` AS `genus`,`germinate_template_4_24_09_27`.`taxonomies`.`species` AS `species`,`germinate_template_4_24_09_27`.`taxonomies`.`subtaxa` AS `subtaxa`,(select json_arrayagg(json_object('id',`germinate_template_4_24_09_27`.`institutions`.`id`,'code',`germinate_template_4_24_09_27`.`institutions`.`code`,'name',`germinate_template_4_24_09_27`.`institutions`.`name`,'type',`germinate_template_4_24_09_27`.`germplasminstitutions`.`type`)) from (`germinate_template_4_24_09_27`.`germplasminstitutions` left join `germinate_template_4_24_09_27`.`institutions` on((`germinate_template_4_24_09_27`.`institutions`.`id` = `germinate_template_4_24_09_27`.`germplasminstitutions`.`institution_id`))) where (`germinate_template_4_24_09_27`.`germplasminstitutions`.`germinatebase_id` = `germinate_template_4_24_09_27`.`germinatebase`.`id`) group by `germinate_template_4_24_09_27`.`germplasminstitutions`.`germinatebase_id`) AS `institutions`,`germinate_template_4_24_09_27`.`locations`.`site_name` AS `location`,`germinate_template_4_24_09_27`.`locations`.`latitude` AS `latitude`,`germinate_template_4_24_09_27`.`locations`.`longitude` AS `longitude`,`germinate_template_4_24_09_27`.`locations`.`elevation` AS `elevation`,`germinate_template_4_24_09_27`.`countries`.`country_name` AS `country_name`,`germinate_template_4_24_09_27`.`countries`.`country_code2` AS `country_code`,`germinate_template_4_24_09_27`.`mcpd`.`colldate` AS `coll_date`,`germinate_template_4_24_09_27`.`germinatebase`.`pdci` AS `pdci`,(select count(1) from (`germinate_template_4_24_09_27`.`images` left join `germinate_template_4_24_09_27`.`imagetypes` on((`germinate_template_4_24_09_27`.`imagetypes`.`id` = `germinate_template_4_24_09_27`.`images`.`imagetype_id`))) where ((`germinate_template_4_24_09_27`.`imagetypes`.`reference_table` = 'germinatebase') and (`germinate_template_4_24_09_27`.`images`.`foreign_id` = `germinate_template_4_24_09_27`.`germinatebase`.`id`))) AS `image_count`,(select `germinate_template_4_24_09_27`.`images`.`path` from (`germinate_template_4_24_09_27`.`images` left join `germinate_template_4_24_09_27`.`imagetypes` on((`germinate_template_4_24_09_27`.`imagetypes`.`id` = `germinate_template_4_24_09_27`.`images`.`imagetype_id`))) where ((`germinate_template_4_24_09_27`.`imagetypes`.`reference_table` = 'germinatebase') and (`germinate_template_4_24_09_27`.`images`.`foreign_id` = `germinate_template_4_24_09_27`.`germinatebase`.`id`)) limit 1) AS `first_image_path`,(select 1 from `germinate_template_4_24_09_27`.`trialsetup` where (`germinate_template_4_24_09_27`.`trialsetup`.`germinatebase_id` = `germinate_template_4_24_09_27`.`germinatebase`.`id`) limit 1) AS `has_trials_data`,(select 1 from (`germinate_template_4_24_09_27`.`datasetmembers` left join `germinate_template_4_24_09_27`.`datasets` on((`germinate_template_4_24_09_27`.`datasets`.`id` = `germinate_template_4_24_09_27`.`datasetmembers`.`dataset_id`))) where ((`germinate_template_4_24_09_27`.`datasetmembers`.`foreign_id` = `germinate_template_4_24_09_27`.`germinatebase`.`id`) and (`germinate_template_4_24_09_27`.`datasetmembers`.`datasetmembertype_id` = 2) and (`germinate_template_4_24_09_27`.`datasets`.`datasettype_id` = 1)) limit 1) AS `has_genotypic_data`,(select 1 from (`germinate_template_4_24_09_27`.`datasetmembers` left join `germinate_template_4_24_09_27`.`datasets` on((`germinate_template_4_24_09_27`.`datasets`.`id` = `germinate_template_4_24_09_27`.`datasetmembers`.`dataset_id`))) where ((`germinate_template_4_24_09_27`.`datasetmembers`.`foreign_id` = `germinate_template_4_24_09_27`.`germinatebase`.`id`) and (`germinate_template_4_24_09_27`.`datasetmembers`.`datasetmembertype_id` = 2) and (`germinate_template_4_24_09_27`.`datasets`.`datasettype_id` = 4)) limit 1) AS `has_allelefreq_data` from ((((((((`germinate_template_4_24_09_27`.`germinatebase` left join `germinate_template_4_24_09_27`.`mcpd` on((`germinate_template_4_24_09_27`.`mcpd`.`germinatebase_id` = `germinate_template_4_24_09_27`.`germinatebase`.`id`))) left join `germinate_template_4_24_09_27`.`germinatebase` `g` on((`g`.`id` = `germinate_template_4_24_09_27`.`germinatebase`.`entityparent_id`))) left join `germinate_template_4_24_09_27`.`entitytypes` on((`germinate_template_4_24_09_27`.`germinatebase`.`entitytype_id` = `germinate_template_4_24_09_27`.`entitytypes`.`id`))) left join `germinate_template_4_24_09_27`.`taxonomies` on((`germinate_template_4_24_09_27`.`germinatebase`.`taxonomy_id` = `germinate_template_4_24_09_27`.`taxonomies`.`id`))) left join `germinate_template_4_24_09_27`.`locations` on((`germinate_template_4_24_09_27`.`germinatebase`.`location_id` = `germinate_template_4_24_09_27`.`locations`.`id`))) left join `germinate_template_4_24_09_27`.`countries` on((`germinate_template_4_24_09_27`.`locations`.`country_id` = `germinate_template_4_24_09_27`.`countries`.`id`))) left join `germinate_template_4_24_09_27`.`biologicalstatus` on((`germinate_template_4_24_09_27`.`biologicalstatus`.`id` = `germinate_template_4_24_09_27`.`mcpd`.`sampstat`))) left join `germinate_template_4_24_09_27`.`synonyms` on(((`germinate_template_4_24_09_27`.`synonyms`.`foreign_id` = `germinate_template_4_24_09_27`.`germinatebase`.`id`) and (`germinate_template_4_24_09_27`.`synonyms`.`synonymtype_id` = 1))))"));
    }
