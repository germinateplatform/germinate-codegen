...
public class Images extends TableImpl<ImagesRecord> {
    ...
    private static final long serialVersionUID = -1232259590;
    ...
    /**
     * The column <code>germinate_db.images.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.images.imagetype_id</code>. Foreign key to imagetypes (imagetypes.id).
     */
    ...
    /**
     * The column <code>germinate_db.images.description</code>. A description of what the image shows if required.
     */
    ...
    /**
     * The column <code>germinate_db.images.foreign_id</code>. Relates to the UID of the table to which the comment relates.
     */
    ...
    /**
     * The column <code>germinate_db.images.path</code>. The file system path to the image.
     */
    ...
    /**
     * The column <code>germinate_db.images.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.images.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    public Identity<ImagesRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Images.IMAGES, jhi.germinate.server.database.codegen.tables.Images.IMAGES.ID);
    }
    ...
    public UniqueKey<ImagesRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Images.IMAGES, "KEY_images_PRIMARY", jhi.germinate.server.database.codegen.tables.Images.IMAGES.ID);
    }
    ...
    public List<UniqueKey<ImagesRecord>> getKeys() {
        return Arrays.<UniqueKey<ImagesRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Images.IMAGES, "KEY_images_PRIMARY", jhi.germinate.server.database.codegen.tables.Images.IMAGES.ID)
        );
    }
