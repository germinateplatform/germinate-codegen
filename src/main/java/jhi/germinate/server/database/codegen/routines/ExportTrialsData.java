...
public class ExportTrialsData extends AbstractRoutine<java.lang.Void> {
    ...
    /**
     * The parameter <code>germinate_db.export_trials_data.groupIds</code>.
     */
    public static final Parameter<String> GROUPIDS = Internal.createParameter("groupIds", SQLDataType.CLOB, false, false);

    /**
     * The parameter <code>germinate_db.export_trials_data.markedIds</code>.
     */
    public static final Parameter<String> MARKEDIDS = Internal.createParameter("markedIds", SQLDataType.CLOB, false, false);

    /**
     * The parameter <code>germinate_db.export_trials_data.datasetIds</code>.
     */
    public static final Parameter<String> DATASETIDS = Internal.createParameter("datasetIds", SQLDataType.CLOB, false, false);

    /**
     * The parameter <code>germinate_db.export_trials_data.phenotypeIds</code>.
     */
    public static final Parameter<String> PHENOTYPEIDS = Internal.createParameter("phenotypeIds", SQLDataType.CLOB, false, false);

    /**
     * Create a new routine call instance
     */
    public ExportTrialsData() {
        super("export_trials_data", GerminateDb.GERMINATE_DB);
