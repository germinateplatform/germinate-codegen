...
public class Collaborators extends TableImpl<CollaboratorsRecord> {
    ...
    /**
     * The column <code>germinate_db.collaborators.first_name</code>. Last name (surname) of the author(s), researcher(s), scientist(s), student(s) responsible for producing the information product.
     */
    ...
    /**
     * The column <code>germinate_db.collaborators.last_name</code>. First name (and middle name if available) of the author(s), researcher(s), scientist(s), student(s) responsible for producing the information product.
     */
    ...
    /**
     * The column <code>germinate_db.collaborators.email</code>. E-mail address of the author(s), researcher(s), scientist(s), student(s) responsible for producing the information product.
     */
    ...
    /**
     * The column <code>germinate_db.collaborators.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.collaborators.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    public Identity<CollaboratorsRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Collaborators.COLLABORATORS, jhi.germinate.server.database.codegen.tables.Collaborators.COLLABORATORS.ID);
    }
    ...
    public UniqueKey<CollaboratorsRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Collaborators.COLLABORATORS, "KEY_collaborators_PRIMARY", jhi.germinate.server.database.codegen.tables.Collaborators.COLLABORATORS.ID);
    }
    ...
    public List<UniqueKey<CollaboratorsRecord>> getKeys() {
        return Arrays.<UniqueKey<CollaboratorsRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Collaborators.COLLABORATORS, "KEY_collaborators_PRIMARY", jhi.germinate.server.database.codegen.tables.Collaborators.COLLABORATORS.ID)
        );
    }
