...
public class Collaborators extends TableImpl<CollaboratorsRecord> {
     ...
     * record was created.
     */
    public final TableField<CollaboratorsRecord, Timestamp> CREATED_ON = createField(DSL.name("created_on"), SQLDataType.TIMESTAMP(0).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMP)), this, "When the record was created.");
    ...
    private Collaborators(Name alias, Table<CollaboratorsRecord> aliased, Field<?>[] parameters, Condition where) {
    ...
    @Override
    public Collaborators as(Table<?> alias) {
        return new Collaborators(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public Collaborators rename(Table<?> name) {
        return new Collaborators(name.getQualifiedName(), null);
    }
     ...
     */
    @Override
    public Collaborators where(Condition condition) {
        return new Collaborators(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public Collaborators where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public Collaborators where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public Collaborators where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public Collaborators where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public Collaborators where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public Collaborators where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public Collaborators where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public Collaborators whereExists(Select<?> select) {
     ...
     */
    @Override
    public Collaborators whereNotExists(Select<?> select) {
