...
public class Mapdefinitions extends TableImpl<MapdefinitionsRecord> {
    ...
    private static final long serialVersionUID = -992353067;
    ...
    /**
     * The column <code>germinate_db.mapdefinitions.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.mapdefinitions.mapfeaturetype_id</code>. Foreign key to mapfeaturetypes (mapfeaturetypes.id).
     */
    ...
    /**
     * The column <code>germinate_db.mapdefinitions.marker_id</code>. Foreign key to markers (markers.id).
     */
    ...
    /**
     * The column <code>germinate_db.mapdefinitions.map_id</code>. Foreign key to maps (maps.id).
     */
    ...
    /**
     * The column <code>germinate_db.mapdefinitions.definition_start</code>. Used if the markers location spans over an area more than a single point on the maps. Determines the marker start location.
     */
    ...
    /**
     * The column <code>germinate_db.mapdefinitions.definition_end</code>. Used if the markers location spans over an area more than a single point on the maps. Determines the marker end location.
     */
    ...
    /**
     * The column <code>germinate_db.mapdefinitions.chromosome</code>. The chromosome/linkage group that this marker is found on.
     */
    ...
    /**
     * The column <code>germinate_db.mapdefinitions.arm_impute</code>. If a chromosome arm is available then this can be entered here.
     */
    ...
    /**
     * The column <code>germinate_db.mapdefinitions.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.mapdefinitions.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Create an aliased <code>germinate_db.mapdefinitions</code> table reference
     */
    ...
    public Identity<MapdefinitionsRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Mapdefinitions.MAPDEFINITIONS, jhi.germinate.server.database.codegen.tables.Mapdefinitions.MAPDEFINITIONS.ID);
    }
    ...
    public UniqueKey<MapdefinitionsRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Mapdefinitions.MAPDEFINITIONS, "KEY_mapdefinitions_PRIMARY", jhi.germinate.server.database.codegen.tables.Mapdefinitions.MAPDEFINITIONS.ID);
    }
    ...
    public List<UniqueKey<MapdefinitionsRecord>> getKeys() {
        return Arrays.<UniqueKey<MapdefinitionsRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Mapdefinitions.MAPDEFINITIONS, "KEY_mapdefinitions_PRIMARY", jhi.germinate.server.database.codegen.tables.Mapdefinitions.MAPDEFINITIONS.ID)
        );
    }
