...
public class ViewStatsPdci extends TableImpl<ViewStatsPdciRecord> {
    ...
    private ViewStatsPdci(Name alias, Table<ViewStatsPdciRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_stats_pdci` as select '0-1' AS `bin`,count(1) AS `count` from `germinate_template_4_22_09_02`.`germinatebase` where ((`germinate_template_4_22_09_02`.`germinatebase`.`pdci` >= 0) and (`germinate_template_4_22_09_02`.`germinatebase`.`pdci` < 1) and (`germinate_template_4_22_09_02`.`germinatebase`.`entitytype_id` = 1)) union select '1-2' AS `bin`,count(1) AS `count` from `germinate_template_4_22_09_02`.`germinatebase` where ((`germinate_template_4_22_09_02`.`germinatebase`.`pdci` >= 1) and (`germinate_template_4_22_09_02`.`germinatebase`.`pdci` < 2) and (`germinate_template_4_22_09_02`.`germinatebase`.`entitytype_id` = 1)) union select '2-3' AS `bin`,count(1) AS `count` from `germinate_template_4_22_09_02`.`germinatebase` where ((`germinate_template_4_22_09_02`.`germinatebase`.`pdci` >= 2) and (`germinate_template_4_22_09_02`.`germinatebase`.`pdci` < 3) and (`germinate_template_4_22_09_02`.`germinatebase`.`entitytype_id` = 1)) union select '3-4' AS `bin`,count(1) AS `count` from `germinate_template_4_22_09_02`.`germinatebase` where ((`germinate_template_4_22_09_02`.`germinatebase`.`pdci` >= 3) and (`germinate_template_4_22_09_02`.`germinatebase`.`pdci` < 4) and (`germinate_template_4_22_09_02`.`germinatebase`.`entitytype_id` = 1)) union select '4-5' AS `bin`,count(1) AS `count` from `germinate_template_4_22_09_02`.`germinatebase` where ((`germinate_template_4_22_09_02`.`germinatebase`.`pdci` >= 4) and (`germinate_template_4_22_09_02`.`germinatebase`.`pdci` < 5) and (`germinate_template_4_22_09_02`.`germinatebase`.`entitytype_id` = 1)) union select '5-6' AS `bin`,count(1) AS `count` from `germinate_template_4_22_09_02`.`germinatebase` where ((`germinate_template_4_22_09_02`.`germinatebase`.`pdci` >= 5) and (`germinate_template_4_22_09_02`.`germinatebase`.`pdci` < 6) and (`germinate_template_4_22_09_02`.`germinatebase`.`entitytype_id` = 1)) union select '6-7' AS `bin`,count(1) AS `count` from `germinate_template_4_22_09_02`.`germinatebase` where ((`germinate_template_4_22_09_02`.`germinatebase`.`pdci` >= 6) and (`germinate_template_4_22_09_02`.`germinatebase`.`pdci` < 7) and (`germinate_template_4_22_09_02`.`germinatebase`.`entitytype_id` = 1)) union select '7-8' AS `bin`,count(1) AS `count` from `germinate_template_4_22_09_02`.`germinatebase` where ((`germinate_template_4_22_09_02`.`germinatebase`.`pdci` >= 7) and (`germinate_template_4_22_09_02`.`germinatebase`.`pdci` < 8) and (`germinate_template_4_22_09_02`.`germinatebase`.`entitytype_id` = 1)) union select '8-9' AS `bin`,count(1) AS `count` from `germinate_template_4_22_09_02`.`germinatebase` where ((`germinate_template_4_22_09_02`.`germinatebase`.`pdci` >= 8) and (`germinate_template_4_22_09_02`.`germinatebase`.`pdci` < 9) and (`germinate_template_4_22_09_02`.`germinatebase`.`entitytype_id` = 1)) union select '9-10' AS `bin`,count(1) AS `count` from `germinate_template_4_22_09_02`.`germinatebase` where ((`germinate_template_4_22_09_02`.`germinatebase`.`pdci` >= 9) and (`germinate_template_4_22_09_02`.`germinatebase`.`pdci` <= 10) and (`germinate_template_4_22_09_02`.`germinatebase`.`entitytype_id` = 1))"));
    }
