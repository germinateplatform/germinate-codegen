...
public class DatasetsRecord extends UpdatableRecordImpl<DatasetsRecord> implements Record19<Integer, Integer, Integer, String, String, Date, Date, String, String, DublinCore, String, Integer, Integer, Integer, Boolean, String, Timestamp, Timestamp, String> {
    ...
    private static final long serialVersionUID = -1859155115;

    /**
     * Setter for <code>germinate_db.datasets.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Getter for <code>germinate_db.datasets.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Setter for <code>germinate_db.datasets.experiment_id</code>. Foreign key to experiments (experiments.id).
     */
    ...
    /**
     * Getter for <code>germinate_db.datasets.experiment_id</code>. Foreign key to experiments (experiments.id).
     */
    ...
    /**
     * Setter for <code>germinate_db.datasets.datasettype_id</code>. Foreign key to datasettypes (datasettypes.id).
     */
    ...
    /**
     * Getter for <code>germinate_db.datasets.datasettype_id</code>. Foreign key to datasettypes (datasettypes.id).
     */
    ...
    /**
     * Setter for <code>germinate_db.datasets.name</code>. Describes the dataset.
     */
    ...
    /**
     * Getter for <code>germinate_db.datasets.name</code>. Describes the dataset.
     */
    ...
    /**
     * Setter for <code>germinate_db.datasets.description</code>. The name of this dataset.
     */
    ...
    /**
     * Getter for <code>germinate_db.datasets.description</code>. The name of this dataset.
     */
    ...
    /**
     * Setter for <code>germinate_db.datasets.date_start</code>. Date that the dataset was generated.
     */
    ...
    /**
     * Getter for <code>germinate_db.datasets.date_start</code>. Date that the dataset was generated.
     */
    ...
    /**
     * Setter for <code>germinate_db.datasets.date_end</code>. Date at which the dataset recording ended.
     */
    ...
    /**
     * Getter for <code>germinate_db.datasets.date_end</code>. Date at which the dataset recording ended.
     */
    ...
    /**
     * Setter for <code>germinate_db.datasets.datatype</code>. A description of the data type of the contained data. Examples might be: "raw data", "BLUPs", etc.
     */
    ...
    /**
     * Getter for <code>germinate_db.datasets.datatype</code>. A description of the data type of the contained data. Examples might be: "raw data", "BLUPs", etc.
     */
    ...
    /**
     * Setter for <code>germinate_db.datasets.version</code>. Dataset version if this exists.
     */
    ...
    /**
     * Getter for <code>germinate_db.datasets.version</code>. Dataset version if this exists.
     */
    ...
    /**
     * Setter for <code>germinate_db.datasets.created_by</code>. Defines who created the dataset. This is a FK in Gatekeeper users table. Foreign key to Gatekeeper users (users.id).
     */
    ...
    /**
     * Getter for <code>germinate_db.datasets.created_by</code>. Defines who created the dataset. This is a FK in Gatekeeper users table. Foreign key to Gatekeeper users (users.id).
     */
    ...
    /**
     * Setter for <code>germinate_db.datasets.dataset_state_id</code>. Foreign key to datasetstates (datasetstates.id).
     */
    ...
    /**
     * Getter for <code>germinate_db.datasets.dataset_state_id</code>. Foreign key to datasetstates (datasetstates.id).
     */
    ...
    /**
     * Setter for <code>germinate_db.datasets.is_external</code>. Defines if the dataset is contained within Germinate or from an external source and not stored in the database.
     */
    ...
    /**
     * Getter for <code>germinate_db.datasets.is_external</code>. Defines if the dataset is contained within Germinate or from an external source and not stored in the database.
     */
    ...
    /**
     * Setter for <code>germinate_db.datasets.hyperlink</code>. Link to access the external dasets.
     */
    ...
    /**
     * Getter for <code>germinate_db.datasets.hyperlink</code>. Link to access the external dasets.
     */
    ...
    /**
     * Setter for <code>germinate_db.datasets.created_on</code>. When the record was created.
    ...
    /**
     * Getter for <code>germinate_db.datasets.created_on</code>. When the record was created.
    ...
    /**
     * Setter for <code>germinate_db.datasets.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Getter for <code>germinate_db.datasets.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Setter for <code>germinate_db.datasets.contact</code>. The contact to get more information about this dataset.
     */
    ...
    /**
     * Getter for <code>germinate_db.datasets.contact</code>. The contact to get more information about this dataset.
     */
