...
public class ViewTableClimatesRecord extends TableRecordImpl<ViewTableClimatesRecord> implements Record11<Integer, String, String, String, ViewTableClimatesDataType, Integer, String, String, Long, String, Long> {
    ...
    /**
     * Getter for <code>germinate_db.view_table_climates.climate_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_climates.climate_name</code>. Describes the climate.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_climates.climate_name</code>. Describes the climate.
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_climates.climate_name_short</code>. Shortened version of the climate name which is used in some table headers.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_climates.climate_name_short</code>. Shortened version of the climate name which is used in some table headers.
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_climates.climate_description</code>. A longer description of the climate.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_climates.climate_description</code>. A longer description of the climate.
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_climates.unit_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_climates.unit_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_climates.unit_name</code>. The name of the unit. This should be the name of the unit in full.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_climates.unit_name</code>. The name of the unit. This should be the name of the unit in full.
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_climates.unit_description</code>. A description of the unit. If the unit is not a standard SI unit then it is beneficial to have a description which explains what the unit it, how it is derived and any other information which would help identifiy it.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_climates.unit_description</code>. A description of the unit. If the unit is not a standard SI unit then it is beneficial to have a description which explains what the unit it, how it is derived and any other information which would help identifiy it.
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_climates.unit_abbreviation</code>. This should be the unit abbreviation.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_climates.unit_abbreviation</code>. This should be the unit abbreviation.
     */
