...
public class ViewTableUsergroups extends TableImpl<ViewTableUsergroupsRecord> {
    ...
    private ViewTableUsergroups(Name alias, Table<ViewTableUsergroupsRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.view("create view `view_table_usergroups` as select `germinate_template_5_26_01_28`.`usergroups`.`id` AS `user_group_id`,`germinate_template_5_26_01_28`.`usergroups`.`name` AS `user_group_name`,`germinate_template_5_26_01_28`.`usergroups`.`description` AS `user_group_description`,`germinate_template_5_26_01_28`.`usergroups`.`created_on` AS `created_on`,count(`germinate_template_5_26_01_28`.`usergroupmembers`.`id`) AS `count` from (`germinate_template_5_26_01_28`.`usergroups` left join `germinate_template_5_26_01_28`.`usergroupmembers` on((`germinate_template_5_26_01_28`.`usergroupmembers`.`usergroup_id` = `germinate_template_5_26_01_28`.`usergroups`.`id`))) group by `germinate_template_5_26_01_28`.`usergroups`.`id`"), where);
    }
