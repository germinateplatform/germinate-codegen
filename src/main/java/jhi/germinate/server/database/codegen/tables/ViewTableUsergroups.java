...
public class ViewTableUsergroups extends TableImpl<ViewTableUsergroupsRecord> {
    ...
    private ViewTableUsergroups(Name alias, Table<ViewTableUsergroupsRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_usergroups` as select `germinate_template_4_25_01_23`.`usergroups`.`id` AS `user_group_id`,`germinate_template_4_25_01_23`.`usergroups`.`name` AS `user_group_name`,`germinate_template_4_25_01_23`.`usergroups`.`description` AS `user_group_description`,`germinate_template_4_25_01_23`.`usergroups`.`created_on` AS `created_on`,count(`germinate_template_4_25_01_23`.`usergroupmembers`.`id`) AS `count` from (`germinate_template_4_25_01_23`.`usergroups` left join `germinate_template_4_25_01_23`.`usergroupmembers` on((`germinate_template_4_25_01_23`.`usergroupmembers`.`usergroup_id` = `germinate_template_4_25_01_23`.`usergroups`.`id`))) group by `germinate_template_4_25_01_23`.`usergroups`.`id`"));
    }
