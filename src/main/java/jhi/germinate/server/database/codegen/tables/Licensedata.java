...
public class Licensedata extends TableImpl<LicensedataRecord> {
    ...
    private static final long serialVersionUID = 1454034952;
    ...
    /**
     * The column <code>germinate_db.licensedata.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.licensedata.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    public Identity<LicensedataRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Licensedata.LICENSEDATA, jhi.germinate.server.database.codegen.tables.Licensedata.LICENSEDATA.ID);
    }
    ...
    public UniqueKey<LicensedataRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Licensedata.LICENSEDATA, "KEY_licensedata_PRIMARY", jhi.germinate.server.database.codegen.tables.Licensedata.LICENSEDATA.ID);
    }
    ...
    public List<UniqueKey<LicensedataRecord>> getKeys() {
        return Arrays.<UniqueKey<LicensedataRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Licensedata.LICENSEDATA, "KEY_licensedata_PRIMARY", jhi.germinate.server.database.codegen.tables.Licensedata.LICENSEDATA.ID)
        );
    }
