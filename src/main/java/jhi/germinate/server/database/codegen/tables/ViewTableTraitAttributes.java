...
public class ViewTableTraitAttributes extends TableImpl<ViewTableTraitAttributesRecord> {
    ...
    private ViewTableTraitAttributes(Name alias, Table<ViewTableTraitAttributesRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_trait_attributes` as select `germinate_template_4_22_10_12`.`attributedata`.`id` AS `attribute_value_id`,`germinate_template_4_22_10_12`.`phenotypes`.`id` AS `trait_id`,`germinate_template_4_22_10_12`.`phenotypes`.`name` AS `trait_name`,`germinate_template_4_22_10_12`.`attributes`.`id` AS `attribute_id`,`germinate_template_4_22_10_12`.`attributes`.`name` AS `attribute_name`,`germinate_template_4_22_10_12`.`attributes`.`description` AS `attribute_description`,`germinate_template_4_22_10_12`.`attributes`.`datatype` AS `attribute_type`,`germinate_template_4_22_10_12`.`attributes`.`target_table` AS `target_table`,`germinate_template_4_22_10_12`.`attributedata`.`foreign_id` AS `foreign_id`,`germinate_template_4_22_10_12`.`attributedata`.`created_on` AS `created_on`,`germinate_template_4_22_10_12`.`attributedata`.`value` AS `attribute_value` from ((`germinate_template_4_22_10_12`.`attributedata` left join `germinate_template_4_22_10_12`.`phenotypes` on((`germinate_template_4_22_10_12`.`attributedata`.`foreign_id` = `germinate_template_4_22_10_12`.`phenotypes`.`id`))) left join `germinate_template_4_22_10_12`.`attributes` on((`germinate_template_4_22_10_12`.`attributes`.`id` = `germinate_template_4_22_10_12`.`attributedata`.`attribute_id`))) where (`germinate_template_4_22_10_12`.`attributes`.`target_table` = 'phenotypes')"));
    }
