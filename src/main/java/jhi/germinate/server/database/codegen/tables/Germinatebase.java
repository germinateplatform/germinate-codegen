...
public class Germinatebase extends TableImpl<GerminatebaseRecord> {
    ...
    private static final long serialVersionUID = 740012406;
    ...
    /**
     * The column <code>germinate_db.germinatebase.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.germinatebase.general_identifier</code>. A unique identifier.
     */
    ...
    /**
     * The column <code>germinate_db.germinatebase.number</code>. This is the unique identifier for accessions within a genebank, and is assigned when a sample is
entered into the genebank collection (e.g. ‘PI 113869’).
    ...
    /**
     * The column <code>germinate_db.germinatebase.name</code>. A unique name which defines an entry in the germinatbase table.
     */
    ...
    /**
     * The column <code>germinate_db.germinatebase.bank_number</code>. Alternative genebank number.
     */
    ...
    /**
     * The column <code>germinate_db.germinatebase.breeders_code</code>. FAO WIEWS code of the institute that has bred the material. If the holding institute has bred the material, the breeding institute code (BREDCODE) should be the same as the holding institute code (INSTCODE). Follows INSTCODE standard. Multiple values are separated by a semicolon without space.
     */
    ...
    /**
     * The column <code>germinate_db.germinatebase.taxonomy_id</code>. Foreign key to taxonomies (taxonomies.id).
     */
    ...
    /**
     * The column <code>germinate_db.germinatebase.institution_id</code>. Foreign key to institutions (institutions.id).
     */
    ...
    /**
     * The column <code>germinate_db.germinatebase.plant_passport</code>. Record if the entry has a plant passport.
     */
    ...
    /**
     * The column <code>germinate_db.germinatebase.donor_code</code>. FAO WIEWS code of the donor institute. Follows INSTCODE standard.
     */
    ...
    /**
     * The column <code>germinate_db.germinatebase.donor_name</code>. Name of the donor institute (or person). This descriptor should be used only if DONORCODE cannot be filled because the FAO WIEWS code for this institute is not available.
     */
    ...
    /**
     * The column <code>germinate_db.germinatebase.donor_number</code>. Identifier assigned to an accession by the donor. Follows ACCENUMB standard.
     */
    ...
    /**
     * The column <code>germinate_db.germinatebase.acqdate</code>. Date on which the accession entered the collection where YYYY is the year, MM is the month and
DD is the day. Missing data (MM or DD) should be indicated with hyphens or ‘00’ [double zero].
    ...
    /**
     * The column <code>germinate_db.germinatebase.collnumb</code>. Original identifier assigned by the collector(s) of the sample, normally composed of the name or
...
identifying duplicates held in different collections.
    ...
    /**
     * The column <code>germinate_db.germinatebase.colldate</code>. Collecting date of the sample, where YYYY is the year, MM is the month and DD is the day.
Missing data (MM or DD) should be indicated with hyphens or ‘00’ [double zero]. 
    ...
    /**
     * The column <code>germinate_db.germinatebase.collcode</code>. FAO WIEWS code of the institute collecting the sample. If the holding institute has collected the
...
without space.
    ...
    /**
     * The column <code>germinate_db.germinatebase.collname</code>. Name of the institute collecting the sample. This descriptor should be used only if COLLCODE cannot be filled because the FAO WIEWS code for this institute is not available. Multiple values are separated by a semicolon without space.
     */
    ...
    /**
     * The column <code>germinate_db.germinatebase.collmissid</code>. Identifier of the collecting mission used by the Collecting Institute (4 or 4.1) (e.g. 'CIATFOR-052', 'CN426').
     */
    ...
    /**
     * The column <code>germinate_db.germinatebase.othernumb</code>. Any other identifiers known to exist in other collections for this accession. Use the following format: INSTCODE:ACCENUMB;INSTCODE:identifier;… INSTCODE and identifier are separated by a colon without space. Pairs of INSTCODE and identifier are separated by a semicolon without space. When the institute is not known, the identifier should be preceded by a colon.
     */
    ...
    /**
     * The column <code>germinate_db.germinatebase.duplsite</code>. FAO WIEWS code of the institute(s) where a safety duplicate of the accession is maintained.
Multiple values are separated by a semicolon without space. Follows INSTCODE standard.
    ...
    /**
     * The column <code>germinate_db.germinatebase.duplinstname</code>. Name of the institute where a safety duplicate of the accession is maintained. Multiple values are separated by a semicolon without space.
     */
    ...
    /**
     * The column <code>germinate_db.germinatebase.mlsstatus_id</code>. Foreign key to mlsstatus (mlsstatus.id).
     */
    ...
    /**
     * The column <code>germinate_db.germinatebase.puid</code>. Any persistent, unique identifier assigned to the accession so it can be unambiguously referenced at the global level and the information associated with it harvested through automated means. Report one PUID for each accession.
     */
    ...
    /**
     * The column <code>germinate_db.germinatebase.biologicalstatus_id</code>. Foreign key to biologicalstatus (biologicalstaus.id).
     */
    ...
    /**
     * The column <code>germinate_db.germinatebase.collsrc_id</code>. Foreign key to collectionsources (collectionsources.id).
     */
    ...
    /**
     * The column <code>germinate_db.germinatebase.location_id</code>. Foreign key to locations (locations.id).
     */
    ...
    /**
     * The column <code>germinate_db.germinatebase.entitytype_id</code>. Foreign key to entitytypes (entitytypes.id).
     */
    ...
    /**
     * The column <code>germinate_db.germinatebase.entityparent_id</code>. Foreign key to germinatebase (germinatebase.id).
     */
    ...
    /**
     * The column <code>germinate_db.germinatebase.pdci</code>. Passport Data Completeness Index. This is calculated by Germinate. Manual editing of this field will be overwritten.
     */
    ...
    /**
     * The column <code>germinate_db.germinatebase.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.germinatebase.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    public Identity<GerminatebaseRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Germinatebase.GERMINATEBASE, jhi.germinate.server.database.codegen.tables.Germinatebase.GERMINATEBASE.ID);
    }
    ...
    public UniqueKey<GerminatebaseRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Germinatebase.GERMINATEBASE, "KEY_germinatebase_PRIMARY", jhi.germinate.server.database.codegen.tables.Germinatebase.GERMINATEBASE.ID);
    }
    ...
    public List<UniqueKey<GerminatebaseRecord>> getKeys() {
        return Arrays.<UniqueKey<GerminatebaseRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Germinatebase.GERMINATEBASE, "KEY_germinatebase_PRIMARY", jhi.germinate.server.database.codegen.tables.Germinatebase.GERMINATEBASE.ID)
        );
    }
