...
public class Germinatebase extends TableImpl<GerminatebaseRecord> {
     ...
     * record was created.
     */
    public final TableField<GerminatebaseRecord, Timestamp> CREATED_ON = createField(DSL.name("created_on"), SQLDataType.TIMESTAMP(0).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMP)), this, "When the record was created.");
    ...
    private Germinatebase(Name alias, Table<GerminatebaseRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment("Germinatebase is the Germinate base table which contains passport and other germplasm definition data."), TableOptions.table(), where);
    }
    ...
    @Override
    public Germinatebase as(Table<?> alias) {
        return new Germinatebase(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public Germinatebase rename(Table<?> name) {
        return new Germinatebase(name.getQualifiedName(), null);
    }
     ...
     */
    @Override
    public Germinatebase where(Condition condition) {
        return new Germinatebase(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public Germinatebase where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public Germinatebase where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public Germinatebase where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public Germinatebase where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public Germinatebase where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public Germinatebase where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public Germinatebase where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public Germinatebase whereExists(Select<?> select) {
     ...
     */
    @Override
    public Germinatebase whereNotExists(Select<?> select) {
