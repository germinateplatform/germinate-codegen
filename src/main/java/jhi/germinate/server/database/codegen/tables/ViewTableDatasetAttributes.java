...
public class ViewTableDatasetAttributes extends TableImpl<ViewTableDatasetAttributesRecord> {
    ...
    /**
     * The column <code>germinate_db.view_table_dataset_attributes.dataset_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_dataset_attributes.dataset_name</code>. Describes the dataset.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_dataset_attributes.dataset_description</code>. The name of this dataset.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_dataset_attributes.attribute_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_dataset_attributes.attribute_name</code>. Defines the name of the attribute.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_dataset_attributes.attribute_description</code>. Describes the attribute. This should expand on the name to make it clear what the attribute actually is.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_dataset_attributes.foreign_id</code>. Foreign key to germinatebase (germinatebase.id).
     */
    ...
    /**
     * The column <code>germinate_db.view_table_dataset_attributes.attribute_value</code>. The value of the attribute.
     */
    ...
    /**
     * Create a <code>germinate_db.view_table_dataset_attributes</code> table reference
     */
    ...
    /**
     * Create an aliased <code>germinate_db.view_table_dataset_attributes</code> table reference
     */
