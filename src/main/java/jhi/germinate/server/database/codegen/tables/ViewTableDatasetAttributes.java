...
public class ViewTableDatasetAttributes extends TableImpl<ViewTableDatasetAttributesRecord> {
    ...
    private ViewTableDatasetAttributes(Name alias, Table<ViewTableDatasetAttributesRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_dataset_attributes` as select `germinate_template_4_22_09_02`.`datasets`.`id` AS `dataset_id`,`germinate_template_4_22_09_02`.`datasets`.`name` AS `dataset_name`,`germinate_template_4_22_09_02`.`datasets`.`description` AS `dataset_description`,`germinate_template_4_22_09_02`.`attributes`.`id` AS `attribute_id`,`germinate_template_4_22_09_02`.`attributes`.`name` AS `attribute_name`,`germinate_template_4_22_09_02`.`attributes`.`description` AS `attribute_description`,`germinate_template_4_22_09_02`.`attributes`.`datatype` AS `attribute_type`,`germinate_template_4_22_09_02`.`attributes`.`target_table` AS `target_table`,`germinate_template_4_22_09_02`.`attributedata`.`foreign_id` AS `foreign_id`,`germinate_template_4_22_09_02`.`attributedata`.`value` AS `attribute_value` from ((`germinate_template_4_22_09_02`.`attributedata` left join `germinate_template_4_22_09_02`.`datasets` on((`germinate_template_4_22_09_02`.`attributedata`.`foreign_id` = `germinate_template_4_22_09_02`.`datasets`.`id`))) left join `germinate_template_4_22_09_02`.`attributes` on((`germinate_template_4_22_09_02`.`attributes`.`id` = `germinate_template_4_22_09_02`.`attributedata`.`attribute_id`))) where (`germinate_template_4_22_09_02`.`attributes`.`target_table` = 'datasets')"));
    }
