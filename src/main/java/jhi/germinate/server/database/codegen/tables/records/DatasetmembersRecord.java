...
public class DatasetmembersRecord extends UpdatableRecordImpl<DatasetmembersRecord> implements Record6<Integer, Integer, Integer, Integer, Timestamp, Timestamp> {
    ...
    private static final long serialVersionUID = -263065594;
    ...
    /**
     * Setter for <code>germinate_db.datasetmembers.created_on</code>. When the record was created.
     */
    ...
    /**
     * Getter for <code>germinate_db.datasetmembers.created_on</code>. When the record was created.
     */
    ...
    /**
     * Setter for <code>germinate_db.datasetmembers.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Getter for <code>germinate_db.datasetmembers.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
