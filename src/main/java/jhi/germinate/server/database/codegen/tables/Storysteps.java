...
public class Storysteps extends TableImpl<StorystepsRecord> {
     ...
     */
    public final TableField<StorystepsRecord, Timestamp> CREATED_ON = createField(DSL.name("created_on"), SQLDataType.TIMESTAMP(0).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>germinate_db.storysteps.updated_on</code>.
     */
    public final TableField<StorystepsRecord, Timestamp> UPDATED_ON = createField(DSL.name("updated_on"), SQLDataType.TIMESTAMP(0).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMP)), this, "");

    private Storysteps(Name alias, Table<StorystepsRecord> aliased) {
        this(alias, aliased, (Field<?>[]) null, null);
    }

    private Storysteps(Name alias, Table<StorystepsRecord> aliased, Field<?>[] parameters, Condition where) {
    ...
    @Override
    public Storysteps as(Table<?> alias) {
        return new Storysteps(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public Storysteps rename(Table<?> name) {
        return new Storysteps(name.getQualifiedName(), null);
    }
     ...
     */
    @Override
    public Storysteps where(Condition condition) {
        return new Storysteps(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public Storysteps where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public Storysteps where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public Storysteps where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public Storysteps where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public Storysteps where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public Storysteps where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public Storysteps where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public Storysteps whereExists(Select<?> select) {
     ...
     */
    @Override
    public Storysteps whereNotExists(Select<?> select) {
