...
public class ViewTableCommentsRecord extends TableRecordImpl<ViewTableCommentsRecord> implements Record8<Integer, Integer, String, Integer, Integer, String, String, Timestamp> {
    ...
    private static final long serialVersionUID = -226368914;

    /**
     * Setter for <code>germinate_db.view_table_comments.comment_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_comments.comment_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_comments.comment_type_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_comments.comment_type_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_comments.comment_type</code>. This could include 'germinatebase' or 'markers' to define the table that the comment relates to.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_comments.comment_type</code>. This could include 'germinatebase' or 'markers' to define the table that the comment relates to.
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_comments.comment_foreign_id</code>. Relates to the UID of the table to which the comment relates
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_comments.comment_foreign_id</code>. Relates to the UID of the table to which the comment relates
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_comments.user_id</code>. Foreign key to Gatekeeper users (Gatekeeper users.id).
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_comments.user_id</code>. Foreign key to Gatekeeper users (Gatekeeper users.id).
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_comments.comment_content</code>. The comment content.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_comments.comment_content</code>. The comment content.
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_comments.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_comments.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
