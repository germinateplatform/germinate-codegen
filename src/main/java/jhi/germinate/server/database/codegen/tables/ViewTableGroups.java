...
public class ViewTableGroups extends TableImpl<ViewTableGroupsRecord> {
    ...
    private ViewTableGroups(Name alias, Table<ViewTableGroupsRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_groups` as select `germinate_template_4_23_02_16`.`groups`.`id` AS `group_id`,`germinate_template_4_23_02_16`.`groups`.`name` AS `group_name`,`germinate_template_4_23_02_16`.`groups`.`description` AS `group_description`,`germinate_template_4_23_02_16`.`grouptypes`.`id` AS `group_type_id`,`germinate_template_4_23_02_16`.`grouptypes`.`target_table` AS `group_type`,'' AS `user_name`,`germinate_template_4_23_02_16`.`groups`.`created_by` AS `user_id`,`germinate_template_4_23_02_16`.`groups`.`visibility` AS `group_visibility`,`germinate_template_4_23_02_16`.`groups`.`created_on` AS `created_on`,`germinate_template_4_23_02_16`.`groups`.`updated_on` AS `updated_on`,count(`germinate_template_4_23_02_16`.`groupmembers`.`id`) AS `count` from ((`germinate_template_4_23_02_16`.`groups` left join `germinate_template_4_23_02_16`.`grouptypes` on((`germinate_template_4_23_02_16`.`groups`.`grouptype_id` = `germinate_template_4_23_02_16`.`grouptypes`.`id`))) left join `germinate_template_4_23_02_16`.`groupmembers` on((`germinate_template_4_23_02_16`.`groupmembers`.`group_id` = `germinate_template_4_23_02_16`.`groups`.`id`))) group by `germinate_template_4_23_02_16`.`groups`.`id`"));
    }
