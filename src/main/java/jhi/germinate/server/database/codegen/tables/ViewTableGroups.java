...
public class ViewTableGroups extends TableImpl<ViewTableGroupsRecord> {
    ...
    private ViewTableGroups(Name alias, Table<ViewTableGroupsRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_groups` as select `germinate_template_4_25_01_23`.`groups`.`id` AS `group_id`,`germinate_template_4_25_01_23`.`groups`.`name` AS `group_name`,`germinate_template_4_25_01_23`.`groups`.`description` AS `group_description`,`germinate_template_4_25_01_23`.`grouptypes`.`id` AS `group_type_id`,`germinate_template_4_25_01_23`.`grouptypes`.`target_table` AS `group_type`,'' AS `user_name`,`germinate_template_4_25_01_23`.`groups`.`created_by` AS `user_id`,`germinate_template_4_25_01_23`.`groups`.`visibility` AS `group_visibility`,`germinate_template_4_25_01_23`.`groups`.`created_on` AS `created_on`,`germinate_template_4_25_01_23`.`groups`.`updated_on` AS `updated_on`,(select json_arrayagg(`germinate_template_4_25_01_23`.`projectgroups`.`project_id`) from `germinate_template_4_25_01_23`.`projectgroups` where (`germinate_template_4_25_01_23`.`projectgroups`.`group_id` = `germinate_template_4_25_01_23`.`groups`.`id`) group by `germinate_template_4_25_01_23`.`projectgroups`.`group_id`) AS `project_ids`,count(`germinate_template_4_25_01_23`.`groupmembers`.`id`) AS `count` from ((((`germinate_template_4_25_01_23`.`groups` left join `germinate_template_4_25_01_23`.`grouptypes` on((`germinate_template_4_25_01_23`.`groups`.`grouptype_id` = `germinate_template_4_25_01_23`.`grouptypes`.`id`))) left join `germinate_template_4_25_01_23`.`groupmembers` on((`germinate_template_4_25_01_23`.`groupmembers`.`group_id` = `germinate_template_4_25_01_23`.`groups`.`id`))) left join `germinate_template_4_25_01_23`.`projectgroups` on((`germinate_template_4_25_01_23`.`projectgroups`.`group_id` = `germinate_template_4_25_01_23`.`groups`.`id`))) left join `germinate_template_4_25_01_23`.`projects` on((`germinate_template_4_25_01_23`.`projects`.`id` = `germinate_template_4_25_01_23`.`projectgroups`.`project_id`))) group by `germinate_template_4_25_01_23`.`groups`.`id`"));
    }
