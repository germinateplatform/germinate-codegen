...
public class ViewTableGroups extends TableImpl<ViewTableGroupsRecord> {
     ...
     */
    public final TableField<ViewTableGroupsRecord, Timestamp> CREATED_ON = createField(DSL.name("created_on"), SQLDataType.TIMESTAMP(0).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMP)), this, "Foreign key to locations (locations.id).");
    ...
    private ViewTableGroups(Name alias, Table<ViewTableGroupsRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.view("create view `view_table_groups` as select `germinate_template_5_26_08_13`.`groups`.`id` AS `group_id`,`germinate_template_5_26_08_13`.`groups`.`name` AS `group_name`,`germinate_template_5_26_08_13`.`groups`.`description` AS `group_description`,`germinate_template_5_26_08_13`.`grouptypes`.`id` AS `group_type_id`,`germinate_template_5_26_08_13`.`grouptypes`.`target_table` AS `group_type`,'' AS `user_name`,`germinate_template_5_26_08_13`.`groups`.`created_by` AS `user_id`,`germinate_template_5_26_08_13`.`groups`.`visibility` AS `group_visibility`,`germinate_template_5_26_08_13`.`groups`.`created_on` AS `created_on`,`germinate_template_5_26_08_13`.`groups`.`updated_on` AS `updated_on`,(select json_arrayagg(`germinate_template_5_26_08_13`.`projectgroups`.`project_id`) from `germinate_template_5_26_08_13`.`projectgroups` where (`germinate_template_5_26_08_13`.`projectgroups`.`group_id` = `germinate_template_5_26_08_13`.`groups`.`id`) group by `germinate_template_5_26_08_13`.`projectgroups`.`group_id`) AS `project_ids`,count(`germinate_template_5_26_08_13`.`groupmembers`.`id`) AS `count` from ((((`germinate_template_5_26_08_13`.`groups` left join `germinate_template_5_26_08_13`.`grouptypes` on((`germinate_template_5_26_08_13`.`groups`.`grouptype_id` = `germinate_template_5_26_08_13`.`grouptypes`.`id`))) left join `germinate_template_5_26_08_13`.`groupmembers` on((`germinate_template_5_26_08_13`.`groupmembers`.`group_id` = `germinate_template_5_26_08_13`.`groups`.`id`))) left join `germinate_template_5_26_08_13`.`projectgroups` on((`germinate_template_5_26_08_13`.`projectgroups`.`group_id` = `germinate_template_5_26_08_13`.`groups`.`id`))) left join `germinate_template_5_26_08_13`.`projects` on((`germinate_template_5_26_08_13`.`projects`.`id` = `germinate_template_5_26_08_13`.`projectgroups`.`project_id`))) group by `germinate_template_5_26_08_13`.`groups`.`id`"), where);
    }
    ...
    @Override
    public ViewTableGroups as(Table<?> alias) {
        return new ViewTableGroups(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public ViewTableGroups rename(Table<?> name) {
        return new ViewTableGroups(name.getQualifiedName(), null);
    }
     ...
     */
    @Override
    public ViewTableGroups where(Condition condition) {
        return new ViewTableGroups(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public ViewTableGroups where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public ViewTableGroups where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public ViewTableGroups where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public ViewTableGroups where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public ViewTableGroups where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public ViewTableGroups where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public ViewTableGroups where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public ViewTableGroups whereExists(Select<?> select) {
     ...
     */
    @Override
    public ViewTableGroups whereNotExists(Select<?> select) {
