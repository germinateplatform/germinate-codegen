...
public class Phenotypedata extends TableImpl<PhenotypedataRecord> {
    ...
    /**
     * The column <code>germinate_db.phenotypedata.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.phenotypedata.phenotype_id</code>. Foreign key phenotypes (phenotype.id).
     */
    ...
    /**
     * The column <code>germinate_db.phenotypedata.dataset_id</code>. Foreign key datasets (datasets.id).
     */
    ...
    /**
     * The column <code>germinate_db.phenotypedata.recording_date</code>. Date when the phenotypic result was recorded. Should be formatted 'YYYY-MM-DD HH:MM:SS' or just 'YYYY-MM-DD' where a timestamp is not available.
     */
    ...
    /**
     * The column <code>germinate_db.phenotypedata.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.phenotypedata.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * The column <code>germinate_db.phenotypedata.location_id</code>. Foreign key to locations (locations.id).
     */
    ...
    /**
     * The column <code>germinate_db.phenotypedata.treatment_id</code>. Foreign key to treatments (treatments.id).
     */
    ...
    /**
     * The column <code>germinate_db.phenotypedata.trialseries_id</code>. Foreign key to trialseries (trialseries.id).
     */
    ...
    public Identity<PhenotypedataRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Phenotypedata.PHENOTYPEDATA, jhi.germinate.server.database.codegen.tables.Phenotypedata.PHENOTYPEDATA.ID);
    }
    ...
    public UniqueKey<PhenotypedataRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Phenotypedata.PHENOTYPEDATA, "KEY_phenotypedata_PRIMARY", jhi.germinate.server.database.codegen.tables.Phenotypedata.PHENOTYPEDATA.ID);
    }
    ...
    public List<UniqueKey<PhenotypedataRecord>> getKeys() {
        return Arrays.<UniqueKey<PhenotypedataRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Phenotypedata.PHENOTYPEDATA, "KEY_phenotypedata_PRIMARY", jhi.germinate.server.database.codegen.tables.Phenotypedata.PHENOTYPEDATA.ID)
        );
    }
