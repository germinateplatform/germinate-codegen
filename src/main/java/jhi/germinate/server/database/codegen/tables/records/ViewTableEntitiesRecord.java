...
public class ViewTableEntitiesRecord extends TableRecordImpl<ViewTableEntitiesRecord> implements Record8<Integer, String, String, String, Integer, String, String, String> {
    ...
    private static final long serialVersionUID = -1119167048;

    /**
     * Setter for <code>germinate_db.view_table_entities.entity_parent_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_entities.entity_parent_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_entities.entity_parent_gid</code>. A unique identifier.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_entities.entity_parent_gid</code>. A unique identifier.
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_entities.entity_parent_name</code>. A unique name which defines an entry in the germinatbase table.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_entities.entity_parent_name</code>. A unique name which defines an entry in the germinatbase table.
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_entities.entity_parent_type</code>. The name of the entity type.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_entities.entity_parent_type</code>. The name of the entity type.
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_entities.entity_child_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_entities.entity_child_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_entities.entity_child_gid</code>. A unique identifier.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_entities.entity_child_gid</code>. A unique identifier.
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_entities.entity_child_name</code>. A unique name which defines an entry in the germinatbase table.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_entities.entity_child_name</code>. A unique name which defines an entry in the germinatbase table.
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_entities.entity_child_type</code>. The name of the entity type.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_entities.entity_child_type</code>. The name of the entity type.
     */
