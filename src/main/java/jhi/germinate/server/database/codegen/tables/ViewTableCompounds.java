...
public class ViewTableCompounds extends TableImpl<ViewTableCompoundsRecord> {
    ...
    private ViewTableCompounds(Name alias, Table<ViewTableCompoundsRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_compounds` as select `germinate_template_4_22_05_04`.`compounds`.`id` AS `compound_id`,`germinate_template_4_22_05_04`.`compounds`.`name` AS `compound_name`,`germinate_template_4_22_05_04`.`compounds`.`description` AS `compound_description`,`germinate_template_4_22_05_04`.`units`.`id` AS `unit_id`,`germinate_template_4_22_05_04`.`units`.`unit_name` AS `unit_name`,`germinate_template_4_22_05_04`.`units`.`unit_description` AS `unit_description`,`germinate_template_4_22_05_04`.`units`.`unit_abbreviation` AS `unit_abbreviation`,`germinate_template_4_22_05_04`.`synonyms`.`synonyms` AS `synonyms`,(select count(1) from `germinate_template_4_22_05_04`.`compounddata` where (`germinate_template_4_22_05_04`.`compounddata`.`compound_id` = `germinate_template_4_22_05_04`.`compounds`.`id`)) AS `count` from ((`germinate_template_4_22_05_04`.`compounds` left join `germinate_template_4_22_05_04`.`units` on((`germinate_template_4_22_05_04`.`units`.`id` = `germinate_template_4_22_05_04`.`compounds`.`unit_id`))) left join `germinate_template_4_22_05_04`.`synonyms` on(((`germinate_template_4_22_05_04`.`synonyms`.`foreign_id` = `germinate_template_4_22_05_04`.`compounds`.`id`) and (`germinate_template_4_22_05_04`.`synonyms`.`synonymtype_id` = 3)))) group by `germinate_template_4_22_05_04`.`compounds`.`id`,`germinate_template_4_22_05_04`.`synonyms`.`id`"));
    }
