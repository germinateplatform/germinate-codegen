...
public class ViewTableCompounds extends TableImpl<ViewTableCompoundsRecord> {
    ...
    private ViewTableCompounds(Name alias, Table<ViewTableCompoundsRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_compounds` as select `germinate_template_4_22_08_18`.`compounds`.`id` AS `compound_id`,`germinate_template_4_22_08_18`.`compounds`.`name` AS `compound_name`,`germinate_template_4_22_08_18`.`compounds`.`description` AS `compound_description`,`germinate_template_4_22_08_18`.`units`.`id` AS `unit_id`,`germinate_template_4_22_08_18`.`units`.`unit_name` AS `unit_name`,`germinate_template_4_22_08_18`.`units`.`unit_description` AS `unit_description`,`germinate_template_4_22_08_18`.`units`.`unit_abbreviation` AS `unit_abbreviation`,`germinate_template_4_22_08_18`.`synonyms`.`synonyms` AS `synonyms`,(select count(1) from `germinate_template_4_22_08_18`.`compounddata` where (`germinate_template_4_22_08_18`.`compounddata`.`compound_id` = `germinate_template_4_22_08_18`.`compounds`.`id`)) AS `count` from ((`germinate_template_4_22_08_18`.`compounds` left join `germinate_template_4_22_08_18`.`units` on((`germinate_template_4_22_08_18`.`units`.`id` = `germinate_template_4_22_08_18`.`compounds`.`unit_id`))) left join `germinate_template_4_22_08_18`.`synonyms` on(((`germinate_template_4_22_08_18`.`synonyms`.`foreign_id` = `germinate_template_4_22_08_18`.`compounds`.`id`) and (`germinate_template_4_22_08_18`.`synonyms`.`synonymtype_id` = 3)))) group by `germinate_template_4_22_08_18`.`compounds`.`id`,`germinate_template_4_22_08_18`.`synonyms`.`id`"));
    }
