...
public class Climates extends TableImpl<ClimatesRecord> {
    ...
    /**
     * The column <code>germinate_db.climates.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.climates.name</code>. Describes the climate.
     */
    ...
    /**
     * The column <code>germinate_db.climates.short_name</code>. Shortened version of the climate name which is used in some table headers.
     */
    ...
    /**
     * The column <code>germinate_db.climates.description</code>. A longer description of the climate.
     */
    ...
    /**
     * The column <code>germinate_db.climates.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.climates.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    public Identity<ClimatesRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Climates.CLIMATES, jhi.germinate.server.database.codegen.tables.Climates.CLIMATES.ID);
    }
    ...
    public UniqueKey<ClimatesRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Climates.CLIMATES, "KEY_climates_PRIMARY", jhi.germinate.server.database.codegen.tables.Climates.CLIMATES.ID);
    }
    ...
    public List<UniqueKey<ClimatesRecord>> getKeys() {
        return Arrays.<UniqueKey<ClimatesRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Climates.CLIMATES, "KEY_climates_PRIMARY", jhi.germinate.server.database.codegen.tables.Climates.CLIMATES.ID)
        );
    }
