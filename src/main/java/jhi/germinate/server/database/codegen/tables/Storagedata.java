...
public class Storagedata extends TableImpl<StoragedataRecord> {
    ...
    private static final long serialVersionUID = -317478694;
    ...
    /**
     * The column <code>germinate_db.storagedata.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.storagedata.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    public Identity<StoragedataRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Storagedata.STORAGEDATA, jhi.germinate.server.database.codegen.tables.Storagedata.STORAGEDATA.ID);
    }
    ...
    public UniqueKey<StoragedataRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Storagedata.STORAGEDATA, "KEY_storagedata_PRIMARY", jhi.germinate.server.database.codegen.tables.Storagedata.STORAGEDATA.ID);
    }
    ...
    public List<UniqueKey<StoragedataRecord>> getKeys() {
        return Arrays.<UniqueKey<StoragedataRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Storagedata.STORAGEDATA, "KEY_storagedata_PRIMARY", jhi.germinate.server.database.codegen.tables.Storagedata.STORAGEDATA.ID)
        );
    }
