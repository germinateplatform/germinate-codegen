...
public class News extends TableImpl<NewsRecord> {
    ...
    private static final long serialVersionUID = 793649010;
    ...
    /**
     * The column <code>germinate_db.news.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.news.newstype_id</code>. Foreign key newstypes (newstypes.id).
     */
    ...
    /**
     * The column <code>germinate_db.news.title</code>. A title which is used to name this news item. This appears in the Germinate user interface if used.
     */
    ...
    /**
     * The column <code>germinate_db.news.content</code>. The textual content of this news item.
     */
    ...
    /**
     * The column <code>germinate_db.news.image</code>. Image to use with this news item.
     */
    ...
    /**
     * The column <code>germinate_db.news.hyperlink</code>. HTML hyperlink to use for this news item. This can be a link to another source which contains more information or a link to the original source.
     */
    ...
    /**
     * The column <code>germinate_db.news.user_id</code>. Foreign key users (users.id).
     */
    ...
    /**
     * The column <code>germinate_db.news.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.news.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    public Identity<NewsRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.News.NEWS, jhi.germinate.server.database.codegen.tables.News.NEWS.ID);
    }
    ...
    public UniqueKey<NewsRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.News.NEWS, "KEY_news_PRIMARY", jhi.germinate.server.database.codegen.tables.News.NEWS.ID);
    }
    ...
    public List<UniqueKey<NewsRecord>> getKeys() {
        return Arrays.<UniqueKey<NewsRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.News.NEWS, "KEY_news_PRIMARY", jhi.germinate.server.database.codegen.tables.News.NEWS.ID)
        );
    }
