...
public class ImageToTags extends TableImpl<ImageToTagsRecord> {
    ...
    private static final long serialVersionUID = 1806034270;
    ...
    public UniqueKey<ImageToTagsRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.ImageToTags.IMAGE_TO_TAGS, "KEY_image_to_tags_PRIMARY", jhi.germinate.server.database.codegen.tables.ImageToTags.IMAGE_TO_TAGS.IMAGE_ID, jhi.germinate.server.database.codegen.tables.ImageToTags.IMAGE_TO_TAGS.IMAGETAG_ID);
    }
    ...
    public List<UniqueKey<ImageToTagsRecord>> getKeys() {
        return Arrays.<UniqueKey<ImageToTagsRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.ImageToTags.IMAGE_TO_TAGS, "KEY_image_to_tags_PRIMARY", jhi.germinate.server.database.codegen.tables.ImageToTags.IMAGE_TO_TAGS.IMAGE_ID, jhi.germinate.server.database.codegen.tables.ImageToTags.IMAGE_TO_TAGS.IMAGETAG_ID)
        );
    }
