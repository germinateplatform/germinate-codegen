...
public class Attributedata extends TableImpl<AttributedataRecord> {
    ...
    private static final long serialVersionUID = -653237967;
    ...
    /**
     * The column <code>germinate_db.attributedata.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.attributedata.attribute_id</code>. Foreign key to attributes (attributes.id).
     */
    ...
    /**
     * The column <code>germinate_db.attributedata.foreign_id</code>. Foreign key to germinatebase (germinatebase.id).
     */
    ...
    /**
     * The column <code>germinate_db.attributedata.value</code>. The value of the attribute.
     */
    ...
    /**
     * The column <code>germinate_db.attributedata.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.attributedata.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    public Identity<AttributedataRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Attributedata.ATTRIBUTEDATA, jhi.germinate.server.database.codegen.tables.Attributedata.ATTRIBUTEDATA.ID);
    }
    ...
    public UniqueKey<AttributedataRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Attributedata.ATTRIBUTEDATA, "KEY_attributedata_PRIMARY", jhi.germinate.server.database.codegen.tables.Attributedata.ATTRIBUTEDATA.ID);
    }
    ...
    public List<UniqueKey<AttributedataRecord>> getKeys() {
        return Arrays.<UniqueKey<AttributedataRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Attributedata.ATTRIBUTEDATA, "KEY_attributedata_PRIMARY", jhi.germinate.server.database.codegen.tables.Attributedata.ATTRIBUTEDATA.ID)
        );
    }
