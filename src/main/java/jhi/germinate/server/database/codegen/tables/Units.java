...
public class Units extends TableImpl<UnitsRecord> {
    ...
    private static final long serialVersionUID = -1834418469;
    ...
    /**
     * The column <code>germinate_db.units.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.units.unit_name</code>. The name of the unit. This should be the name of the unit in full.
     */
    ...
    /**
     * The column <code>germinate_db.units.unit_abbreviation</code>. This should be the unit abbreviation.
     */
    ...
    /**
     * The column <code>germinate_db.units.unit_description</code>. A description of the unit. If the unit is not a standard SI unit then it is beneficial to have a description which explains what the unit it, how it is derived and any other information which would help identifiy it.
     */
    ...
    /**
     * The column <code>germinate_db.units.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.units.updated_on</code>. When the record was updated. This may be different from the created on date if changes have been made subsequently to the underlying record.
     */
    ...
    public Identity<UnitsRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Units.UNITS, jhi.germinate.server.database.codegen.tables.Units.UNITS.ID);
    }
    ...
    public UniqueKey<UnitsRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Units.UNITS, "KEY_units_PRIMARY", jhi.germinate.server.database.codegen.tables.Units.UNITS.ID);
    }
    ...
    public List<UniqueKey<UnitsRecord>> getKeys() {
        return Arrays.<UniqueKey<UnitsRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Units.UNITS, "KEY_units_PRIMARY", jhi.germinate.server.database.codegen.tables.Units.UNITS.ID)
        );
    }
