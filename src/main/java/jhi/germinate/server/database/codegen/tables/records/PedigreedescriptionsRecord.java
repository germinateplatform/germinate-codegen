...
public class PedigreedescriptionsRecord extends UpdatableRecordImpl<PedigreedescriptionsRecord> implements Record6<Integer, String, String, String, Timestamp, Timestamp> {
    ...
    private static final long serialVersionUID = -1167079770;

    /**
     * Setter for <code>germinate_db.pedigreedescriptions.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Getter for <code>germinate_db.pedigreedescriptions.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Setter for <code>germinate_db.pedigreedescriptions.name</code>. The name of the pedigree.
     */
    ...
    /**
     * Getter for <code>germinate_db.pedigreedescriptions.name</code>. The name of the pedigree.
     */
    ...
    /**
     * Setter for <code>germinate_db.pedigreedescriptions.description</code>. Describes the pedigree in more detail.
     */
    ...
    /**
     * Getter for <code>germinate_db.pedigreedescriptions.description</code>. Describes the pedigree in more detail.
     */
    ...
    /**
     * Setter for <code>germinate_db.pedigreedescriptions.author</code>. Who is responsible for the creation of the pedigree. Attribution should be included in here for pedigree sources.
     */
    ...
    /**
     * Getter for <code>germinate_db.pedigreedescriptions.author</code>. Who is responsible for the creation of the pedigree. Attribution should be included in here for pedigree sources.
     */
    ...
    /**
     * Setter for <code>germinate_db.pedigreedescriptions.created_on</code>. When the record was created.
     */
    ...
    /**
     * Getter for <code>germinate_db.pedigreedescriptions.created_on</code>. When the record was created.
     */
    ...
    /**
     * Setter for <code>germinate_db.pedigreedescriptions.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Getter for <code>germinate_db.pedigreedescriptions.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
