...
public class ViewTableMapoverlays extends TableImpl<ViewTableMapoverlaysRecord> {
     ...
     */
    public final TableField<ViewTableMapoverlaysRecord, ViewTableMapoverlaysReferenceTable> REFERENCE_TABLE = createField(DSL.name("reference_table"), SQLDataType.VARCHAR(10).asEnumDataType(ViewTableMapoverlaysReferenceTable.class), this, "Optionally, other database items can be linked to this. As an example, an overlay can be linked to a climate variable.");
     ...
     */
    public final TableField<ViewTableMapoverlaysRecord, Timestamp> CREATED_ON = createField(DSL.name("created_on"), SQLDataType.TIMESTAMP(0).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMP)), this, "The datetime when this database record has been created.");
     ...
     */
    public final TableField<ViewTableMapoverlaysRecord, Timestamp> UPDATED_ON = createField(DSL.name("updated_on"), SQLDataType.TIMESTAMP(0).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMP)), this, "The timestamp when this database record has last been updated.");
    ...
    private ViewTableMapoverlays(Name alias, Table<ViewTableMapoverlaysRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.view("create view `view_table_mapoverlays` as select `germinate_template_5_26_01_28`.`mapoverlays`.`id` AS `mapoverlay_id`,`germinate_template_5_26_01_28`.`mapoverlays`.`name` AS `mapoverlay_name`,`germinate_template_5_26_01_28`.`mapoverlays`.`description` AS `mapoverlay_description`,`germinate_template_5_26_01_28`.`mapoverlays`.`bottom_left_lat` AS `mapoverlay_bottom_left_lat`,`germinate_template_5_26_01_28`.`mapoverlays`.`bottom_left_lng` AS `mapoverlay_bottom_left_lng`,`germinate_template_5_26_01_28`.`mapoverlays`.`top_right_lat` AS `mapoverlay_top_right_lat`,`germinate_template_5_26_01_28`.`mapoverlays`.`top_right_lng` AS `mapoverlay_top_right_lng`,`germinate_template_5_26_01_28`.`mapoverlays`.`is_legend` AS `mapoverlays_is_legend`,`germinate_template_5_26_01_28`.`mapoverlays`.`reference_table` AS `reference_table`,`germinate_template_5_26_01_28`.`mapoverlays`.`foreign_id` AS `foreign_id`,`germinate_template_5_26_01_28`.`datasets`.`id` AS `dataset_id`,`germinate_template_5_26_01_28`.`datasets`.`name` AS `dataset_name`,`germinate_template_5_26_01_28`.`datasets`.`description` AS `dataset_description`,`germinate_template_5_26_01_28`.`datasettypes`.`description` AS `dataset_type`,`germinate_template_5_26_01_28`.`mapoverlays`.`recording_date` AS `recording_date`,`germinate_template_5_26_01_28`.`mapoverlays`.`created_on` AS `created_on`,`germinate_template_5_26_01_28`.`mapoverlays`.`updated_on` AS `updated_on` from ((`germinate_template_5_26_01_28`.`mapoverlays` left join `germinate_template_5_26_01_28`.`datasets` on((`germinate_template_5_26_01_28`.`datasets`.`id` = `germinate_template_5_26_01_28`.`mapoverlays`.`dataset_id`))) left join `germinate_template_5_26_01_28`.`datasettypes` on((`germinate_template_5_26_01_28`.`datasettypes`.`id` = `germinate_template_5_26_01_28`.`datasets`.`datasettype_id`)))"), where);
    }
    ...
    @Override
    public ViewTableMapoverlays as(Table<?> alias) {
        return new ViewTableMapoverlays(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public ViewTableMapoverlays rename(Table<?> name) {
        return new ViewTableMapoverlays(name.getQualifiedName(), null);
    }
     ...
     */
    @Override
    public ViewTableMapoverlays where(Condition condition) {
        return new ViewTableMapoverlays(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public ViewTableMapoverlays where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public ViewTableMapoverlays where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public ViewTableMapoverlays where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public ViewTableMapoverlays where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public ViewTableMapoverlays where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public ViewTableMapoverlays where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public ViewTableMapoverlays where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public ViewTableMapoverlays whereExists(Select<?> select) {
     ...
     */
    @Override
    public ViewTableMapoverlays whereNotExists(Select<?> select) {
