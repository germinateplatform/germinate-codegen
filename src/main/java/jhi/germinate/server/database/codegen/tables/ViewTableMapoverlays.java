...
public class ViewTableMapoverlays extends TableImpl<ViewTableMapoverlaysRecord> {
    ...
    private ViewTableMapoverlays(Name alias, Table<ViewTableMapoverlaysRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_mapoverlays` as select `germinate_template_4_23_01_09`.`mapoverlays`.`id` AS `mapoverlay_id`,`germinate_template_4_23_01_09`.`mapoverlays`.`name` AS `mapoverlay_name`,`germinate_template_4_23_01_09`.`mapoverlays`.`description` AS `mapoverlay_description`,`germinate_template_4_23_01_09`.`mapoverlays`.`bottom_left_lat` AS `mapoverlay_bottom_left_lat`,`germinate_template_4_23_01_09`.`mapoverlays`.`bottom_left_lng` AS `mapoverlay_bottom_left_lng`,`germinate_template_4_23_01_09`.`mapoverlays`.`top_right_lat` AS `mapoverlay_top_right_lat`,`germinate_template_4_23_01_09`.`mapoverlays`.`top_right_lng` AS `mapoverlay_top_right_lng`,`germinate_template_4_23_01_09`.`mapoverlays`.`is_legend` AS `mapoverlays_is_legend`,`germinate_template_4_23_01_09`.`mapoverlays`.`reference_table` AS `reference_table`,`germinate_template_4_23_01_09`.`mapoverlays`.`foreign_id` AS `foreign_id`,`germinate_template_4_23_01_09`.`datasets`.`id` AS `dataset_id`,`germinate_template_4_23_01_09`.`datasets`.`name` AS `dataset_name`,`germinate_template_4_23_01_09`.`datasets`.`description` AS `dataset_description`,`germinate_template_4_23_01_09`.`datasettypes`.`description` AS `dataset_type`,`germinate_template_4_23_01_09`.`mapoverlays`.`recording_date` AS `recording_date`,`germinate_template_4_23_01_09`.`mapoverlays`.`created_on` AS `created_on`,`germinate_template_4_23_01_09`.`mapoverlays`.`updated_on` AS `updated_on` from ((`germinate_template_4_23_01_09`.`mapoverlays` left join `germinate_template_4_23_01_09`.`datasets` on((`germinate_template_4_23_01_09`.`datasets`.`id` = `germinate_template_4_23_01_09`.`mapoverlays`.`dataset_id`))) left join `germinate_template_4_23_01_09`.`datasettypes` on((`germinate_template_4_23_01_09`.`datasettypes`.`id` = `germinate_template_4_23_01_09`.`datasets`.`datasettype_id`)))"));
    }
