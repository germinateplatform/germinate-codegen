...
public class ViewTableLinksRecord extends TableRecordImpl<ViewTableLinksRecord> implements Record11<Integer, String, Boolean, Integer, String, String, String, Integer, String, String, Timestamp> {
    ...
    private static final long serialVersionUID = -1560888766;

    /**
     * Setter for <code>germinate_db.view_table_links.link_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_links.link_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_links.link_description</code>. A description of the link.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_links.link_description</code>. A description of the link.
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_links.link_visibility</code>. Determines if the link is visible or not: {0, 1}
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_links.link_visibility</code>. Determines if the link is visible or not: {0, 1}
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_links.linktype_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_links.linktype_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_links.linktype_description</code>. A description of the link.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_links.linktype_description</code>. A description of the link.
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_links.linktype_target_table</code>. This is the table that the link links to.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_links.linktype_target_table</code>. This is the table that the link links to.
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_links.linktype_target_column</code>. This is the column that is used to generate the link.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_links.linktype_target_column</code>. This is the column that is used to generate the link.
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_links.hyperlink</code>. The actual hyperlink.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_links.hyperlink</code>. The actual hyperlink.
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_links.placeholder</code>. The part of the link that will be replaced by the value of the target column.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_links.placeholder</code>. The part of the link that will be replaced by the value of the target column.
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_links.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_links.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
