...
public class ViewTableLinks extends TableImpl<ViewTableLinksRecord> {
    ...
    private ViewTableLinks(Name alias, Table<ViewTableLinksRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_links` as select `germinate_template_4_22_10_12`.`links`.`id` AS `link_id`,`germinate_template_4_22_10_12`.`links`.`description` AS `link_description`,`germinate_template_4_22_10_12`.`links`.`visibility` AS `link_visibility`,`germinate_template_4_22_10_12`.`linktypes`.`id` AS `linktype_id`,`germinate_template_4_22_10_12`.`linktypes`.`description` AS `linktype_description`,`germinate_template_4_22_10_12`.`linktypes`.`target_table` AS `linktype_target_table`,`germinate_template_4_22_10_12`.`linktypes`.`target_column` AS `linktype_target_column`,`germinate_template_4_22_10_12`.`links`.`foreign_id` AS `link_foreign_id`,`germinate_template_4_22_10_12`.`links`.`hyperlink` AS `hyperlink`,`germinate_template_4_22_10_12`.`linktypes`.`placeholder` AS `placeholder`,`germinate_template_4_22_10_12`.`links`.`updated_on` AS `updated_on` from (`germinate_template_4_22_10_12`.`links` left join `germinate_template_4_22_10_12`.`linktypes` on((`germinate_template_4_22_10_12`.`linktypes`.`id` = `germinate_template_4_22_10_12`.`links`.`linktype_id`)))"));
    }
