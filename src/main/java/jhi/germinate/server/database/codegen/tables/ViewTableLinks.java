...
public class ViewTableLinks extends TableImpl<ViewTableLinksRecord> {
    ...
    private ViewTableLinks(Name alias, Table<ViewTableLinksRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.view("create view `view_table_links` as select `germinate_template_5_26_08_13`.`links`.`id` AS `link_id`,`germinate_template_5_26_08_13`.`links`.`description` AS `link_description`,`germinate_template_5_26_08_13`.`links`.`visibility` AS `link_visibility`,`germinate_template_5_26_08_13`.`linktypes`.`id` AS `linktype_id`,`germinate_template_5_26_08_13`.`linktypes`.`description` AS `linktype_description`,`germinate_template_5_26_08_13`.`linktypes`.`target_table` AS `linktype_target_table`,`germinate_template_5_26_08_13`.`linktypes`.`target_column` AS `linktype_target_column`,`germinate_template_5_26_08_13`.`links`.`foreign_id` AS `link_foreign_id`,`germinate_template_5_26_08_13`.`links`.`hyperlink` AS `hyperlink`,`germinate_template_5_26_08_13`.`linktypes`.`placeholder` AS `placeholder`,`germinate_template_5_26_08_13`.`links`.`updated_on` AS `updated_on` from (`germinate_template_5_26_08_13`.`links` left join `germinate_template_5_26_08_13`.`linktypes` on((`germinate_template_5_26_08_13`.`linktypes`.`id` = `germinate_template_5_26_08_13`.`links`.`linktype_id`)))"), where);
    }
