...
public class ViewTableLinks extends TableImpl<ViewTableLinksRecord> {
    ...
    private static final long serialVersionUID = -1579946093;
    ...
    /**
     * The column <code>germinate_db.view_table_links.link_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_links.link_description</code>. A description of the link.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_links.link_visibility</code>. Determines if the link is visible or not: {0, 1}
     */
    ...
    /**
     * The column <code>germinate_db.view_table_links.linktype_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_links.linktype_description</code>. A description of the link.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_links.linktype_target_table</code>. This is the table that the link links to.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_links.linktype_target_column</code>. This is the column that is used to generate the link.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_links.hyperlink</code>. The actual hyperlink.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_links.placeholder</code>. The part of the link that will be replaced by the value of the target column.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_links.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Create an aliased <code>germinate_db.view_table_links</code> table reference
     */
