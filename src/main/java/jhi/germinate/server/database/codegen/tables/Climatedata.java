...
public class Climatedata extends TableImpl<ClimatedataRecord> {
    ...
    private static final long serialVersionUID = 1307889671;
    ...
    /**
     * The column <code>germinate_db.climatedata.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.climatedata.climate_id</code>. Foreign key to climates (climates.id).
     */
    ...
    /**
     * The column <code>germinate_db.climatedata.location_id</code>. Foreign key to locations (locations.id).
     */
    ...
    /**
     * The column <code>germinate_db.climatedata.climate_value</code>. Value for the specific climate attribute. These are monthly averages and not daily. Monthly data is required for the current Germinate climate viisualizations and interface.
     */
    ...
    /**
     * The column <code>germinate_db.climatedata.dataset_id</code>. Foreign key to datasets (datasets.id).
     */
    ...
    /**
     * The column <code>germinate_db.climatedata.recording_date</code>. The date at which this data point was recorded.
     */
    ...
    /**
     * The column <code>germinate_db.climatedata.old_recording_date</code>. The month that the data was recorded. This uses an integer to represent the month (1-12).
     */
    ...
    /**
     * The column <code>germinate_db.climatedata.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.climatedata.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    public Identity<ClimatedataRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Climatedata.CLIMATEDATA, jhi.germinate.server.database.codegen.tables.Climatedata.CLIMATEDATA.ID);
    }
    ...
    public UniqueKey<ClimatedataRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Climatedata.CLIMATEDATA, "KEY_climatedata_PRIMARY", jhi.germinate.server.database.codegen.tables.Climatedata.CLIMATEDATA.ID);
    }
    ...
    public List<UniqueKey<ClimatedataRecord>> getKeys() {
        return Arrays.<UniqueKey<ClimatedataRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Climatedata.CLIMATEDATA, "KEY_climatedata_PRIMARY", jhi.germinate.server.database.codegen.tables.Climatedata.CLIMATEDATA.ID)
        );
    }
