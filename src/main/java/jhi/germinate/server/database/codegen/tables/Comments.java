...
public class Comments extends TableImpl<CommentsRecord> {
    ...
    private static final long serialVersionUID = -590727997;
    ...
    /**
     * The column <code>germinate_db.comments.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.comments.commenttype_id</code>. Foreign key to commentypes (commenttypes.id).
     */
    ...
    /**
     * The column <code>germinate_db.comments.user_id</code>. Foreign key to Gatekeeper users (Gatekeeper users.id).
     */
    ...
    /**
     * The column <code>germinate_db.comments.visibility</code>. Defines if the comment is available or masked (hidden) from the interface.
     */
    ...
    /**
     * The column <code>germinate_db.comments.description</code>. The comment content.
     */
    ...
    /**
     * The column <code>germinate_db.comments.reference_id</code>. Relates to the UID of the table to which the comment relates
     */
    ...
    /**
     * The column <code>germinate_db.comments.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.comments.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    public Identity<CommentsRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Comments.COMMENTS, jhi.germinate.server.database.codegen.tables.Comments.COMMENTS.ID);
    }
    ...
    public UniqueKey<CommentsRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Comments.COMMENTS, "KEY_comments_PRIMARY", jhi.germinate.server.database.codegen.tables.Comments.COMMENTS.ID);
    }
    ...
    public List<UniqueKey<CommentsRecord>> getKeys() {
        return Arrays.<UniqueKey<CommentsRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Comments.COMMENTS, "KEY_comments_PRIMARY", jhi.germinate.server.database.codegen.tables.Comments.COMMENTS.ID)
        );
    }
