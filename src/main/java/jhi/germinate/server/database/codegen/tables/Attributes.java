...
public class Attributes extends TableImpl<AttributesRecord> {
    ...
    /**
     * The column <code>germinate_db.attributes.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.attributes.name</code>. Defines the name of the attribute.
     */
    ...
    /**
     * The column <code>germinate_db.attributes.description</code>. Describes the attribute. This should expand on the name to make it clear what the attribute actually is.
     */
    ...
    /**
     * The column <code>germinate_db.attributes.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.attributes.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    public Identity<AttributesRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Attributes.ATTRIBUTES, jhi.germinate.server.database.codegen.tables.Attributes.ATTRIBUTES.ID);
    }
    ...
    public UniqueKey<AttributesRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Attributes.ATTRIBUTES, "KEY_attributes_PRIMARY", jhi.germinate.server.database.codegen.tables.Attributes.ATTRIBUTES.ID);
    }
    ...
    public List<UniqueKey<AttributesRecord>> getKeys() {
        return Arrays.<UniqueKey<AttributesRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Attributes.ATTRIBUTES, "KEY_attributes_PRIMARY", jhi.germinate.server.database.codegen.tables.Attributes.ATTRIBUTES.ID)
        );
    }
