...
public class ViewTableGermplasmAttributes extends TableImpl<ViewTableGermplasmAttributesRecord> {
    ...
    /**
     * The column <code>germinate_db.view_table_germplasm_attributes.attribute_value_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_germplasm_attributes.germplasm_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_germplasm_attributes.germplasm_gid</code>. A unique identifier.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_germplasm_attributes.germplasm_name</code>. A unique name which defines an entry in the germinatbase table.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_germplasm_attributes.attribute_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_germplasm_attributes.attribute_name</code>. Defines the name of the attribute.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_germplasm_attributes.attribute_description</code>. Describes the attribute. This should expand on the name to make it clear what the attribute actually is.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_germplasm_attributes.foreign_id</code>. Foreign key to germinatebase (germinatebase.id).
     */
    ...
    /**
     * The column <code>germinate_db.view_table_germplasm_attributes.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_germplasm_attributes.attribute_value</code>. The value of the attribute.
     */
    ...
    /**
     * Create a <code>germinate_db.view_table_germplasm_attributes</code> table reference
     */
    ...
    /**
     * Create an aliased <code>germinate_db.view_table_germplasm_attributes</code> table reference
     */
