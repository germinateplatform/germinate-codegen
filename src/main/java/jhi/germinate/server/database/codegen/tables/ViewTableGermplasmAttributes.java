...
public class ViewTableGermplasmAttributes extends TableImpl<ViewTableGermplasmAttributesRecord> {
    ...
    private ViewTableGermplasmAttributes(Name alias, Table<ViewTableGermplasmAttributesRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_germplasm_attributes` as select `germinate_template_4_22_08_23`.`attributedata`.`id` AS `attribute_value_id`,`germinate_template_4_22_08_23`.`germinatebase`.`id` AS `germplasm_id`,`germinate_template_4_22_08_23`.`germinatebase`.`general_identifier` AS `germplasm_gid`,`germinate_template_4_22_08_23`.`germinatebase`.`name` AS `germplasm_name`,`germinate_template_4_22_08_23`.`attributes`.`id` AS `attribute_id`,`germinate_template_4_22_08_23`.`attributes`.`name` AS `attribute_name`,`germinate_template_4_22_08_23`.`attributes`.`description` AS `attribute_description`,`germinate_template_4_22_08_23`.`attributes`.`datatype` AS `attribute_type`,`germinate_template_4_22_08_23`.`attributes`.`target_table` AS `target_table`,`germinate_template_4_22_08_23`.`attributedata`.`foreign_id` AS `foreign_id`,`germinate_template_4_22_08_23`.`attributedata`.`created_on` AS `created_on`,`germinate_template_4_22_08_23`.`attributedata`.`value` AS `attribute_value` from ((`germinate_template_4_22_08_23`.`attributedata` left join `germinate_template_4_22_08_23`.`germinatebase` on((`germinate_template_4_22_08_23`.`attributedata`.`foreign_id` = `germinate_template_4_22_08_23`.`germinatebase`.`id`))) left join `germinate_template_4_22_08_23`.`attributes` on((`germinate_template_4_22_08_23`.`attributes`.`id` = `germinate_template_4_22_08_23`.`attributedata`.`attribute_id`))) where (`germinate_template_4_22_08_23`.`attributes`.`target_table` = 'germinatebase')"));
    }
