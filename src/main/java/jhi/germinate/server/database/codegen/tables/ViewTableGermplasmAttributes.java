...
public class ViewTableGermplasmAttributes extends TableImpl<ViewTableGermplasmAttributesRecord> {
     ...
     */
    public final TableField<ViewTableGermplasmAttributesRecord, Timestamp> CREATED_ON = createField(DSL.name("created_on"), SQLDataType.TIMESTAMP(0).defaultValue(DSL.field("CURRENT_TIMESTAMP", SQLDataType.TIMESTAMP)), this, "When the record was created.");
    ...
    private ViewTableGermplasmAttributes(Name alias, Table<ViewTableGermplasmAttributesRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_germplasm_attributes` as select `germinate_template_4_25_01_14`.`attributedata`.`id` AS `attribute_value_id`,`germinate_template_4_25_01_14`.`germinatebase`.`id` AS `germplasm_id`,`germinate_template_4_25_01_14`.`germinatebase`.`general_identifier` AS `germplasm_gid`,`germinate_template_4_25_01_14`.`germinatebase`.`name` AS `germplasm_name`,`germinate_template_4_25_01_14`.`germinatebase`.`display_name` AS `germplasm_display_name`,`germinate_template_4_25_01_14`.`attributes`.`id` AS `attribute_id`,`germinate_template_4_25_01_14`.`attributes`.`name` AS `attribute_name`,`germinate_template_4_25_01_14`.`attributes`.`description` AS `attribute_description`,`germinate_template_4_25_01_14`.`attributes`.`datatype` AS `attribute_type`,`germinate_template_4_25_01_14`.`attributes`.`target_table` AS `target_table`,`germinate_template_4_25_01_14`.`attributedata`.`foreign_id` AS `foreign_id`,`germinate_template_4_25_01_14`.`attributedata`.`created_on` AS `created_on`,`germinate_template_4_25_01_14`.`attributedata`.`value` AS `attribute_value` from ((`germinate_template_4_25_01_14`.`attributedata` left join `germinate_template_4_25_01_14`.`germinatebase` on((`germinate_template_4_25_01_14`.`attributedata`.`foreign_id` = `germinate_template_4_25_01_14`.`germinatebase`.`id`))) left join `germinate_template_4_25_01_14`.`attributes` on((`germinate_template_4_25_01_14`.`attributes`.`id` = `germinate_template_4_25_01_14`.`attributedata`.`attribute_id`))) where (`germinate_template_4_25_01_14`.`attributes`.`target_table` = 'germinatebase')"));
    }
