...
public class CollaboratorsRecord extends UpdatableRecordImpl<CollaboratorsRecord> implements Record9<Integer, String, String, String, String, String, Integer, Timestamp, Timestamp> {
    ...
    private static final long serialVersionUID = -1042412431;
    ...
    /**
     * Setter for <code>germinate_db.collaborators.external_id</code>. An identifier for the data submitter. If that submitter is an individual, ORCID identifiers are recommended.
     */
    ...
    /**
     * Getter for <code>germinate_db.collaborators.external_id</code>. An identifier for the data submitter. If that submitter is an individual, ORCID identifiers are recommended.
     */
