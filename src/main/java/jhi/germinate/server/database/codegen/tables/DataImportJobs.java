...
public class DataImportJobs extends TableImpl<DataImportJobsRecord> {
    ...
    private static final long serialVersionUID = 909014318;
     ...
     */
    public final TableField<DataImportJobsRecord, ImportResult[]> FEEDBACK = createField("feedback", org.jooq.impl.DefaultDataType.getDefaultDataType("\"germinate_template_4_20_10_02\".\"data_import_jobs_feedback\""), this, "", new ImportResultBinding());
