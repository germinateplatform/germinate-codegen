...
public class DataImportJobs extends TableImpl<DataImportJobsRecord> {
    ...
    private static final long serialVersionUID = -398285746;
     ...
     */
    public final TableField<DataImportJobsRecord, ImportResult[]> FEEDBACK = createField("feedback", org.jooq.impl.DefaultDataType.getDefaultDataType("\"germinate_template_4_21_11_08\".\"data_import_jobs_feedback\""), this, "", new ImportResultBinding());
