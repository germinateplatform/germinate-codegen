...
public class MapdefinitionsRecord extends UpdatableRecordImpl<MapdefinitionsRecord> implements Record10<Integer, Integer, Integer, Integer, Double, Double, String, String, Timestamp, Timestamp> {
    ...
    private static final long serialVersionUID = -855030258;

    /**
     * Setter for <code>germinate_db.mapdefinitions.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Getter for <code>germinate_db.mapdefinitions.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Setter for <code>germinate_db.mapdefinitions.mapfeaturetype_id</code>. Foreign key to mapfeaturetypes (mapfeaturetypes.id).
     */
    ...
    /**
     * Getter for <code>germinate_db.mapdefinitions.mapfeaturetype_id</code>. Foreign key to mapfeaturetypes (mapfeaturetypes.id).
     */
    ...
    /**
     * Setter for <code>germinate_db.mapdefinitions.marker_id</code>. Foreign key to markers (markers.id).
     */
    ...
    /**
     * Getter for <code>germinate_db.mapdefinitions.marker_id</code>. Foreign key to markers (markers.id).
     */
    ...
    /**
     * Setter for <code>germinate_db.mapdefinitions.map_id</code>. Foreign key to maps (maps.id).
     */
    ...
    /**
     * Getter for <code>germinate_db.mapdefinitions.map_id</code>. Foreign key to maps (maps.id).
     */
    ...
    /**
     * Setter for <code>germinate_db.mapdefinitions.definition_start</code>. Used if the markers location spans over an area more than a single point on the maps. Determines the marker start location.
     */
    ...
    /**
     * Getter for <code>germinate_db.mapdefinitions.definition_start</code>. Used if the markers location spans over an area more than a single point on the maps. Determines the marker start location.
     */
    ...
    /**
     * Setter for <code>germinate_db.mapdefinitions.definition_end</code>. Used if the markers location spans over an area more than a single point on the maps. Determines the marker end location.
     */
    ...
    /**
     * Getter for <code>germinate_db.mapdefinitions.definition_end</code>. Used if the markers location spans over an area more than a single point on the maps. Determines the marker end location.
     */
    ...
    /**
     * Setter for <code>germinate_db.mapdefinitions.chromosome</code>. The chromosome/linkage group that this marker is found on.
     */
    ...
    /**
     * Getter for <code>germinate_db.mapdefinitions.chromosome</code>. The chromosome/linkage group that this marker is found on.
     */
    ...
    /**
     * Setter for <code>germinate_db.mapdefinitions.arm_impute</code>. If a chromosome arm is available then this can be entered here.
     */
    ...
    /**
     * Getter for <code>germinate_db.mapdefinitions.arm_impute</code>. If a chromosome arm is available then this can be entered here.
     */
    ...
    /**
     * Setter for <code>germinate_db.mapdefinitions.created_on</code>. When the record was created.
     */
    ...
    /**
     * Getter for <code>germinate_db.mapdefinitions.created_on</code>. When the record was created.
     */
    ...
    /**
     * Setter for <code>germinate_db.mapdefinitions.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Getter for <code>germinate_db.mapdefinitions.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
