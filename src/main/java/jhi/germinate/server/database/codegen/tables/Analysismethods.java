...
public class Analysismethods extends TableImpl<AnalysismethodsRecord> {
    ...
    private static final long serialVersionUID = 1102833154;
    ...
    /**
     * The column <code>germinate_db.analysismethods.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.analysismethods.name</code>. The name of the analysis method.
     */
    ...
    /**
     * The column <code>germinate_db.analysismethods.description</code>. Describes the analysis method.
     */
    ...
    /**
     * The column <code>germinate_db.analysismethods.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.analysismethods.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Create an aliased <code>germinate_db.analysismethods</code> table reference
     */
    ...
    public Identity<AnalysismethodsRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Analysismethods.ANALYSISMETHODS, jhi.germinate.server.database.codegen.tables.Analysismethods.ANALYSISMETHODS.ID);
    }
    ...
    public UniqueKey<AnalysismethodsRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Analysismethods.ANALYSISMETHODS, "KEY_analysismethods_PRIMARY", jhi.germinate.server.database.codegen.tables.Analysismethods.ANALYSISMETHODS.ID);
    }
    ...
    public List<UniqueKey<AnalysismethodsRecord>> getKeys() {
        return Arrays.<UniqueKey<AnalysismethodsRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Analysismethods.ANALYSISMETHODS, "KEY_analysismethods_PRIMARY", jhi.germinate.server.database.codegen.tables.Analysismethods.ANALYSISMETHODS.ID)
        );
    }
