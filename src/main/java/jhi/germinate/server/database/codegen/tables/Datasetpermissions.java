...
public class Datasetpermissions extends TableImpl<DatasetpermissionsRecord> {
    ...
    private static final long serialVersionUID = -1457659477;
    ...
    /**
     * The column <code>germinate_db.datasetpermissions.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.datasetpermissions.dataset_id</code>. Foreign key to datasets (datasets.id).
     */
    ...
    /**
     * The column <code>germinate_db.datasetpermissions.user_id</code>. Foreign key to Gatekeeper users (Gatekeeper usersid).
     */
    ...
    /**
     * The column <code>germinate_db.datasetpermissions.group_id</code>. Foreign key to usergroups table.
     */
    ...
    /**
     * The column <code>germinate_db.datasetpermissions.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.datasetpermissions.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Create an aliased <code>germinate_db.datasetpermissions</code> table reference
     */
    ...
    public Identity<DatasetpermissionsRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Datasetpermissions.DATASETPERMISSIONS, jhi.germinate.server.database.codegen.tables.Datasetpermissions.DATASETPERMISSIONS.ID);
    }
    ...
    public UniqueKey<DatasetpermissionsRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Datasetpermissions.DATASETPERMISSIONS, "KEY_datasetpermissions_PRIMARY", jhi.germinate.server.database.codegen.tables.Datasetpermissions.DATASETPERMISSIONS.ID);
    }
    ...
    public List<UniqueKey<DatasetpermissionsRecord>> getKeys() {
        return Arrays.<UniqueKey<DatasetpermissionsRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Datasetpermissions.DATASETPERMISSIONS, "KEY_datasetpermissions_PRIMARY", jhi.germinate.server.database.codegen.tables.Datasetpermissions.DATASETPERMISSIONS.ID)
        );
    }
