...
public class Groupmembers extends TableImpl<GroupmembersRecord> {
    ...
    private static final long serialVersionUID = -1827155106;
    ...
    /**
     * The column <code>germinate_db.groupmembers.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.groupmembers.foreign_id</code>. Foreign key to [table] ([table].id).
     */
    ...
    /**
     * The column <code>germinate_db.groupmembers.group_id</code>. Foreign key to groups (groups.id).
     */
    ...
    /**
     * The column <code>germinate_db.groupmembers.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.groupmembers.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    public Identity<GroupmembersRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Groupmembers.GROUPMEMBERS, jhi.germinate.server.database.codegen.tables.Groupmembers.GROUPMEMBERS.ID);
    }
    ...
    public UniqueKey<GroupmembersRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Groupmembers.GROUPMEMBERS, "KEY_groupmembers_PRIMARY", jhi.germinate.server.database.codegen.tables.Groupmembers.GROUPMEMBERS.ID);
    }
    ...
    public List<UniqueKey<GroupmembersRecord>> getKeys() {
        return Arrays.<UniqueKey<GroupmembersRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Groupmembers.GROUPMEMBERS, "KEY_groupmembers_PRIMARY", jhi.germinate.server.database.codegen.tables.Groupmembers.GROUPMEMBERS.ID)
        );
    }
