...
public class Imagetypes extends TableImpl<ImagetypesRecord> {
    ...
    private static final long serialVersionUID = 1494208768;
    ...
    /**
     * The column <code>germinate_db.imagetypes.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.imagetypes.description</code>. A description of the image type. This would usually be a description of what the image was showing in general terms such as 'field image' or 'insitu hybridisation images'.
     */
    ...
    /**
     * The column <code>germinate_db.imagetypes.reference_table</code>. The table which the image type relates to.
     */
    ...
    /**
     * The column <code>germinate_db.imagetypes.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.imagetypes.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    public Identity<ImagetypesRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Imagetypes.IMAGETYPES, jhi.germinate.server.database.codegen.tables.Imagetypes.IMAGETYPES.ID);
    }
    ...
    public UniqueKey<ImagetypesRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Imagetypes.IMAGETYPES, "KEY_imagetypes_PRIMARY", jhi.germinate.server.database.codegen.tables.Imagetypes.IMAGETYPES.ID);
    }
    ...
    public List<UniqueKey<ImagetypesRecord>> getKeys() {
        return Arrays.<UniqueKey<ImagetypesRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Imagetypes.IMAGETYPES, "KEY_imagetypes_PRIMARY", jhi.germinate.server.database.codegen.tables.Imagetypes.IMAGETYPES.ID)
        );
    }
