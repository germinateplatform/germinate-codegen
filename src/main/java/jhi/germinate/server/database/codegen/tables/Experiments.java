...
public class Experiments extends TableImpl<ExperimentsRecord> {
    ...
    private static final long serialVersionUID = 1381768242;
    ...
    /**
     * The column <code>germinate_db.experiments.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.experiments.experiment_name</code>. The name of the experiment.
     */
    ...
    /**
     * The column <code>germinate_db.experiments.user_id</code>. Foreign key to Gatekeeper users (Gatekeeper users.id).
    ...
    /**
     * The column <code>germinate_db.experiments.description</code>. Describes the experiment.
     */
    ...
    /**
     * The column <code>germinate_db.experiments.experiment_date</code>. The date that the experiment was carried out.
     */
    ...
    /**
     * The column <code>germinate_db.experiments.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.experiments.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    public Identity<ExperimentsRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Experiments.EXPERIMENTS, jhi.germinate.server.database.codegen.tables.Experiments.EXPERIMENTS.ID);
    }
    ...
    public UniqueKey<ExperimentsRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Experiments.EXPERIMENTS, "KEY_experiments_PRIMARY", jhi.germinate.server.database.codegen.tables.Experiments.EXPERIMENTS.ID);
    }
    ...
    public List<UniqueKey<ExperimentsRecord>> getKeys() {
        return Arrays.<UniqueKey<ExperimentsRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Experiments.EXPERIMENTS, "KEY_experiments_PRIMARY", jhi.germinate.server.database.codegen.tables.Experiments.EXPERIMENTS.ID)
        );
    }
