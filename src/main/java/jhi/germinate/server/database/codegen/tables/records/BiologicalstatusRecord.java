...
public class BiologicalstatusRecord extends UpdatableRecordImpl<BiologicalstatusRecord> implements Record4<Integer, String, Timestamp, Timestamp> {
    ...
    private static final long serialVersionUID = 1053189980;

    /**
     * Setter for <code>germinate_db.biologicalstatus.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Getter for <code>germinate_db.biologicalstatus.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Setter for <code>germinate_db.biologicalstatus.sampstat</code>. Previoulsy known as sampstat.
     */
    ...
    /**
     * Getter for <code>germinate_db.biologicalstatus.sampstat</code>. Previoulsy known as sampstat.
     */
    ...
    /**
     * Setter for <code>germinate_db.biologicalstatus.created_on</code>. When the record was created.
     */
    ...
    /**
     * Getter for <code>germinate_db.biologicalstatus.created_on</code>. When the record was created.
     */
    ...
    /**
     * Setter for <code>germinate_db.biologicalstatus.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Getter for <code>germinate_db.biologicalstatus.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
