...
public class SynonymtypesRecord extends UpdatableRecordImpl<SynonymtypesRecord> implements Record6<Integer, String, String, String, Timestamp, Timestamp> {
    ...
    private static final long serialVersionUID = -1209818810;

    /**
     * Setter for <code>germinate_db.synonymtypes.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Getter for <code>germinate_db.synonymtypes.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Setter for <code>germinate_db.synonymtypes.target_table</code>. The target table.
     */
    ...
    /**
     * Getter for <code>germinate_db.synonymtypes.target_table</code>. The target table.
     */
    ...
    /**
     * Setter for <code>germinate_db.synonymtypes.name</code>. Name of the synonym type.
     */
    ...
    /**
     * Getter for <code>germinate_db.synonymtypes.name</code>. Name of the synonym type.
     */
    ...
    /**
     * Setter for <code>germinate_db.synonymtypes.description</code>. Description of the type.
     */
    ...
    /**
     * Getter for <code>germinate_db.synonymtypes.description</code>. Description of the type.
     */
    ...
    /**
     * Setter for <code>germinate_db.synonymtypes.created_on</code>. When the record was created.
     */
    ...
    /**
     * Getter for <code>germinate_db.synonymtypes.created_on</code>. When the record was created.
     */
    ...
    /**
     * Setter for <code>germinate_db.synonymtypes.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Getter for <code>germinate_db.synonymtypes.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
