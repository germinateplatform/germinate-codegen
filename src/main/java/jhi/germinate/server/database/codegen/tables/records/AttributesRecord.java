...
public class AttributesRecord extends UpdatableRecordImpl<AttributesRecord> implements Record7<Integer, String, String, AttributesDatatype, String, Timestamp, Timestamp> {
    ...
    /**
     * Getter for <code>germinate_db.attributes.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Setter for <code>germinate_db.attributes.name</code>. Defines the name of the attribute.
     */
    ...
    /**
     * Getter for <code>germinate_db.attributes.name</code>. Defines the name of the attribute.
     */
    ...
    /**
     * Setter for <code>germinate_db.attributes.description</code>. Describes the attribute. This should expand on the name to make it clear what the attribute actually is.
     */
    ...
    /**
     * Getter for <code>germinate_db.attributes.description</code>. Describes the attribute. This should expand on the name to make it clear what the attribute actually is.
     */
    ...
    /**
     * Setter for <code>germinate_db.attributes.created_on</code>. When the record was created.
     */
    ...
    /**
     * Getter for <code>germinate_db.attributes.created_on</code>. When the record was created.
     */
    ...
    /**
     * Setter for <code>germinate_db.attributes.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Getter for <code>germinate_db.attributes.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
