...
public class ViewTableMapdefinitions extends TableImpl<ViewTableMapdefinitionsRecord> {
    ...
    private ViewTableMapdefinitions(Name alias, Table<ViewTableMapdefinitionsRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_mapdefinitions` as select `germinate_template_4_23_02_16`.`markers`.`id` AS `marker_id`,`germinate_template_4_23_02_16`.`markers`.`marker_name` AS `marker_name`,`germinate_template_4_23_02_16`.`synonyms`.`synonyms` AS `synonyms`,`germinate_template_4_23_02_16`.`mapfeaturetypes`.`description` AS `map_feature_type`,`germinate_template_4_23_02_16`.`maps`.`id` AS `map_id`,`germinate_template_4_23_02_16`.`maps`.`user_id` AS `user_id`,`germinate_template_4_23_02_16`.`maps`.`visibility` AS `visibility`,`germinate_template_4_23_02_16`.`maps`.`name` AS `map_name`,`germinate_template_4_23_02_16`.`mapdefinitions`.`chromosome` AS `chromosome`,`germinate_template_4_23_02_16`.`mapdefinitions`.`definition_start` AS `position` from ((((`germinate_template_4_23_02_16`.`markers` left join `germinate_template_4_23_02_16`.`mapdefinitions` on((`germinate_template_4_23_02_16`.`markers`.`id` = `germinate_template_4_23_02_16`.`mapdefinitions`.`marker_id`))) left join `germinate_template_4_23_02_16`.`mapfeaturetypes` on((`germinate_template_4_23_02_16`.`mapfeaturetypes`.`id` = `germinate_template_4_23_02_16`.`mapdefinitions`.`mapfeaturetype_id`))) left join `germinate_template_4_23_02_16`.`maps` on((`germinate_template_4_23_02_16`.`maps`.`id` = `germinate_template_4_23_02_16`.`mapdefinitions`.`map_id`))) left join `germinate_template_4_23_02_16`.`synonyms` on(((`germinate_template_4_23_02_16`.`synonyms`.`foreign_id` = `germinate_template_4_23_02_16`.`markers`.`id`) and (`germinate_template_4_23_02_16`.`synonyms`.`synonymtype_id` = 2))))"));
    }
