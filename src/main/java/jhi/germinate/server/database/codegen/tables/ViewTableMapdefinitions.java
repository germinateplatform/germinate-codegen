...
public class ViewTableMapdefinitions extends TableImpl<ViewTableMapdefinitionsRecord> {
    ...
    private ViewTableMapdefinitions(Name alias, Table<ViewTableMapdefinitionsRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_mapdefinitions` as select `germinate_template_4_22_10_03`.`markers`.`id` AS `marker_id`,`germinate_template_4_22_10_03`.`markers`.`marker_name` AS `marker_name`,`germinate_template_4_22_10_03`.`synonyms`.`synonyms` AS `synonyms`,`germinate_template_4_22_10_03`.`mapfeaturetypes`.`description` AS `map_feature_type`,`germinate_template_4_22_10_03`.`maps`.`id` AS `map_id`,`germinate_template_4_22_10_03`.`maps`.`user_id` AS `user_id`,`germinate_template_4_22_10_03`.`maps`.`visibility` AS `visibility`,`germinate_template_4_22_10_03`.`maps`.`name` AS `map_name`,`germinate_template_4_22_10_03`.`mapdefinitions`.`chromosome` AS `chromosome`,`germinate_template_4_22_10_03`.`mapdefinitions`.`definition_start` AS `position` from ((((`germinate_template_4_22_10_03`.`markers` left join `germinate_template_4_22_10_03`.`mapdefinitions` on((`germinate_template_4_22_10_03`.`markers`.`id` = `germinate_template_4_22_10_03`.`mapdefinitions`.`marker_id`))) left join `germinate_template_4_22_10_03`.`mapfeaturetypes` on((`germinate_template_4_22_10_03`.`mapfeaturetypes`.`id` = `germinate_template_4_22_10_03`.`mapdefinitions`.`mapfeaturetype_id`))) left join `germinate_template_4_22_10_03`.`maps` on((`germinate_template_4_22_10_03`.`maps`.`id` = `germinate_template_4_22_10_03`.`mapdefinitions`.`map_id`))) left join `germinate_template_4_22_10_03`.`synonyms` on(((`germinate_template_4_22_10_03`.`synonyms`.`foreign_id` = `germinate_template_4_22_10_03`.`markers`.`id`) and (`germinate_template_4_22_10_03`.`synonyms`.`synonymtype_id` = 2))))"));
    }
