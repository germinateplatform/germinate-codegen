...
public class Datasetcollaborators extends TableImpl<DatasetcollaboratorsRecord> {
    ...
    /**
     * The column <code>germinate_db.datasetcollaborators.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Create an aliased <code>germinate_db.datasetcollaborators</code> table reference
     */
    ...
    public Identity<DatasetcollaboratorsRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Datasetcollaborators.DATASETCOLLABORATORS, jhi.germinate.server.database.codegen.tables.Datasetcollaborators.DATASETCOLLABORATORS.ID);
    }
    ...
    public UniqueKey<DatasetcollaboratorsRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Datasetcollaborators.DATASETCOLLABORATORS, "KEY_datasetcollaborators_PRIMARY", jhi.germinate.server.database.codegen.tables.Datasetcollaborators.DATASETCOLLABORATORS.ID);
    }
    ...
    public List<UniqueKey<DatasetcollaboratorsRecord>> getKeys() {
        return Arrays.<UniqueKey<DatasetcollaboratorsRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Datasetcollaborators.DATASETCOLLABORATORS, "KEY_datasetcollaborators_PRIMARY", jhi.germinate.server.database.codegen.tables.Datasetcollaborators.DATASETCOLLABORATORS.ID)
        );
    }
