...
public class ViewTablePublications extends TableImpl<ViewTablePublicationsRecord> {
    ...
    private ViewTablePublications(Name alias, Table<ViewTablePublicationsRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_publications` as select `germinate_template_4_22_09_26`.`publications`.`id` AS `publication_id`,`germinate_template_4_22_09_26`.`publications`.`doi` AS `publication_doi`,`germinate_template_4_22_09_26`.`publications`.`fallback_cache` AS `publication_fallback_cache`,(select TRUE from `germinate_template_4_22_09_26`.`publicationdata` where ((`germinate_template_4_22_09_26`.`publicationdata`.`reference_type` = 'database') and (`germinate_template_4_22_09_26`.`publicationdata`.`publication_id` = `germinate_template_4_22_09_26`.`publications`.`id`))) AS `is_database_pub`,(select json_arrayagg(`germinate_template_4_22_09_26`.`publicationdata`.`foreign_id`) from `germinate_template_4_22_09_26`.`publicationdata` where ((`germinate_template_4_22_09_26`.`publicationdata`.`reference_type` = 'dataset') and (`germinate_template_4_22_09_26`.`publicationdata`.`publication_id` = `germinate_template_4_22_09_26`.`publications`.`id`)) group by `germinate_template_4_22_09_26`.`publicationdata`.`publication_id`) AS `dataset_ids`,(select json_arrayagg(`germinate_template_4_22_09_26`.`publicationdata`.`foreign_id`) from `germinate_template_4_22_09_26`.`publicationdata` where ((`germinate_template_4_22_09_26`.`publicationdata`.`reference_type` = 'germplasm') and (`germinate_template_4_22_09_26`.`publicationdata`.`publication_id` = `germinate_template_4_22_09_26`.`publications`.`id`)) group by `germinate_template_4_22_09_26`.`publicationdata`.`publication_id`) AS `germplasm_ids`,(select json_arrayagg(`germinate_template_4_22_09_26`.`publicationdata`.`foreign_id`) from `germinate_template_4_22_09_26`.`publicationdata` where ((`germinate_template_4_22_09_26`.`publicationdata`.`reference_type` = 'group') and (`germinate_template_4_22_09_26`.`publicationdata`.`publication_id` = `germinate_template_4_22_09_26`.`publications`.`id`)) group by `germinate_template_4_22_09_26`.`publicationdata`.`publication_id`) AS `group_ids`,(select json_arrayagg(`germinate_template_4_22_09_26`.`publicationdata`.`foreign_id`) from `germinate_template_4_22_09_26`.`publicationdata` where ((`germinate_template_4_22_09_26`.`publicationdata`.`reference_type` = 'experiment') and (`germinate_template_4_22_09_26`.`publicationdata`.`publication_id` = `germinate_template_4_22_09_26`.`publications`.`id`)) group by `germinate_template_4_22_09_26`.`publicationdata`.`publication_id`) AS `experiment_ids`,`germinate_template_4_22_09_26`.`publications`.`created_on` AS `created_on`,`germinate_template_4_22_09_26`.`publications`.`updated_on` AS `updated_on` from `germinate_template_4_22_09_26`.`publications`"));
    }
