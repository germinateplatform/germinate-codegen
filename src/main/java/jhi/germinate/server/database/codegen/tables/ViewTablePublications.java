...
public class ViewTablePublications extends TableImpl<ViewTablePublicationsRecord> {
    ...
    private ViewTablePublications(Name alias, Table<ViewTablePublicationsRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_publications` as select `germinate_template_4_22_05_04`.`publications`.`id` AS `publication_id`,`germinate_template_4_22_05_04`.`publications`.`doi` AS `publication_doi`,`germinate_template_4_22_05_04`.`publications`.`fallback_cache` AS `publication_fallback_cache`,`germinate_template_4_22_05_04`.`publicationdata`.`reference_type` AS `reference_type`,json_arrayagg(`germinate_template_4_22_05_04`.`publicationdata`.`foreign_id`) AS `referencing_ids`,`germinate_template_4_22_05_04`.`publications`.`created_on` AS `created_on`,`germinate_template_4_22_05_04`.`publications`.`updated_on` AS `updated_on` from (`germinate_template_4_22_05_04`.`publications` left join `germinate_template_4_22_05_04`.`publicationdata` on((`germinate_template_4_22_05_04`.`publicationdata`.`publication_id` = `germinate_template_4_22_05_04`.`publications`.`id`))) group by `germinate_template_4_22_05_04`.`publications`.`id`,`germinate_template_4_22_05_04`.`publicationdata`.`reference_type`"));
    }
