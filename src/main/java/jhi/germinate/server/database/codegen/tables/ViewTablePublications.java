...
public class ViewTablePublications extends TableImpl<ViewTablePublicationsRecord> {
    ...
    private ViewTablePublications(Name alias, Table<ViewTablePublicationsRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_publications` as select `germinate_template_4_22_08_18`.`publications`.`id` AS `publication_id`,`germinate_template_4_22_08_18`.`publications`.`doi` AS `publication_doi`,`germinate_template_4_22_08_18`.`publications`.`fallback_cache` AS `publication_fallback_cache`,`germinate_template_4_22_08_18`.`publicationdata`.`reference_type` AS `reference_type`,json_arrayagg(`germinate_template_4_22_08_18`.`publicationdata`.`foreign_id`) AS `referencing_ids`,`germinate_template_4_22_08_18`.`publications`.`created_on` AS `created_on`,`germinate_template_4_22_08_18`.`publications`.`updated_on` AS `updated_on` from (`germinate_template_4_22_08_18`.`publications` left join `germinate_template_4_22_08_18`.`publicationdata` on((`germinate_template_4_22_08_18`.`publicationdata`.`publication_id` = `germinate_template_4_22_08_18`.`publications`.`id`))) group by `germinate_template_4_22_08_18`.`publications`.`id`,`germinate_template_4_22_08_18`.`publicationdata`.`reference_type`"));
    }
