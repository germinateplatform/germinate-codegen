...
public class Stories extends TableImpl<StoriesRecord> {
     ...
     */
    public final TableField<StoriesRecord, Timestamp> CREATED_ON = createField(DSL.name("created_on"), SQLDataType.TIMESTAMP(0).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>germinate_db.stories.updated_on</code>.
     */
    public final TableField<StoriesRecord, Timestamp> UPDATED_ON = createField(DSL.name("updated_on"), SQLDataType.TIMESTAMP(0).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMP)), this, "");

    private Stories(Name alias, Table<StoriesRecord> aliased) {
        this(alias, aliased, (Field<?>[]) null, null);
    }

    private Stories(Name alias, Table<StoriesRecord> aliased, Field<?>[] parameters, Condition where) {
     ...
     */
    @Override
    public Stories where(Condition condition) {
        return new Stories(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public Stories where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public Stories where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public Stories where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public Stories where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public Stories where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public Stories where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public Stories where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public Stories whereExists(Select<?> select) {
     ...
     */
    @Override
    public Stories whereNotExists(Select<?> select) {
