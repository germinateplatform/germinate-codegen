...
public class Treatments extends TableImpl<TreatmentsRecord> {
    ...
    private static final long serialVersionUID = 329174319;
    ...
    /**
     * The column <code>germinate_db.treatments.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.treatments.name</code>. The name which defines the treatment.
     */
    ...
    /**
     * The column <code>germinate_db.treatments.description</code>. A longer descripiton of the treatment. This should include enough information to be able to identify what the treatment was and why it was applied.
     */
    ...
    /**
     * The column <code>germinate_db.treatments.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.treatments.updated_on</code>. When the record was updated. This may be different from the created on date if changes have been made subsequently to the underlying record.
     */
    ...
    public Identity<TreatmentsRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Treatments.TREATMENTS, jhi.germinate.server.database.codegen.tables.Treatments.TREATMENTS.ID);
    }
    ...
    public UniqueKey<TreatmentsRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Treatments.TREATMENTS, "KEY_treatments_PRIMARY", jhi.germinate.server.database.codegen.tables.Treatments.TREATMENTS.ID);
    }
    ...
    public List<UniqueKey<TreatmentsRecord>> getKeys() {
        return Arrays.<UniqueKey<TreatmentsRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Treatments.TREATMENTS, "KEY_treatments_PRIMARY", jhi.germinate.server.database.codegen.tables.Treatments.TREATMENTS.ID)
        );
    }
