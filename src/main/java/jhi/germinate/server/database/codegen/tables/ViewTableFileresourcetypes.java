...
public class ViewTableFileresourcetypes extends TableImpl<ViewTableFileresourcetypesRecord> {
    ...
    private ViewTableFileresourcetypes(Name alias, Table<ViewTableFileresourcetypesRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.view("create view `view_table_fileresourcetypes` as select `germinate_template_5_26_01_28`.`fileresourcetypes`.`id` AS `id`,`germinate_template_5_26_01_28`.`fileresourcetypes`.`name` AS `name`,`germinate_template_5_26_01_28`.`fileresourcetypes`.`description` AS `description`,`germinate_template_5_26_01_28`.`fileresourcetypes`.`created_on` AS `created_on`,`germinate_template_5_26_01_28`.`fileresourcetypes`.`updated_on` AS `updated_on`,(select count(1) from `germinate_template_5_26_01_28`.`fileresources` where (`germinate_template_5_26_01_28`.`fileresources`.`fileresourcetype_id` = `germinate_template_5_26_01_28`.`fileresourcetypes`.`id`)) AS `count` from `germinate_template_5_26_01_28`.`fileresourcetypes`"), where);
    }
