...
public class ViewTableFileresourcetypes extends TableImpl<ViewTableFileresourcetypesRecord> {
    ...
    private ViewTableFileresourcetypes(Name alias, Table<ViewTableFileresourcetypesRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_fileresourcetypes` as select `germinate_template_4_25_01_23`.`fileresourcetypes`.`id` AS `id`,`germinate_template_4_25_01_23`.`fileresourcetypes`.`name` AS `name`,`germinate_template_4_25_01_23`.`fileresourcetypes`.`description` AS `description`,`germinate_template_4_25_01_23`.`fileresourcetypes`.`created_on` AS `created_on`,`germinate_template_4_25_01_23`.`fileresourcetypes`.`updated_on` AS `updated_on`,(select count(1) from `germinate_template_4_25_01_23`.`fileresources` where (`germinate_template_4_25_01_23`.`fileresources`.`fileresourcetype_id` = `germinate_template_4_25_01_23`.`fileresourcetypes`.`id`)) AS `count` from `germinate_template_4_25_01_23`.`fileresourcetypes`"));
    }
