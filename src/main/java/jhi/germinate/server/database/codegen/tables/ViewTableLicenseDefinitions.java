...
public class ViewTableLicenseDefinitions extends TableImpl<ViewTableLicenseDefinitionsRecord> {
    ...
    private ViewTableLicenseDefinitions(Name alias, Table<ViewTableLicenseDefinitionsRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.view("create view `view_table_license_definitions` as select `germinate_template_5_26_01_28`.`licenses`.`id` AS `license_id`,`germinate_template_5_26_01_28`.`licenses`.`name` AS `license_name`,`germinate_template_5_26_01_28`.`licenses`.`description` AS `license_description`,`germinate_template_5_26_01_28`.`licenses`.`created_on` AS `created_on`,(select json_objectagg(`germinate_template_5_26_01_28`.`locales`.`name`,`germinate_template_5_26_01_28`.`licensedata`.`content`) from (`germinate_template_5_26_01_28`.`licensedata` left join `germinate_template_5_26_01_28`.`locales` on((`germinate_template_5_26_01_28`.`locales`.`id` = `germinate_template_5_26_01_28`.`licensedata`.`locale_id`))) where (`germinate_template_5_26_01_28`.`licensedata`.`license_id` = `germinate_template_5_26_01_28`.`licenses`.`id`) group by `germinate_template_5_26_01_28`.`licensedata`.`license_id`) AS `license_data` from `germinate_template_5_26_01_28`.`licenses`"), where);
    }
