...
public class ViewTableLicenseDefinitions extends TableImpl<ViewTableLicenseDefinitionsRecord> {
    ...
    private ViewTableLicenseDefinitions(Name alias, Table<ViewTableLicenseDefinitionsRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_license_definitions` as select `germinate_template_4_23_02_16`.`licenses`.`id` AS `license_id`,`germinate_template_4_23_02_16`.`licenses`.`name` AS `license_name`,`germinate_template_4_23_02_16`.`licenses`.`description` AS `license_description`,`germinate_template_4_23_02_16`.`licenses`.`created_on` AS `created_on`,(select json_objectagg(`germinate_template_4_23_02_16`.`locales`.`name`,`germinate_template_4_23_02_16`.`licensedata`.`content`) from (`germinate_template_4_23_02_16`.`licensedata` left join `germinate_template_4_23_02_16`.`locales` on((`germinate_template_4_23_02_16`.`locales`.`id` = `germinate_template_4_23_02_16`.`licensedata`.`locale_id`))) where (`germinate_template_4_23_02_16`.`licensedata`.`license_id` = `germinate_template_4_23_02_16`.`licenses`.`id`) group by `germinate_template_4_23_02_16`.`licensedata`.`license_id`) AS `license_data` from `germinate_template_4_23_02_16`.`licenses`"));
    }
