...
public class ViewTableLicenseDefinitions extends TableImpl<ViewTableLicenseDefinitionsRecord> {
    ...
    private ViewTableLicenseDefinitions(Name alias, Table<ViewTableLicenseDefinitionsRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_license_definitions` as select `germinate_template_4_22_09_26`.`licenses`.`id` AS `license_id`,`germinate_template_4_22_09_26`.`licenses`.`name` AS `license_name`,`germinate_template_4_22_09_26`.`licenses`.`description` AS `license_description`,`germinate_template_4_22_09_26`.`licenses`.`created_on` AS `created_on`,(select json_objectagg(`germinate_template_4_22_09_26`.`locales`.`name`,`germinate_template_4_22_09_26`.`licensedata`.`content`) from (`germinate_template_4_22_09_26`.`licensedata` left join `germinate_template_4_22_09_26`.`locales` on((`germinate_template_4_22_09_26`.`locales`.`id` = `germinate_template_4_22_09_26`.`licensedata`.`locale_id`))) where (`germinate_template_4_22_09_26`.`licensedata`.`license_id` = `germinate_template_4_22_09_26`.`licenses`.`id`) group by `germinate_template_4_22_09_26`.`licensedata`.`license_id`) AS `license_data` from `germinate_template_4_22_09_26`.`licenses`"));
    }
