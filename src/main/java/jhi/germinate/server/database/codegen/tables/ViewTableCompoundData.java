...
public class ViewTableCompoundData extends TableImpl<ViewTableCompoundDataRecord> {
    ...
    private ViewTableCompoundData(Name alias, Table<ViewTableCompoundDataRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_compound_data` as select `germinate_template_4_22_05_04`.`germinatebase`.`id` AS `germplasm_id`,`germinate_template_4_22_05_04`.`germinatebase`.`general_identifier` AS `germplasm_gid`,`germinate_template_4_22_05_04`.`germinatebase`.`name` AS `germplasm_name`,`germinate_template_4_22_05_04`.`synonyms`.`synonyms` AS `germplasm_synonyms`,`g`.`name` AS `entity_parent_name`,`g`.`general_identifier` AS `entity_parent_general_identifier`,`germinate_template_4_22_05_04`.`entitytypes`.`name` AS `entity_type`,`germinate_template_4_22_05_04`.`datasets`.`id` AS `dataset_id`,`germinate_template_4_22_05_04`.`datasets`.`name` AS `dataset_name`,`germinate_template_4_22_05_04`.`datasets`.`description` AS `dataset_description`,`germinate_template_4_22_05_04`.`compounds`.`id` AS `compound_id`,`germinate_template_4_22_05_04`.`compounds`.`name` AS `compound_name`,`germinate_template_4_22_05_04`.`units`.`unit_name` AS `unit_name`,`germinate_template_4_22_05_04`.`compounddata`.`recording_date` AS `recording_date`,`germinate_template_4_22_05_04`.`compounddata`.`compound_value` AS `compound_value` from (((((((`germinate_template_4_22_05_04`.`compounddata` left join `germinate_template_4_22_05_04`.`germinatebase` on((`germinate_template_4_22_05_04`.`germinatebase`.`id` = `germinate_template_4_22_05_04`.`compounddata`.`germinatebase_id`))) left join `germinate_template_4_22_05_04`.`germinatebase` `g` on((`germinate_template_4_22_05_04`.`germinatebase`.`entityparent_id` = `g`.`id`))) left join `germinate_template_4_22_05_04`.`synonyms` on(((`germinate_template_4_22_05_04`.`synonyms`.`synonymtype_id` = 1) and (`germinate_template_4_22_05_04`.`synonyms`.`foreign_id` = `germinate_template_4_22_05_04`.`germinatebase`.`id`)))) left join `germinate_template_4_22_05_04`.`entitytypes` on((`germinate_template_4_22_05_04`.`entitytypes`.`id` = `germinate_template_4_22_05_04`.`germinatebase`.`entitytype_id`))) left join `germinate_template_4_22_05_04`.`compounds` on((`germinate_template_4_22_05_04`.`compounds`.`id` = `germinate_template_4_22_05_04`.`compounddata`.`compound_id`))) left join `germinate_template_4_22_05_04`.`units` on((`germinate_template_4_22_05_04`.`units`.`id` = `germinate_template_4_22_05_04`.`compounds`.`unit_id`))) left join `germinate_template_4_22_05_04`.`datasets` on((`germinate_template_4_22_05_04`.`datasets`.`id` = `germinate_template_4_22_05_04`.`compounddata`.`dataset_id`)))"));
    }
