...
public class ViewTableCompoundData extends TableImpl<ViewTableCompoundDataRecord> {
    ...
    private ViewTableCompoundData(Name alias, Table<ViewTableCompoundDataRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_compound_data` as select `germinate_template_4_22_09_02`.`germinatebase`.`id` AS `germplasm_id`,`germinate_template_4_22_09_02`.`germinatebase`.`general_identifier` AS `germplasm_gid`,`germinate_template_4_22_09_02`.`germinatebase`.`name` AS `germplasm_name`,`germinate_template_4_22_09_02`.`synonyms`.`synonyms` AS `germplasm_synonyms`,`g`.`name` AS `entity_parent_name`,`g`.`general_identifier` AS `entity_parent_general_identifier`,`germinate_template_4_22_09_02`.`entitytypes`.`name` AS `entity_type`,`germinate_template_4_22_09_02`.`datasets`.`id` AS `dataset_id`,`germinate_template_4_22_09_02`.`datasets`.`name` AS `dataset_name`,`germinate_template_4_22_09_02`.`datasets`.`description` AS `dataset_description`,`germinate_template_4_22_09_02`.`compounds`.`id` AS `compound_id`,`germinate_template_4_22_09_02`.`compounds`.`name` AS `compound_name`,`germinate_template_4_22_09_02`.`units`.`unit_name` AS `unit_name`,`germinate_template_4_22_09_02`.`compounddata`.`recording_date` AS `recording_date`,`germinate_template_4_22_09_02`.`compounddata`.`compound_value` AS `compound_value` from (((((((`germinate_template_4_22_09_02`.`compounddata` left join `germinate_template_4_22_09_02`.`germinatebase` on((`germinate_template_4_22_09_02`.`germinatebase`.`id` = `germinate_template_4_22_09_02`.`compounddata`.`germinatebase_id`))) left join `germinate_template_4_22_09_02`.`germinatebase` `g` on((`germinate_template_4_22_09_02`.`germinatebase`.`entityparent_id` = `g`.`id`))) left join `germinate_template_4_22_09_02`.`synonyms` on(((`germinate_template_4_22_09_02`.`synonyms`.`synonymtype_id` = 1) and (`germinate_template_4_22_09_02`.`synonyms`.`foreign_id` = `germinate_template_4_22_09_02`.`germinatebase`.`id`)))) left join `germinate_template_4_22_09_02`.`entitytypes` on((`germinate_template_4_22_09_02`.`entitytypes`.`id` = `germinate_template_4_22_09_02`.`germinatebase`.`entitytype_id`))) left join `germinate_template_4_22_09_02`.`compounds` on((`germinate_template_4_22_09_02`.`compounds`.`id` = `germinate_template_4_22_09_02`.`compounddata`.`compound_id`))) left join `germinate_template_4_22_09_02`.`units` on((`germinate_template_4_22_09_02`.`units`.`id` = `germinate_template_4_22_09_02`.`compounds`.`unit_id`))) left join `germinate_template_4_22_09_02`.`datasets` on((`germinate_template_4_22_09_02`.`datasets`.`id` = `germinate_template_4_22_09_02`.`compounddata`.`dataset_id`)))"));
    }
