...
public class Commenttypes extends TableImpl<CommenttypesRecord> {
     ...
     * record was created.
     */
    public final TableField<CommenttypesRecord, Timestamp> CREATED_ON = createField(DSL.name("created_on"), SQLDataType.TIMESTAMP(0).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMP)), this, "When the record was created.");
    ...
    private Commenttypes(Name alias, Table<CommenttypesRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment("Defines the comment type."), TableOptions.table(), where);
    }
    ...
    @Override
    public Commenttypes as(Table<?> alias) {
        return new Commenttypes(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public Commenttypes rename(Table<?> name) {
        return new Commenttypes(name.getQualifiedName(), null);
    }
     ...
     */
    @Override
    public Commenttypes where(Condition condition) {
        return new Commenttypes(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public Commenttypes where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public Commenttypes where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public Commenttypes where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public Commenttypes where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public Commenttypes where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public Commenttypes where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public Commenttypes where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public Commenttypes whereExists(Select<?> select) {
     ...
     */
    @Override
    public Commenttypes whereNotExists(Select<?> select) {
