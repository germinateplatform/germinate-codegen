...
public class Commenttypes extends TableImpl<CommenttypesRecord> {
    ...
    private static final long serialVersionUID = 461491001;
    ...
    /**
     * The column <code>germinate_db.commenttypes.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.commenttypes.description</code>. Describes the comment type.
     */
    ...
    /**
     * The column <code>germinate_db.commenttypes.reference_table</code>. This could include 'germinatebase' or 'markers' to define the table that the comment relates to.
     */
    ...
    /**
     * The column <code>germinate_db.commenttypes.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.commenttypes.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    public Identity<CommenttypesRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Commenttypes.COMMENTTYPES, jhi.germinate.server.database.codegen.tables.Commenttypes.COMMENTTYPES.ID);
    }
    ...
    public UniqueKey<CommenttypesRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Commenttypes.COMMENTTYPES, "KEY_commenttypes_PRIMARY", jhi.germinate.server.database.codegen.tables.Commenttypes.COMMENTTYPES.ID);
    }
    ...
    public List<UniqueKey<CommenttypesRecord>> getKeys() {
        return Arrays.<UniqueKey<CommenttypesRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Commenttypes.COMMENTTYPES, "KEY_commenttypes_PRIMARY", jhi.germinate.server.database.codegen.tables.Commenttypes.COMMENTTYPES.ID)
        );
    }
