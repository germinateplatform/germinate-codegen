...
public class ViewTableLocations extends TableImpl<ViewTableLocationsRecord> {
    ...
    private ViewTableLocations(Name alias, Table<ViewTableLocationsRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.view("create view `view_table_locations` as select `germinate_template_5_26_08_13`.`locations`.`id` AS `location_id`,`germinate_template_5_26_08_13`.`locations`.`site_name` AS `location_name`,`germinate_template_5_26_08_13`.`locations`.`site_name_short` AS `location_name_short`,`germinate_template_5_26_08_13`.`locations`.`region` AS `location_region`,`germinate_template_5_26_08_13`.`locations`.`state` AS `location_state`,`germinate_template_5_26_08_13`.`locationtypes`.`name` AS `location_type`,`germinate_template_5_26_08_13`.`locations`.`latitude` AS `location_latitude`,`germinate_template_5_26_08_13`.`locations`.`longitude` AS `location_longitude`,`germinate_template_5_26_08_13`.`locations`.`elevation` AS `location_elevation`,`germinate_template_5_26_08_13`.`locations`.`coordinate_uncertainty` AS `location_coordinate_uncertainty`,`germinate_template_5_26_08_13`.`countries`.`id` AS `country_id`,`germinate_template_5_26_08_13`.`countries`.`country_name` AS `country_name`,`germinate_template_5_26_08_13`.`countries`.`country_code2` AS `country_code2`,`germinate_template_5_26_08_13`.`countries`.`country_code3` AS `country_code3` from ((`germinate_template_5_26_08_13`.`locations` left join `germinate_template_5_26_08_13`.`countries` on((`germinate_template_5_26_08_13`.`countries`.`id` = `germinate_template_5_26_08_13`.`locations`.`country_id`))) left join `germinate_template_5_26_08_13`.`locationtypes` on((`germinate_template_5_26_08_13`.`locationtypes`.`id` = `germinate_template_5_26_08_13`.`locations`.`locationtype_id`)))"), where);
    }
