...
public class ViewTableLocations extends TableImpl<ViewTableLocationsRecord> {
    ...
    private ViewTableLocations(Name alias, Table<ViewTableLocationsRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_locations` as select `germinate_template_4_25_01_14`.`locations`.`id` AS `location_id`,`germinate_template_4_25_01_14`.`locations`.`site_name` AS `location_name`,`germinate_template_4_25_01_14`.`locations`.`site_name_short` AS `location_name_short`,`germinate_template_4_25_01_14`.`locations`.`region` AS `location_region`,`germinate_template_4_25_01_14`.`locations`.`state` AS `location_state`,`germinate_template_4_25_01_14`.`locationtypes`.`name` AS `location_type`,`germinate_template_4_25_01_14`.`locations`.`latitude` AS `location_latitude`,`germinate_template_4_25_01_14`.`locations`.`longitude` AS `location_longitude`,`germinate_template_4_25_01_14`.`locations`.`elevation` AS `location_elevation`,`germinate_template_4_25_01_14`.`locations`.`coordinate_uncertainty` AS `location_coordinate_uncertainty`,`germinate_template_4_25_01_14`.`countries`.`id` AS `country_id`,`germinate_template_4_25_01_14`.`countries`.`country_name` AS `country_name`,`germinate_template_4_25_01_14`.`countries`.`country_code2` AS `country_code2`,`germinate_template_4_25_01_14`.`countries`.`country_code3` AS `country_code3` from ((`germinate_template_4_25_01_14`.`locations` left join `germinate_template_4_25_01_14`.`countries` on((`germinate_template_4_25_01_14`.`countries`.`id` = `germinate_template_4_25_01_14`.`locations`.`country_id`))) left join `germinate_template_4_25_01_14`.`locationtypes` on((`germinate_template_4_25_01_14`.`locationtypes`.`id` = `germinate_template_4_25_01_14`.`locations`.`locationtype_id`)))"));
    }
