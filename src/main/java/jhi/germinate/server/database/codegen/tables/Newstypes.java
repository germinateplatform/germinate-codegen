...
public class Newstypes extends TableImpl<NewstypesRecord> {
    ...
    private static final long serialVersionUID = -1674639996;
    ...
    /**
     * The column <code>germinate_db.newstypes.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.newstypes.name</code>. Name of the news type.
     */
    ...
    /**
     * The column <code>germinate_db.newstypes.description</code>. A longer description of the news type.
     */
    ...
    /**
     * The column <code>germinate_db.newstypes.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.newstypes.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    public Identity<NewstypesRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Newstypes.NEWSTYPES, jhi.germinate.server.database.codegen.tables.Newstypes.NEWSTYPES.ID);
    }
    ...
    public UniqueKey<NewstypesRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Newstypes.NEWSTYPES, "KEY_newstypes_PRIMARY", jhi.germinate.server.database.codegen.tables.Newstypes.NEWSTYPES.ID);
    }
    ...
    public List<UniqueKey<NewstypesRecord>> getKeys() {
        return Arrays.<UniqueKey<NewstypesRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Newstypes.NEWSTYPES, "KEY_newstypes_PRIMARY", jhi.germinate.server.database.codegen.tables.Newstypes.NEWSTYPES.ID)
        );
    }
