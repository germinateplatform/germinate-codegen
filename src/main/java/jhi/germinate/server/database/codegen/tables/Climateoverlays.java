...
public class Climateoverlays extends TableImpl<ClimateoverlaysRecord> {
    ...
    private static final long serialVersionUID = 855606001;
    ...
    /**
     * The column <code>germinate_db.climateoverlays.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.climateoverlays.climate_id</code>. Foreign key to climates (climates.id).
     */
    ...
    /**
     * The column <code>germinate_db.climateoverlays.path</code>. This is the path for holding images which can be used as overlays for the Google Maps representation in Germinate. The path is relative.
     */
    ...
    /**
     * The column <code>germinate_db.climateoverlays.bottom_left_longitude</code>. Allows the allignment of images against OpenStreetMap API.
     */
    ...
    /**
     * The column <code>germinate_db.climateoverlays.bottom_left_latitude</code>. Allows the allignment of images against OpenStreetMap API.
     */
    ...
    /**
     * The column <code>germinate_db.climateoverlays.top_right_longitude</code>. Allows the allignment of images against OpenStreetMap API.
     */
    ...
    /**
     * The column <code>germinate_db.climateoverlays.top_right_latitude</code>. Allows the allignment of images against OpenStreetMap API.
     */
    ...
    /**
     * The column <code>germinate_db.climateoverlays.is_legend</code>. The legend for the image. What colours represent in the overlays. This is not required but used if present. 
     */
    ...
    /**
     * The column <code>germinate_db.climateoverlays.description</code>. Describes the climate overlay if additional explanation of  the overlay image is required.
     */
    ...
    /**
     * The column <code>germinate_db.climateoverlays.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.climateoverlays.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Create an aliased <code>germinate_db.climateoverlays</code> table reference
     */
    ...
    public Identity<ClimateoverlaysRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Climateoverlays.CLIMATEOVERLAYS, jhi.germinate.server.database.codegen.tables.Climateoverlays.CLIMATEOVERLAYS.ID);
    }
    ...
    public UniqueKey<ClimateoverlaysRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Climateoverlays.CLIMATEOVERLAYS, "KEY_climateoverlays_PRIMARY", jhi.germinate.server.database.codegen.tables.Climateoverlays.CLIMATEOVERLAYS.ID);
    }
    ...
    public List<UniqueKey<ClimateoverlaysRecord>> getKeys() {
        return Arrays.<UniqueKey<ClimateoverlaysRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Climateoverlays.CLIMATEOVERLAYS, "KEY_climateoverlays_PRIMARY", jhi.germinate.server.database.codegen.tables.Climateoverlays.CLIMATEOVERLAYS.ID)
        );
    }
