...
public class ViewTableStories extends TableImpl<ViewTableStoriesRecord> {
    ...
    private ViewTableStories(Name alias, Table<ViewTableStoriesRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.view("create view `view_table_stories` as select `germinate_template_5_26_01_28`.`stories`.`id` AS `story_id`,`germinate_template_5_26_01_28`.`stories`.`name` AS `story_name`,`germinate_template_5_26_01_28`.`stories`.`description` AS `story_description`,`germinate_template_5_26_01_28`.`stories`.`requirements` AS `story_requirements`,`germinate_template_5_26_01_28`.`images`.`id` AS `story_image_id`,`germinate_template_5_26_01_28`.`images`.`path` AS `story_image_name`,`germinate_template_5_26_01_28`.`projects`.`id` AS `project_id`,`germinate_template_5_26_01_28`.`projects`.`name` AS `project_name`,`germinate_template_5_26_01_28`.`projects`.`description` AS `project_description`,`germinate_template_5_26_01_28`.`stories`.`featured` AS `story_featured`,`germinate_template_5_26_01_28`.`stories`.`visibility` AS `story_visibility`,`germinate_template_5_26_01_28`.`stories`.`user_id` AS `story_user_id`,`germinate_template_5_26_01_28`.`publications`.`id` AS `publication_id`,`germinate_template_5_26_01_28`.`publications`.`doi` AS `publication_doi`,json_arrayagg(json_object('id',`germinate_template_5_26_01_28`.`storysteps`.`id`,'name',`germinate_template_5_26_01_28`.`storysteps`.`name`,'description',`germinate_template_5_26_01_28`.`storysteps`.`description`,'storyId',`germinate_template_5_26_01_28`.`storysteps`.`story_id`,'storyIndex',`germinate_template_5_26_01_28`.`storysteps`.`story_index`,'pageConfig',`germinate_template_5_26_01_28`.`storysteps`.`page_config`,'storyIndex',`germinate_template_5_26_01_28`.`storysteps`.`story_index`,'imageId',`germinate_template_5_26_01_28`.`storysteps`.`image_id`,'createdOn',date_format(`germinate_template_5_26_01_28`.`storysteps`.`created_on`,'%Y-%m-%d %H:%i:%s'),'updatedOn',date_format(`germinate_template_5_26_01_28`.`storysteps`.`updated_on`,'%Y-%m-%d %H:%i:%s'))) AS `story_steps`,`germinate_template_5_26_01_28`.`stories`.`created_on` AS `story_created_on`,`germinate_template_5_26_01_28`.`stories`.`updated_on` AS `story_updated_on` from ((((`germinate_template_5_26_01_28`.`stories` left join `germinate_template_5_26_01_28`.`storysteps` on((`germinate_template_5_26_01_28`.`stories`.`id` = `germinate_template_5_26_01_28`.`storysteps`.`story_id`))) left join `germinate_template_5_26_01_28`.`images` on((`germinate_template_5_26_01_28`.`images`.`id` = `germinate_template_5_26_01_28`.`stories`.`image_id`))) left join `germinate_template_5_26_01_28`.`publications` on((`germinate_template_5_26_01_28`.`publications`.`id` = `germinate_template_5_26_01_28`.`stories`.`publication_id`))) left join `germinate_template_5_26_01_28`.`projects` on((`germinate_template_5_26_01_28`.`projects`.`id` = `germinate_template_5_26_01_28`.`stories`.`project_id`))) group by `germinate_template_5_26_01_28`.`stories`.`id`"), where);
    }
