...
public class ViewTableStories extends TableImpl<ViewTableStoriesRecord> {
     ...
     */
    public final TableField<ViewTableStoriesRecord, Timestamp> STORY_CREATED_ON = createField(DSL.name("story_created_on"), SQLDataType.TIMESTAMP(0).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>germinate_db.view_table_stories.story_updated_on</code>.
     */
    public final TableField<ViewTableStoriesRecord, Timestamp> STORY_UPDATED_ON = createField(DSL.name("story_updated_on"), SQLDataType.TIMESTAMP(0).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMP)), this, "");
    ...
    private ViewTableStories(Name alias, Table<ViewTableStoriesRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.view("create view `view_table_stories` as select `germinate_template_5_26_08_13`.`stories`.`id` AS `story_id`,`germinate_template_5_26_08_13`.`stories`.`name` AS `story_name`,`germinate_template_5_26_08_13`.`stories`.`description` AS `story_description`,`germinate_template_5_26_08_13`.`stories`.`requirements` AS `story_requirements`,`germinate_template_5_26_08_13`.`images`.`id` AS `story_image_id`,`germinate_template_5_26_08_13`.`images`.`path` AS `story_image_name`,`germinate_template_5_26_08_13`.`projects`.`id` AS `project_id`,`germinate_template_5_26_08_13`.`projects`.`name` AS `project_name`,`germinate_template_5_26_08_13`.`projects`.`description` AS `project_description`,`germinate_template_5_26_08_13`.`stories`.`featured` AS `story_featured`,`germinate_template_5_26_08_13`.`stories`.`visibility` AS `story_visibility`,`germinate_template_5_26_08_13`.`stories`.`user_id` AS `story_user_id`,`germinate_template_5_26_08_13`.`publications`.`id` AS `publication_id`,`germinate_template_5_26_08_13`.`publications`.`doi` AS `publication_doi`,(select coalesce(json_arrayagg(json_object('id',`germinate_template_5_26_08_13`.`storysteps`.`id`,'name',`germinate_template_5_26_08_13`.`storysteps`.`name`,'description',`germinate_template_5_26_08_13`.`storysteps`.`description`,'storyId',`germinate_template_5_26_08_13`.`storysteps`.`story_id`,'storyIndex',`germinate_template_5_26_08_13`.`storysteps`.`story_index`,'pageConfig',`germinate_template_5_26_08_13`.`storysteps`.`page_config`,'storyIndex',`germinate_template_5_26_08_13`.`storysteps`.`story_index`,'imageId',`germinate_template_5_26_08_13`.`storysteps`.`image_id`,'createdOn',date_format(`germinate_template_5_26_08_13`.`storysteps`.`created_on`,'%Y-%m-%d %H:%i:%s'),'updatedOn',date_format(`germinate_template_5_26_08_13`.`storysteps`.`updated_on`,'%Y-%m-%d %H:%i:%s'))),json_array()) from `germinate_template_5_26_08_13`.`storysteps` where (`germinate_template_5_26_08_13`.`storysteps`.`story_id` = `germinate_template_5_26_08_13`.`stories`.`id`)) AS `story_steps`,`germinate_template_5_26_08_13`.`stories`.`created_on` AS `story_created_on`,`germinate_template_5_26_08_13`.`stories`.`updated_on` AS `story_updated_on` from (((`germinate_template_5_26_08_13`.`stories` left join `germinate_template_5_26_08_13`.`images` on((`germinate_template_5_26_08_13`.`images`.`id` = `germinate_template_5_26_08_13`.`stories`.`image_id`))) left join `germinate_template_5_26_08_13`.`publications` on((`germinate_template_5_26_08_13`.`publications`.`id` = `germinate_template_5_26_08_13`.`stories`.`publication_id`))) left join `germinate_template_5_26_08_13`.`projects` on((`germinate_template_5_26_08_13`.`projects`.`id` = `germinate_template_5_26_08_13`.`stories`.`project_id`))) group by `germinate_template_5_26_08_13`.`stories`.`id`"), where);
    }
    ...
    @Override
    public ViewTableStories as(Table<?> alias) {
        return new ViewTableStories(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public ViewTableStories rename(Table<?> name) {
        return new ViewTableStories(name.getQualifiedName(), null);
    }
     ...
     */
    @Override
    public ViewTableStories where(Condition condition) {
        return new ViewTableStories(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public ViewTableStories where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public ViewTableStories where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public ViewTableStories where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public ViewTableStories where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public ViewTableStories where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public ViewTableStories where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public ViewTableStories where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public ViewTableStories whereExists(Select<?> select) {
     ...
     */
    @Override
    public ViewTableStories whereNotExists(Select<?> select) {
