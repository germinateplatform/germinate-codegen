...
public class ViewTableTraits extends TableImpl<ViewTableTraitsRecord> {
    ...
    private static final long serialVersionUID = -1380948245;
    ...
    /**
     * The column <code>germinate_db.view_table_traits.trait_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_traits.trait_name</code>. Phenotype full name.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_traits.trait_name_short</code>. Shortened name for the phenotype. This is used in table columns where space is an issue.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_traits.trait_description</code>. Full description of the phenotype. This should contain enough infomation to accurately identify the phenoytpe and how it was recorded.
     */
     ...
     */
    public final TableField<ViewTableTraitsRecord, TraitRestrictions> TRAIT_RESTRICTIONS = createField("trait_restrictions", org.jooq.impl.DefaultDataType.getDefaultDataType("\"germinate_template_4_22_05_04\".\"view_table_traits_trait_restrictions\""), this, "A json object describing the restrictions placed on this trait. It is an object containing a field called \"categories\" which is an array of arrays, each describing a categorical scale. Each scale must have the same length as they describe the same categories just using different terms or numbers. The other fields are \"min\" and \"max\" to specify upper and lower limits for numeric traits.", new TraitRestrictionBinding());
    ...
    /**
     * The column <code>germinate_db.view_table_traits.unit_name</code>. The name of the unit. This should be the name of the unit in full.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_traits.unit_description</code>. A description of the unit. If the unit is not a standard SI unit then it is beneficial to have a description which explains what the unit it, how it is derived and any other information which would help identifiy it.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_traits.unit_abbreviation</code>. This should be the unit abbreviation.
     */
     ...
     */
    public final TableField<ViewTableTraitsRecord, String[]> SYNONYMS = createField("synonyms", org.jooq.impl.DefaultDataType.getDefaultDataType("\"germinate_template_4_22_05_04\".\"view_table_traits_synonyms\""), this, "The synonyms as a json array.", new SynonymBinding());

    /**
     * The column <code>germinate_db.view_table_traits.dataset_ids</code>.
     */
    public final TableField<ViewTableTraitsRecord, Integer[]> DATASET_IDS = createField("dataset_ids", org.jooq.impl.DefaultDataType.getDefaultDataType("\"germinate_template_4_22_05_04\".\"view_table_traits_dataset_ids\""), this, "", new IntArrayBinding());
    ...
    /**
     * Create an aliased <code>germinate_db.view_table_traits</code> table reference
     */
