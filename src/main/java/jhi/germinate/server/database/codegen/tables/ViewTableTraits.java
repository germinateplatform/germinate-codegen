...
public class ViewTableTraits extends TableImpl<ViewTableTraitsRecord> {
    ...
    private static final long serialVersionUID = 1529734278;
     ...
     */
    public final TableField<ViewTableTraitsRecord, String[]> SYNONYMS = createField("synonyms", org.jooq.impl.DefaultDataType.getDefaultDataType("\"germinate_template_4_21_04_09\".\"view_table_traits_synonyms\""), this, "The synonyms as a json array.", new SynonymBinding());

    /**
     * The column <code>germinate_db.view_table_traits.dataset_ids</code>.
     */
    public final TableField<ViewTableTraitsRecord, Integer[]> DATASET_IDS = createField("dataset_ids", org.jooq.impl.DefaultDataType.getDefaultDataType("\"germinate_template_4_21_04_09\".\"view_table_traits_dataset_ids\""), this, "", new IntArrayBinding());
