...
public class DataImportJobsRecord extends UpdatableRecordImpl<DataImportJobsRecord> implements Record15<Integer, String, String, ImportJobDetails, Integer, String, Boolean, Integer, DataImportJobsDatatype, DataImportJobsStatus, Boolean, Boolean, ImportResult[], Timestamp, Timestamp> {
    ...
    @Override
    public Row15<Integer, String, String, ImportJobDetails, Integer, String, Boolean, Integer, DataImportJobsDatatype, DataImportJobsStatus, Boolean, Boolean, ImportResult[], Timestamp, Timestamp> valuesRow() {
    ...
    @Override
    public DataImportJobsRecord values(Integer value1, String value2, String value3, ImportJobDetails value4, Integer value5, String value6, Boolean value7, Integer value8, DataImportJobsDatatype value9, DataImportJobsStatus value10, Boolean value11, Boolean value12, ImportResult[] value13, Timestamp value14, Timestamp value15) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DataImportJobsRecord(Integer id, String uuid, String jobId, ImportJobDetails jobConfig, Integer userId, String originalFilename, Boolean isUpdate, Integer datasetstateId, DataImportJobsDatatype datatype, DataImportJobsStatus status, Boolean imported, Boolean visibility, ImportResult[] feedback, Timestamp createdOn, Timestamp updatedOn) {
        super(DataImportJobs.DATA_IMPORT_JOBS);
