...
public class ViewTablePedigreedefinitions extends TableImpl<ViewTablePedigreedefinitionsRecord> {
    ...
    private ViewTablePedigreedefinitions(Name alias, Table<ViewTablePedigreedefinitionsRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_pedigreedefinitions` as select `germinate_template_4_25_01_14`.`germinatebase`.`id` AS `germplasm_id`,`germinate_template_4_25_01_14`.`germinatebase`.`name` AS `germplasm_name`,`germinate_template_4_25_01_14`.`germinatebase`.`display_name` AS `germplasm_display_name`,`germinate_template_4_25_01_14`.`pedigreenotations`.`name` AS `pedigree_notation_name`,`germinate_template_4_25_01_14`.`pedigreenotations`.`description` AS `pedigree_notation_description`,`germinate_template_4_25_01_14`.`pedigreenotations`.`reference_url` AS `pedigree_notation_url`,`germinate_template_4_25_01_14`.`datasets`.`id` AS `dataset_id`,`germinate_template_4_25_01_14`.`datasets`.`name` AS `dataset_name`,`germinate_template_4_25_01_14`.`pedigreedefinitions`.`id` AS `definition_id`,`germinate_template_4_25_01_14`.`pedigreedefinitions`.`definition` AS `definition`,`germinate_template_4_25_01_14`.`pedigreedescriptions`.`name` AS `pedigree_description_name`,`germinate_template_4_25_01_14`.`pedigreedescriptions`.`description` AS `pedigree_description_description`,`germinate_template_4_25_01_14`.`pedigreedescriptions`.`author` AS `pedigree_description_author`,`germinate_template_4_25_01_14`.`pedigreedefinitions`.`created_on` AS `created_on` from ((((`germinate_template_4_25_01_14`.`pedigreedefinitions` left join `germinate_template_4_25_01_14`.`germinatebase` on((`germinate_template_4_25_01_14`.`germinatebase`.`id` = `germinate_template_4_25_01_14`.`pedigreedefinitions`.`germinatebase_id`))) left join `germinate_template_4_25_01_14`.`pedigreenotations` on((`germinate_template_4_25_01_14`.`pedigreenotations`.`id` = `germinate_template_4_25_01_14`.`pedigreedefinitions`.`pedigreenotation_id`))) left join `germinate_template_4_25_01_14`.`pedigreedescriptions` on((`germinate_template_4_25_01_14`.`pedigreedescriptions`.`id` = `germinate_template_4_25_01_14`.`pedigreedefinitions`.`pedigreedescription_id`))) left join `germinate_template_4_25_01_14`.`datasets` on((`germinate_template_4_25_01_14`.`datasets`.`id` = `germinate_template_4_25_01_14`.`pedigreedefinitions`.`dataset_id`)))"));
    }
