...
public class ViewTablePedigreedefinitions extends TableImpl<ViewTablePedigreedefinitionsRecord> {
    ...
    private ViewTablePedigreedefinitions(Name alias, Table<ViewTablePedigreedefinitionsRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_pedigreedefinitions` as select `germinate_template_4_23_01_09`.`germinatebase`.`id` AS `germplasm_id`,`germinate_template_4_23_01_09`.`germinatebase`.`name` AS `germplasm_name`,`germinate_template_4_23_01_09`.`pedigreenotations`.`name` AS `pedigree_notation_name`,`germinate_template_4_23_01_09`.`pedigreenotations`.`description` AS `pedigree_notation_description`,`germinate_template_4_23_01_09`.`pedigreenotations`.`reference_url` AS `pedigree_notation_url`,`germinate_template_4_23_01_09`.`datasets`.`id` AS `dataset_id`,`germinate_template_4_23_01_09`.`datasets`.`name` AS `dataset_name`,`germinate_template_4_23_01_09`.`pedigreedefinitions`.`id` AS `definition_id`,`germinate_template_4_23_01_09`.`pedigreedefinitions`.`definition` AS `definition`,`germinate_template_4_23_01_09`.`pedigreedescriptions`.`name` AS `pedigree_description_name`,`germinate_template_4_23_01_09`.`pedigreedescriptions`.`description` AS `pedigree_description_description`,`germinate_template_4_23_01_09`.`pedigreedescriptions`.`author` AS `pedigree_description_author`,`germinate_template_4_23_01_09`.`pedigreedefinitions`.`created_on` AS `created_on` from ((((`germinate_template_4_23_01_09`.`pedigreedefinitions` left join `germinate_template_4_23_01_09`.`germinatebase` on((`germinate_template_4_23_01_09`.`germinatebase`.`id` = `germinate_template_4_23_01_09`.`pedigreedefinitions`.`germinatebase_id`))) left join `germinate_template_4_23_01_09`.`pedigreenotations` on((`germinate_template_4_23_01_09`.`pedigreenotations`.`id` = `germinate_template_4_23_01_09`.`pedigreedefinitions`.`pedigreenotation_id`))) left join `germinate_template_4_23_01_09`.`pedigreedescriptions` on((`germinate_template_4_23_01_09`.`pedigreedescriptions`.`id` = `germinate_template_4_23_01_09`.`pedigreedefinitions`.`pedigreedescription_id`))) left join `germinate_template_4_23_01_09`.`datasets` on((`germinate_template_4_23_01_09`.`datasets`.`id` = `germinate_template_4_23_01_09`.`pedigreedefinitions`.`dataset_id`)))"));
    }
