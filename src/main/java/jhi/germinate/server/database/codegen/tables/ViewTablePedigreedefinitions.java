...
public class ViewTablePedigreedefinitions extends TableImpl<ViewTablePedigreedefinitionsRecord> {
    ...
    private ViewTablePedigreedefinitions(Name alias, Table<ViewTablePedigreedefinitionsRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_pedigreedefinitions` as select `germinate_template_4_22_08_10`.`germinatebase`.`id` AS `germplasm_id`,`germinate_template_4_22_08_10`.`germinatebase`.`name` AS `germplasm_name`,`germinate_template_4_22_08_10`.`pedigreenotations`.`name` AS `pedigree_notation_name`,`germinate_template_4_22_08_10`.`pedigreenotations`.`description` AS `pedigree_notation_description`,`germinate_template_4_22_08_10`.`pedigreenotations`.`reference_url` AS `pedigree_notation_url`,`germinate_template_4_22_08_10`.`datasets`.`id` AS `dataset_id`,`germinate_template_4_22_08_10`.`datasets`.`name` AS `dataset_name`,`germinate_template_4_22_08_10`.`pedigreedefinitions`.`id` AS `definition_id`,`germinate_template_4_22_08_10`.`pedigreedefinitions`.`definition` AS `definition`,`germinate_template_4_22_08_10`.`pedigreedescriptions`.`name` AS `pedigree_description_name`,`germinate_template_4_22_08_10`.`pedigreedescriptions`.`description` AS `pedigree_description_description`,`germinate_template_4_22_08_10`.`pedigreedescriptions`.`author` AS `pedigree_description_author`,`germinate_template_4_22_08_10`.`pedigreedefinitions`.`created_on` AS `created_on` from ((((`germinate_template_4_22_08_10`.`pedigreedefinitions` left join `germinate_template_4_22_08_10`.`germinatebase` on((`germinate_template_4_22_08_10`.`germinatebase`.`id` = `germinate_template_4_22_08_10`.`pedigreedefinitions`.`germinatebase_id`))) left join `germinate_template_4_22_08_10`.`pedigreenotations` on((`germinate_template_4_22_08_10`.`pedigreenotations`.`id` = `germinate_template_4_22_08_10`.`pedigreedefinitions`.`pedigreenotation_id`))) left join `germinate_template_4_22_08_10`.`pedigreedescriptions` on((`germinate_template_4_22_08_10`.`pedigreedescriptions`.`id` = `germinate_template_4_22_08_10`.`pedigreedefinitions`.`pedigreedescription_id`))) left join `germinate_template_4_22_08_10`.`datasets` on((`germinate_template_4_22_08_10`.`datasets`.`id` = `germinate_template_4_22_08_10`.`pedigreedefinitions`.`dataset_id`)))"));
    }
