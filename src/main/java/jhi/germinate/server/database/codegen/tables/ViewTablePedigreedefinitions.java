...
public class ViewTablePedigreedefinitions extends TableImpl<ViewTablePedigreedefinitionsRecord> {
     ...
     */
    public final TableField<ViewTablePedigreedefinitionsRecord, Timestamp> CREATED_ON = createField(DSL.name("created_on"), SQLDataType.TIMESTAMP(0).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMP)), this, "When the record was created.");
    ...
    private ViewTablePedigreedefinitions(Name alias, Table<ViewTablePedigreedefinitionsRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.view("create view `view_table_pedigreedefinitions` as select `germinate_template_5_26_01_28`.`germinatebase`.`id` AS `germplasm_id`,`germinate_template_5_26_01_28`.`germinatebase`.`name` AS `germplasm_name`,`germinate_template_5_26_01_28`.`germinatebase`.`display_name` AS `germplasm_display_name`,`germinate_template_5_26_01_28`.`pedigreenotations`.`name` AS `pedigree_notation_name`,`germinate_template_5_26_01_28`.`pedigreenotations`.`description` AS `pedigree_notation_description`,`germinate_template_5_26_01_28`.`pedigreenotations`.`reference_url` AS `pedigree_notation_url`,`germinate_template_5_26_01_28`.`datasets`.`id` AS `dataset_id`,`germinate_template_5_26_01_28`.`datasets`.`name` AS `dataset_name`,`germinate_template_5_26_01_28`.`pedigreedefinitions`.`id` AS `definition_id`,`germinate_template_5_26_01_28`.`pedigreedefinitions`.`definition` AS `definition`,`germinate_template_5_26_01_28`.`pedigreedescriptions`.`name` AS `pedigree_description_name`,`germinate_template_5_26_01_28`.`pedigreedescriptions`.`description` AS `pedigree_description_description`,`germinate_template_5_26_01_28`.`pedigreedescriptions`.`author` AS `pedigree_description_author`,`germinate_template_5_26_01_28`.`pedigreedefinitions`.`created_on` AS `created_on` from ((((`germinate_template_5_26_01_28`.`pedigreedefinitions` left join `germinate_template_5_26_01_28`.`germinatebase` on((`germinate_template_5_26_01_28`.`germinatebase`.`id` = `germinate_template_5_26_01_28`.`pedigreedefinitions`.`germinatebase_id`))) left join `germinate_template_5_26_01_28`.`pedigreenotations` on((`germinate_template_5_26_01_28`.`pedigreenotations`.`id` = `germinate_template_5_26_01_28`.`pedigreedefinitions`.`pedigreenotation_id`))) left join `germinate_template_5_26_01_28`.`pedigreedescriptions` on((`germinate_template_5_26_01_28`.`pedigreedescriptions`.`id` = `germinate_template_5_26_01_28`.`pedigreedefinitions`.`pedigreedescription_id`))) left join `germinate_template_5_26_01_28`.`datasets` on((`germinate_template_5_26_01_28`.`datasets`.`id` = `germinate_template_5_26_01_28`.`pedigreedefinitions`.`dataset_id`)))"), where);
    }
    ...
    @Override
    public ViewTablePedigreedefinitions as(Table<?> alias) {
        return new ViewTablePedigreedefinitions(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public ViewTablePedigreedefinitions rename(Table<?> name) {
        return new ViewTablePedigreedefinitions(name.getQualifiedName(), null);
    }
     ...
     */
    @Override
    public ViewTablePedigreedefinitions where(Condition condition) {
        return new ViewTablePedigreedefinitions(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public ViewTablePedigreedefinitions where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public ViewTablePedigreedefinitions where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public ViewTablePedigreedefinitions where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public ViewTablePedigreedefinitions where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public ViewTablePedigreedefinitions where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public ViewTablePedigreedefinitions where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public ViewTablePedigreedefinitions where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public ViewTablePedigreedefinitions whereExists(Select<?> select) {
     ...
     */
    @Override
    public ViewTablePedigreedefinitions whereNotExists(Select<?> select) {
