...
public class ViewTablePedigreedefinitions extends TableImpl<ViewTablePedigreedefinitionsRecord> {
    ...
    private ViewTablePedigreedefinitions(Name alias, Table<ViewTablePedigreedefinitionsRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.view("create view `view_table_pedigreedefinitions` as select `germinate_template_5_26_08_13`.`germinatebase`.`id` AS `germplasm_id`,`germinate_template_5_26_08_13`.`germinatebase`.`name` AS `germplasm_name`,`germinate_template_5_26_08_13`.`germinatebase`.`display_name` AS `germplasm_display_name`,`germinate_template_5_26_08_13`.`pedigreenotations`.`name` AS `pedigree_notation_name`,`germinate_template_5_26_08_13`.`pedigreenotations`.`description` AS `pedigree_notation_description`,`germinate_template_5_26_08_13`.`pedigreenotations`.`reference_url` AS `pedigree_notation_url`,`germinate_template_5_26_08_13`.`datasets`.`id` AS `dataset_id`,`germinate_template_5_26_08_13`.`datasets`.`name` AS `dataset_name`,`germinate_template_5_26_08_13`.`pedigreedefinitions`.`id` AS `definition_id`,`germinate_template_5_26_08_13`.`pedigreedefinitions`.`definition` AS `definition`,`germinate_template_5_26_08_13`.`pedigreedescriptions`.`name` AS `pedigree_description_name`,`germinate_template_5_26_08_13`.`pedigreedescriptions`.`description` AS `pedigree_description_description`,`germinate_template_5_26_08_13`.`pedigreedescriptions`.`author` AS `pedigree_description_author`,`germinate_template_5_26_08_13`.`pedigreedefinitions`.`created_on` AS `created_on` from ((((`germinate_template_5_26_08_13`.`pedigreedefinitions` left join `germinate_template_5_26_08_13`.`germinatebase` on((`germinate_template_5_26_08_13`.`germinatebase`.`id` = `germinate_template_5_26_08_13`.`pedigreedefinitions`.`germinatebase_id`))) left join `germinate_template_5_26_08_13`.`pedigreenotations` on((`germinate_template_5_26_08_13`.`pedigreenotations`.`id` = `germinate_template_5_26_08_13`.`pedigreedefinitions`.`pedigreenotation_id`))) left join `germinate_template_5_26_08_13`.`pedigreedescriptions` on((`germinate_template_5_26_08_13`.`pedigreedescriptions`.`id` = `germinate_template_5_26_08_13`.`pedigreedefinitions`.`pedigreedescription_id`))) left join `germinate_template_5_26_08_13`.`datasets` on((`germinate_template_5_26_08_13`.`datasets`.`id` = `germinate_template_5_26_08_13`.`pedigreedefinitions`.`dataset_id`)))"), where);
    }
