...
public class GrouptypesRecord extends UpdatableRecordImpl<GrouptypesRecord> implements Record5<Integer, String, String, Timestamp, Timestamp> {
    ...
    private static final long serialVersionUID = 1858744861;
    ...
    /**
     * Setter for <code>germinate_db.grouptypes.created_on</code>. When the record was created.
     */
    ...
    /**
     * Getter for <code>germinate_db.grouptypes.created_on</code>. When the record was created.
     */
    ...
    /**
     * Setter for <code>germinate_db.grouptypes.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Getter for <code>germinate_db.grouptypes.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
