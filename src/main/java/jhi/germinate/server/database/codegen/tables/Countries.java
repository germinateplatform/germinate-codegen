...
public class Countries extends TableImpl<CountriesRecord> {
    ...
    private static final long serialVersionUID = -504991757;
    ...
    /**
     * The column <code>germinate_db.countries.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.countries.country_code2</code>. ISO 2 Code for country.
     */
    ...
    /**
     * The column <code>germinate_db.countries.country_code3</code>. ISO 3 Code for country.
     */
    ...
    /**
     * The column <code>germinate_db.countries.country_name</code>. Country name.
     */
    ...
    /**
     * The column <code>germinate_db.countries.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.countries.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    public Identity<CountriesRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Countries.COUNTRIES, jhi.germinate.server.database.codegen.tables.Countries.COUNTRIES.ID);
    }
    ...
    public UniqueKey<CountriesRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Countries.COUNTRIES, "KEY_countries_PRIMARY", jhi.germinate.server.database.codegen.tables.Countries.COUNTRIES.ID);
    }
    ...
    public List<UniqueKey<CountriesRecord>> getKeys() {
        return Arrays.<UniqueKey<CountriesRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Countries.COUNTRIES, "KEY_countries_PRIMARY", jhi.germinate.server.database.codegen.tables.Countries.COUNTRIES.ID)
        );
    }
