...
public class ViewTableFileresources extends TableImpl<ViewTableFileresourcesRecord> {
    ...
    private ViewTableFileresources(Name alias, Table<ViewTableFileresourcesRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.view("create view `view_table_fileresources` as select `germinate_template_5_26_01_28`.`fileresources`.`id` AS `fileresource_id`,`germinate_template_5_26_01_28`.`fileresources`.`name` AS `fileresource_name`,`germinate_template_5_26_01_28`.`fileresources`.`path` AS `fileresource_path`,`germinate_template_5_26_01_28`.`fileresources`.`description` AS `fileresource_description`,`germinate_template_5_26_01_28`.`fileresources`.`filesize` AS `fileresource_size`,`germinate_template_5_26_01_28`.`fileresources`.`created_on` AS `fileresource_created_on`,`germinate_template_5_26_01_28`.`fileresources`.`updated_on` AS `fileresource_updated_on`,`germinate_template_5_26_01_28`.`projects`.`id` AS `project_id`,`germinate_template_5_26_01_28`.`projects`.`name` AS `project_name`,`germinate_template_5_26_01_28`.`projects`.`description` AS `project_description`,`germinate_template_5_26_01_28`.`fileresourcetypes`.`id` AS `fileresourcetype_id`,`germinate_template_5_26_01_28`.`fileresourcetypes`.`name` AS `fileresourcetype_name`,`germinate_template_5_26_01_28`.`fileresourcetypes`.`description` AS `fileresourcetype_description`,(select json_arrayagg(`germinate_template_5_26_01_28`.`datasetfileresources`.`dataset_id`) from `germinate_template_5_26_01_28`.`datasetfileresources` where (`germinate_template_5_26_01_28`.`datasetfileresources`.`fileresource_id` = `germinate_template_5_26_01_28`.`fileresources`.`id`)) AS `dataset_ids` from (((`germinate_template_5_26_01_28`.`fileresources` left join `germinate_template_5_26_01_28`.`fileresourcetypes` on((`germinate_template_5_26_01_28`.`fileresources`.`fileresourcetype_id` = `germinate_template_5_26_01_28`.`fileresourcetypes`.`id`))) left join `germinate_template_5_26_01_28`.`datasetfileresources` on((`germinate_template_5_26_01_28`.`datasetfileresources`.`fileresource_id` = `germinate_template_5_26_01_28`.`fileresources`.`id`))) left join `germinate_template_5_26_01_28`.`projects` on((`germinate_template_5_26_01_28`.`projects`.`id` = `germinate_template_5_26_01_28`.`fileresources`.`project_id`))) group by `germinate_template_5_26_01_28`.`fileresources`.`id`"), where);
    }
