...
public class ViewTableFileresources extends TableImpl<ViewTableFileresourcesRecord> {
    ...
    private ViewTableFileresources(Name alias, Table<ViewTableFileresourcesRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_fileresources` as select `germinate_template_4_22_09_02`.`fileresources`.`id` AS `fileresource_id`,`germinate_template_4_22_09_02`.`fileresources`.`name` AS `fileresource_name`,`germinate_template_4_22_09_02`.`fileresources`.`path` AS `fileresource_path`,`germinate_template_4_22_09_02`.`fileresources`.`description` AS `fileresource_description`,`germinate_template_4_22_09_02`.`fileresources`.`filesize` AS `fileresource_size`,`germinate_template_4_22_09_02`.`fileresources`.`created_on` AS `fileresource_created_on`,`germinate_template_4_22_09_02`.`fileresources`.`updated_on` AS `fileresource_updated_on`,`germinate_template_4_22_09_02`.`fileresourcetypes`.`id` AS `fileresourcetype_id`,`germinate_template_4_22_09_02`.`fileresourcetypes`.`name` AS `fileresourcetype_name`,`germinate_template_4_22_09_02`.`fileresourcetypes`.`description` AS `fileresourcetype_description`,(select json_arrayagg(`germinate_template_4_22_09_02`.`datasetfileresources`.`dataset_id`) from `germinate_template_4_22_09_02`.`datasetfileresources` where (`germinate_template_4_22_09_02`.`datasetfileresources`.`fileresource_id` = `germinate_template_4_22_09_02`.`fileresources`.`id`)) AS `dataset_ids` from ((`germinate_template_4_22_09_02`.`fileresources` left join `germinate_template_4_22_09_02`.`fileresourcetypes` on((`germinate_template_4_22_09_02`.`fileresources`.`fileresourcetype_id` = `germinate_template_4_22_09_02`.`fileresourcetypes`.`id`))) left join `germinate_template_4_22_09_02`.`datasetfileresources` on((`germinate_template_4_22_09_02`.`datasetfileresources`.`fileresource_id` = `germinate_template_4_22_09_02`.`fileresources`.`id`))) group by `germinate_template_4_22_09_02`.`fileresources`.`id`"));
    }
