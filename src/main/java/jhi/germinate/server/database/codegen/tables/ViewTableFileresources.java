...
public class ViewTableFileresources extends TableImpl<ViewTableFileresourcesRecord> {
    ...
    private ViewTableFileresources(Name alias, Table<ViewTableFileresourcesRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_fileresources` as select `germinate_template_4_24_10_07`.`fileresources`.`id` AS `fileresource_id`,`germinate_template_4_24_10_07`.`fileresources`.`name` AS `fileresource_name`,`germinate_template_4_24_10_07`.`fileresources`.`path` AS `fileresource_path`,`germinate_template_4_24_10_07`.`fileresources`.`description` AS `fileresource_description`,`germinate_template_4_24_10_07`.`fileresources`.`filesize` AS `fileresource_size`,`germinate_template_4_24_10_07`.`fileresources`.`created_on` AS `fileresource_created_on`,`germinate_template_4_24_10_07`.`fileresources`.`updated_on` AS `fileresource_updated_on`,`germinate_template_4_24_10_07`.`projects`.`id` AS `project_id`,`germinate_template_4_24_10_07`.`projects`.`name` AS `project_name`,`germinate_template_4_24_10_07`.`projects`.`description` AS `project_description`,`germinate_template_4_24_10_07`.`fileresourcetypes`.`id` AS `fileresourcetype_id`,`germinate_template_4_24_10_07`.`fileresourcetypes`.`name` AS `fileresourcetype_name`,`germinate_template_4_24_10_07`.`fileresourcetypes`.`description` AS `fileresourcetype_description`,(select json_arrayagg(`germinate_template_4_24_10_07`.`datasetfileresources`.`dataset_id`) from `germinate_template_4_24_10_07`.`datasetfileresources` where (`germinate_template_4_24_10_07`.`datasetfileresources`.`fileresource_id` = `germinate_template_4_24_10_07`.`fileresources`.`id`)) AS `dataset_ids` from (((`germinate_template_4_24_10_07`.`fileresources` left join `germinate_template_4_24_10_07`.`fileresourcetypes` on((`germinate_template_4_24_10_07`.`fileresources`.`fileresourcetype_id` = `germinate_template_4_24_10_07`.`fileresourcetypes`.`id`))) left join `germinate_template_4_24_10_07`.`datasetfileresources` on((`germinate_template_4_24_10_07`.`datasetfileresources`.`fileresource_id` = `germinate_template_4_24_10_07`.`fileresources`.`id`))) left join `germinate_template_4_24_10_07`.`projects` on((`germinate_template_4_24_10_07`.`projects`.`id` = `germinate_template_4_24_10_07`.`fileresources`.`project_id`))) group by `germinate_template_4_24_10_07`.`fileresources`.`id`"));
    }
