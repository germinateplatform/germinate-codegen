...
public class ViewTableFileresources extends TableImpl<ViewTableFileresourcesRecord> {
    ...
    private ViewTableFileresources(Name alias, Table<ViewTableFileresourcesRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_fileresources` as select `germinate_template_4_24_02_09`.`fileresources`.`id` AS `fileresource_id`,`germinate_template_4_24_02_09`.`fileresources`.`name` AS `fileresource_name`,`germinate_template_4_24_02_09`.`fileresources`.`path` AS `fileresource_path`,`germinate_template_4_24_02_09`.`fileresources`.`description` AS `fileresource_description`,`germinate_template_4_24_02_09`.`fileresources`.`filesize` AS `fileresource_size`,`germinate_template_4_24_02_09`.`fileresources`.`created_on` AS `fileresource_created_on`,`germinate_template_4_24_02_09`.`fileresources`.`updated_on` AS `fileresource_updated_on`,`germinate_template_4_24_02_09`.`fileresourcetypes`.`id` AS `fileresourcetype_id`,`germinate_template_4_24_02_09`.`fileresourcetypes`.`name` AS `fileresourcetype_name`,`germinate_template_4_24_02_09`.`fileresourcetypes`.`description` AS `fileresourcetype_description`,(select json_arrayagg(`germinate_template_4_24_02_09`.`datasetfileresources`.`dataset_id`) from `germinate_template_4_24_02_09`.`datasetfileresources` where (`germinate_template_4_24_02_09`.`datasetfileresources`.`fileresource_id` = `germinate_template_4_24_02_09`.`fileresources`.`id`)) AS `dataset_ids` from ((`germinate_template_4_24_02_09`.`fileresources` left join `germinate_template_4_24_02_09`.`fileresourcetypes` on((`germinate_template_4_24_02_09`.`fileresources`.`fileresourcetype_id` = `germinate_template_4_24_02_09`.`fileresourcetypes`.`id`))) left join `germinate_template_4_24_02_09`.`datasetfileresources` on((`germinate_template_4_24_02_09`.`datasetfileresources`.`fileresource_id` = `germinate_template_4_24_02_09`.`fileresources`.`id`))) group by `germinate_template_4_24_02_09`.`fileresources`.`id`"));
    }
