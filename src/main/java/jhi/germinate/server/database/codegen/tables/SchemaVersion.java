...
import jhi.germinate.server.database.codegen.tables.records.SchemaVersionRecord;
...
public class SchemaVersion extends TableImpl<SchemaVersionRecord> {
    ...
    private static final long serialVersionUID = -989682942;

    /**
     * The reference instance of <code>germinate_db.schema_version</code>
     */
    ...
    /**
     * The column <code>germinate_db.schema_version.installed_rank</code>.
     */
    ...
    /**
     * The column <code>germinate_db.schema_version.type</code>.
     */
    ...
    /**
     * The column <code>germinate_db.schema_version.script</code>.
     */
    ...
    /**
     * The column <code>germinate_db.schema_version.installed_on</code>.
     */
    ...
    /**
     * The column <code>germinate_db.schema_version.execution_time</code>.
     */
    ...
    /**
     * The column <code>germinate_db.schema_version.success</code>.
     */
    ...
    /**
     * Create a <code>germinate_db.schema_version</code> table reference
     */
    ...
    /**
     * Create an aliased <code>germinate_db.schema_version</code> table reference
     */
    ...
    public UniqueKey<SchemaVersionRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.SchemaVersion.SCHEMA_VERSION, "KEY_schema_version_PRIMARY", jhi.germinate.server.database.codegen.tables.SchemaVersion.SCHEMA_VERSION.INSTALLED_RANK);
    }
    ...
    public List<UniqueKey<SchemaVersionRecord>> getKeys() {
        return Arrays.<UniqueKey<SchemaVersionRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.SchemaVersion.SCHEMA_VERSION, "KEY_schema_version_PRIMARY", jhi.germinate.server.database.codegen.tables.SchemaVersion.SCHEMA_VERSION.INSTALLED_RANK)
        );
    }
