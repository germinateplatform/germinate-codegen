...
public class Datasetaccesslogs extends TableImpl<DatasetaccesslogsRecord> {
     ...
     */
    public final TableField<DatasetaccesslogsRecord, Timestamp> CREATED_ON = createField(DSL.name("created_on"), SQLDataType.TIMESTAMP(0).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMP)), this, "When the record was created.");
     ...
     */
    public final TableField<DatasetaccesslogsRecord, Timestamp> UPDATED_ON = createField(DSL.name("updated_on"), SQLDataType.TIMESTAMP(0).nullable(false).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMP)), this, "When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.");

    private Datasetaccesslogs(Name alias, Table<DatasetaccesslogsRecord> aliased) {
        this(alias, aliased, (Field<?>[]) null, null);
    }

    private Datasetaccesslogs(Name alias, Table<DatasetaccesslogsRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment("If enabled, tracks which user accessed which datasets."), TableOptions.table(), where);
    }
    ...
    @Override
    public Datasetaccesslogs as(Table<?> alias) {
        return new Datasetaccesslogs(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public Datasetaccesslogs rename(Table<?> name) {
        return new Datasetaccesslogs(name.getQualifiedName(), null);
    }
     ...
     */
    @Override
    public Datasetaccesslogs where(Condition condition) {
        return new Datasetaccesslogs(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public Datasetaccesslogs where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public Datasetaccesslogs where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public Datasetaccesslogs where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public Datasetaccesslogs where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public Datasetaccesslogs where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public Datasetaccesslogs where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public Datasetaccesslogs where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public Datasetaccesslogs whereExists(Select<?> select) {
     ...
     */
    @Override
    public Datasetaccesslogs whereNotExists(Select<?> select) {
