...
public class Datasetaccesslogs extends TableImpl<DatasetaccesslogsRecord> {
    ...
    private static final long serialVersionUID = 1663769821;
    ...
    /**
     * The column <code>germinate_db.datasetaccesslogs.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.datasetaccesslogs.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.datasetaccesslogs.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Create an aliased <code>germinate_db.datasetaccesslogs</code> table reference
     */
    ...
    public Identity<DatasetaccesslogsRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Datasetaccesslogs.DATASETACCESSLOGS, jhi.germinate.server.database.codegen.tables.Datasetaccesslogs.DATASETACCESSLOGS.ID);
    }
    ...
    public UniqueKey<DatasetaccesslogsRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Datasetaccesslogs.DATASETACCESSLOGS, "KEY_datasetaccesslogs_PRIMARY", jhi.germinate.server.database.codegen.tables.Datasetaccesslogs.DATASETACCESSLOGS.ID);
    }
    ...
    public List<UniqueKey<DatasetaccesslogsRecord>> getKeys() {
        return Arrays.<UniqueKey<DatasetaccesslogsRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Datasetaccesslogs.DATASETACCESSLOGS, "KEY_datasetaccesslogs_PRIMARY", jhi.germinate.server.database.codegen.tables.Datasetaccesslogs.DATASETACCESSLOGS.ID)
        );
    }
