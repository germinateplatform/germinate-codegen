...
public class ViewTableInstitutions extends TableImpl<ViewTableInstitutionsRecord> {
    ...
    private ViewTableInstitutions(Name alias, Table<ViewTableInstitutionsRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.view("create view `view_table_institutions` as select `germinate_template_5_26_01_28`.`institutions`.`id` AS `institution_id`,`germinate_template_5_26_01_28`.`institutions`.`name` AS `institution_name`,`germinate_template_5_26_01_28`.`institutions`.`code` AS `institution_code`,`germinate_template_5_26_01_28`.`institutions`.`acronym` AS `institution_acronym`,`germinate_template_5_26_01_28`.`institutions`.`address` AS `institution_address`,`germinate_template_5_26_01_28`.`institutions`.`email` AS `institution_email`,`germinate_template_5_26_01_28`.`institutions`.`contact` AS `institution_contact`,`germinate_template_5_26_01_28`.`institutions`.`phone` AS `institution_phone`,`germinate_template_5_26_01_28`.`countries`.`id` AS `country_id`,`germinate_template_5_26_01_28`.`countries`.`country_name` AS `country_name`,`germinate_template_5_26_01_28`.`countries`.`country_code2` AS `country_code`,cast(NULL as char charset utf8mb4) AS `institution_type` from (`germinate_template_5_26_01_28`.`institutions` left join `germinate_template_5_26_01_28`.`countries` on((`germinate_template_5_26_01_28`.`countries`.`id` = `germinate_template_5_26_01_28`.`institutions`.`country_id`)))"), where);
    }
