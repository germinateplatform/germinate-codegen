...
public class ViewTableInstitutions extends TableImpl<ViewTableInstitutionsRecord> {
    ...
    private ViewTableInstitutions(Name alias, Table<ViewTableInstitutionsRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_institutions` as select `germinate_template_4_22_08_18`.`institutions`.`id` AS `institution_id`,`germinate_template_4_22_08_18`.`institutions`.`name` AS `institution_name`,`germinate_template_4_22_08_18`.`institutions`.`code` AS `institution_code`,`germinate_template_4_22_08_18`.`institutions`.`acronym` AS `institution_acronym`,`germinate_template_4_22_08_18`.`institutions`.`address` AS `institution_address`,`germinate_template_4_22_08_18`.`institutions`.`email` AS `institution_email`,`germinate_template_4_22_08_18`.`institutions`.`contact` AS `institution_contact`,`germinate_template_4_22_08_18`.`institutions`.`phone` AS `institution_phone`,`germinate_template_4_22_08_18`.`countries`.`id` AS `country_id`,`germinate_template_4_22_08_18`.`countries`.`country_name` AS `country_name`,`germinate_template_4_22_08_18`.`countries`.`country_code2` AS `country_code` from (`germinate_template_4_22_08_18`.`institutions` left join `germinate_template_4_22_08_18`.`countries` on((`germinate_template_4_22_08_18`.`countries`.`id` = `germinate_template_4_22_08_18`.`institutions`.`country_id`)))"));
    }
