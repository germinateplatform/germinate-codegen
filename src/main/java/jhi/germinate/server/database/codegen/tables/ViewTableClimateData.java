...
public class ViewTableClimateData extends TableImpl<ViewTableClimateDataRecord> {
    ...
    private ViewTableClimateData(Name alias, Table<ViewTableClimateDataRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_climate_data` as select `germinate_template_4_24_02_09`.`locations`.`id` AS `location_id`,`germinate_template_4_24_02_09`.`locations`.`site_name` AS `location_name`,`germinate_template_4_24_02_09`.`locations`.`region` AS `location_region`,`germinate_template_4_24_02_09`.`locations`.`state` AS `location_state`,`germinate_template_4_24_02_09`.`locationtypes`.`name` AS `location_type`,`germinate_template_4_24_02_09`.`locations`.`latitude` AS `location_latitude`,`germinate_template_4_24_02_09`.`locations`.`longitude` AS `location_longitude`,`germinate_template_4_24_02_09`.`locations`.`elevation` AS `location_elevation`,`germinate_template_4_24_02_09`.`countries`.`country_name` AS `country_name`,`germinate_template_4_24_02_09`.`countries`.`country_code2` AS `country_code2`,`germinate_template_4_24_02_09`.`countries`.`country_code3` AS `country_code3`,`germinate_template_4_24_02_09`.`datasets`.`id` AS `dataset_id`,`germinate_template_4_24_02_09`.`datasets`.`name` AS `dataset_name`,`germinate_template_4_24_02_09`.`datasets`.`description` AS `dataset_description`,`germinate_template_4_24_02_09`.`climates`.`id` AS `climate_id`,`germinate_template_4_24_02_09`.`climates`.`name` AS `climate_name`,`germinate_template_4_24_02_09`.`climates`.`short_name` AS `climate_name_short`,`germinate_template_4_24_02_09`.`units`.`unit_name` AS `unit_name`,`germinate_template_4_24_02_09`.`climatedata`.`recording_date` AS `recording_date`,`germinate_template_4_24_02_09`.`climatedata`.`climate_value` AS `climate_value` from ((((((`germinate_template_4_24_02_09`.`climatedata` left join `germinate_template_4_24_02_09`.`locations` on((`germinate_template_4_24_02_09`.`locations`.`id` = `germinate_template_4_24_02_09`.`climatedata`.`location_id`))) left join `germinate_template_4_24_02_09`.`locationtypes` on((`germinate_template_4_24_02_09`.`locations`.`locationtype_id` = `germinate_template_4_24_02_09`.`locationtypes`.`id`))) left join `germinate_template_4_24_02_09`.`climates` on((`germinate_template_4_24_02_09`.`climates`.`id` = `germinate_template_4_24_02_09`.`climatedata`.`climate_id`))) left join `germinate_template_4_24_02_09`.`units` on((`germinate_template_4_24_02_09`.`units`.`id` = `germinate_template_4_24_02_09`.`climates`.`unit_id`))) left join `germinate_template_4_24_02_09`.`datasets` on((`germinate_template_4_24_02_09`.`datasets`.`id` = `germinate_template_4_24_02_09`.`climatedata`.`dataset_id`))) left join `germinate_template_4_24_02_09`.`countries` on((`germinate_template_4_24_02_09`.`countries`.`id` = `germinate_template_4_24_02_09`.`locations`.`country_id`)))"));
    }
