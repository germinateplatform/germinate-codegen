...
public class ViewTableClimateData extends TableImpl<ViewTableClimateDataRecord> {
    ...
    private static final long serialVersionUID = -637445431;

    /**
     * The reference instance of <code>germinate_db.view_table_climate_data</code>
     */
    ...
    /**
     * The column <code>germinate_db.view_table_climate_data.location_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_climate_data.location_name</code>. The site name where the location is.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_climate_data.location_region</code>. The region where the location is if this exists.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_climate_data.location_state</code>. The state where the location is if this exists.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_climate_data.location_type</code>. The name of the location type. 
     */
    ...
    /**
     * The column <code>germinate_db.view_table_climate_data.location_latitude</code>. Latitude of the location.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_climate_data.location_longitude</code>. Longitude of the location.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_climate_data.location_elevation</code>. The elevation of the site in metres.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_climate_data.country_name</code>. Country name.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_climate_data.country_code2</code>. ISO 2 Code for country.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_climate_data.country_code3</code>. ISO 3 Code for country.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_climate_data.dataset_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_climate_data.dataset_name</code>. Describes the dataset.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_climate_data.dataset_description</code>. The name of this dataset.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_climate_data.climate_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_climate_data.climate_name</code>. Describes the climate.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_climate_data.climate_name_short</code>. Shortened version of the climate name which is used in some table headers.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_climate_data.unit_name</code>. The name of the unit. This should be the name of the unit in full.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_climate_data.recording_date</code>. The date at which this data point was recorded.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_climate_data.climate_value</code>. Value for the specific climate attribute. These are monthly averages and not daily. Monthly data is required for the current Germinate climate viisualizations and interface.
     */
    ...
    /**
     * Create a <code>germinate_db.view_table_climate_data</code> table reference
     */
    ...
    /**
     * Create an aliased <code>germinate_db.view_table_climate_data</code> table reference
     */
