...
public class ViewTableClimateData extends TableImpl<ViewTableClimateDataRecord> {
     ...
     */
    public final TableField<ViewTableClimateDataRecord, ViewTableClimateDataClimateDataType> CLIMATE_DATA_TYPE = createField(DSL.name("climate_data_type"), SQLDataType.VARCHAR(11).defaultValue(DSL.inline("text", SQLDataType.VARCHAR)).asEnumDataType(ViewTableClimateDataClimateDataType.class), this, "Defines the data type of the climate. This can be of numeric, text, date or categorical types.");
     ...
     */
    public final TableField<ViewTableClimateDataRecord, String> CLIMATE_VALUE = createField(DSL.name("climate_value"), SQLDataType.VARCHAR(255), this, "Value for the specific climate attribute. These are monthly averages and not daily. Monthly data is required for the current Germinate climate viisualizations and interface.");

    private ViewTableClimateData(Name alias, Table<ViewTableClimateDataRecord> aliased) {
        this(alias, aliased, (Field<?>[]) null, null);
    }

    private ViewTableClimateData(Name alias, Table<ViewTableClimateDataRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.view("create view `view_table_climate_data` as select `germinate_template_5_26_08_13`.`locations`.`id` AS `location_id`,`germinate_template_5_26_08_13`.`locations`.`site_name` AS `location_name`,`germinate_template_5_26_08_13`.`locations`.`region` AS `location_region`,`germinate_template_5_26_08_13`.`locations`.`state` AS `location_state`,`germinate_template_5_26_08_13`.`locationtypes`.`name` AS `location_type`,`germinate_template_5_26_08_13`.`locations`.`latitude` AS `location_latitude`,`germinate_template_5_26_08_13`.`locations`.`longitude` AS `location_longitude`,`germinate_template_5_26_08_13`.`locations`.`elevation` AS `location_elevation`,`germinate_template_5_26_08_13`.`countries`.`country_name` AS `country_name`,`germinate_template_5_26_08_13`.`countries`.`country_code2` AS `country_code2`,`germinate_template_5_26_08_13`.`countries`.`country_code3` AS `country_code3`,`germinate_template_5_26_08_13`.`datasets`.`id` AS `dataset_id`,`germinate_template_5_26_08_13`.`datasets`.`name` AS `dataset_name`,`germinate_template_5_26_08_13`.`datasets`.`description` AS `dataset_description`,`germinate_template_5_26_08_13`.`climates`.`id` AS `climate_id`,`germinate_template_5_26_08_13`.`climates`.`name` AS `climate_name`,`germinate_template_5_26_08_13`.`climates`.`short_name` AS `climate_name_short`,`germinate_template_5_26_08_13`.`climates`.`datatype` AS `climate_data_type`,`germinate_template_5_26_08_13`.`units`.`unit_name` AS `unit_name`,`germinate_template_5_26_08_13`.`climatedata`.`recording_date` AS `recording_date`,`germinate_template_5_26_08_13`.`climatedata`.`climate_value` AS `climate_value` from ((((((`germinate_template_5_26_08_13`.`climatedata` left join `germinate_template_5_26_08_13`.`locations` on((`germinate_template_5_26_08_13`.`locations`.`id` = `germinate_template_5_26_08_13`.`climatedata`.`location_id`))) left join `germinate_template_5_26_08_13`.`locationtypes` on((`germinate_template_5_26_08_13`.`locations`.`locationtype_id` = `germinate_template_5_26_08_13`.`locationtypes`.`id`))) left join `germinate_template_5_26_08_13`.`climates` on((`germinate_template_5_26_08_13`.`climates`.`id` = `germinate_template_5_26_08_13`.`climatedata`.`climate_id`))) left join `germinate_template_5_26_08_13`.`units` on((`germinate_template_5_26_08_13`.`units`.`id` = `germinate_template_5_26_08_13`.`climates`.`unit_id`))) left join `germinate_template_5_26_08_13`.`datasets` on((`germinate_template_5_26_08_13`.`datasets`.`id` = `germinate_template_5_26_08_13`.`climatedata`.`dataset_id`))) left join `germinate_template_5_26_08_13`.`countries` on((`germinate_template_5_26_08_13`.`countries`.`id` = `germinate_template_5_26_08_13`.`locations`.`country_id`)))"), where);
    }
    ...
    @Override
    public ViewTableClimateData as(Table<?> alias) {
        return new ViewTableClimateData(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public ViewTableClimateData rename(Table<?> name) {
        return new ViewTableClimateData(name.getQualifiedName(), null);
    }
     ...
     */
    @Override
    public ViewTableClimateData where(Condition condition) {
        return new ViewTableClimateData(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public ViewTableClimateData where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public ViewTableClimateData where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public ViewTableClimateData where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public ViewTableClimateData where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public ViewTableClimateData where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public ViewTableClimateData where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public ViewTableClimateData where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public ViewTableClimateData whereExists(Select<?> select) {
     ...
     */
    @Override
    public ViewTableClimateData whereNotExists(Select<?> select) {
