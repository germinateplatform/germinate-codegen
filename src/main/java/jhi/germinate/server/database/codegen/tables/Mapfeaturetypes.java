...
public class Mapfeaturetypes extends TableImpl<MapfeaturetypesRecord> {
    ...
    private static final long serialVersionUID = -1119497369;
    ...
    /**
     * The column <code>germinate_db.mapfeaturetypes.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.mapfeaturetypes.description</code>. Description of the feature type. This could include a definition of the marker type such as 'SNP', 'KASP' or 'AFLP'.
     */
    ...
    /**
     * The column <code>germinate_db.mapfeaturetypes.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.mapfeaturetypes.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Create an aliased <code>germinate_db.mapfeaturetypes</code> table reference
     */
    ...
    public Identity<MapfeaturetypesRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Mapfeaturetypes.MAPFEATURETYPES, jhi.germinate.server.database.codegen.tables.Mapfeaturetypes.MAPFEATURETYPES.ID);
    }
    ...
    public UniqueKey<MapfeaturetypesRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Mapfeaturetypes.MAPFEATURETYPES, "KEY_mapfeaturetypes_PRIMARY", jhi.germinate.server.database.codegen.tables.Mapfeaturetypes.MAPFEATURETYPES.ID);
    }
    ...
    public List<UniqueKey<MapfeaturetypesRecord>> getKeys() {
        return Arrays.<UniqueKey<MapfeaturetypesRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Mapfeaturetypes.MAPFEATURETYPES, "KEY_mapfeaturetypes_PRIMARY", jhi.germinate.server.database.codegen.tables.Mapfeaturetypes.MAPFEATURETYPES.ID)
        );
    }
