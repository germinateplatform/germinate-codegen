...
public class ViewTablePedigrees extends TableImpl<ViewTablePedigreesRecord> {
    ...
    /**
     * The column <code>germinate_db.view_table_pedigrees.parent_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_pedigrees.parent_gid</code>. A unique identifier.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_pedigrees.parent_name</code>. A unique name which defines an entry in the germinatbase table.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_pedigrees.child_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_pedigrees.child_gid</code>. A unique identifier.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_pedigrees.pedigree_description</code>. The name of the pedigree.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_pedigrees.pedigree_author</code>. Who is responsible for the creation of the pedigree. Attribution should be included in here for pedigree sources.
     */
    ...
    /**
     * Create an aliased <code>germinate_db.view_table_pedigrees</code> table reference
     */
