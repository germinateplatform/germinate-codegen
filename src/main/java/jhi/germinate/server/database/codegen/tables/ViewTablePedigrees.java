...
public class ViewTablePedigrees extends TableImpl<ViewTablePedigreesRecord> {
     ...
     */
    public final TableField<ViewTablePedigreesRecord, String> PARENT_DISPLAY_NAME = createField(DSL.name("parent_display_name"), SQLDataType.VARCHAR(255), this, "The name to be displayed on user interfaces and to be exported to external tools like Flapjack and Helium.");
     ...
     * tools like Flapjack and Helium.
     */
    public final TableField<ViewTablePedigreesRecord, String> CHILD_DISPLAY_NAME = createField(DSL.name("child_display_name"), SQLDataType.VARCHAR(255), this, "The name to be displayed on user interfaces and to be exported to external tools like Flapjack and Helium.");
    ...
    private ViewTablePedigrees(Name alias, Table<ViewTablePedigreesRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.view("create view `view_table_pedigrees` as select `parent`.`id` AS `parent_id`,`parent`.`general_identifier` AS `parent_gid`,`parent`.`name` AS `parent_name`,`parent`.`display_name` AS `parent_display_name`,`parent`.`number` AS `parent_number`,`child`.`id` AS `child_id`,`child`.`general_identifier` AS `child_gid`,`child`.`name` AS `child_name`,`child`.`display_name` AS `child_display_name`,`child`.`number` AS `child_number`,`germinate_template_5_26_01_28`.`datasets`.`id` AS `dataset_id`,`germinate_template_5_26_01_28`.`datasets`.`name` AS `dataset_name`,`germinate_template_5_26_01_28`.`experiments`.`id` AS `experiment_id`,`germinate_template_5_26_01_28`.`experiments`.`experiment_name` AS `experiment_name`,`germinate_template_5_26_01_28`.`pedigrees`.`relationship_type` AS `relationship_type`,`germinate_template_5_26_01_28`.`pedigrees`.`relationship_description` AS `relationship_description`,`germinate_template_5_26_01_28`.`pedigreedescriptions`.`name` AS `pedigree_description`,`germinate_template_5_26_01_28`.`pedigreedescriptions`.`author` AS `pedigree_author` from (((((`germinate_template_5_26_01_28`.`pedigrees` left join `germinate_template_5_26_01_28`.`germinatebase` `parent` on((`parent`.`id` = `germinate_template_5_26_01_28`.`pedigrees`.`parent_id`))) left join `germinate_template_5_26_01_28`.`germinatebase` `child` on((`child`.`id` = `germinate_template_5_26_01_28`.`pedigrees`.`germinatebase_id`))) left join `germinate_template_5_26_01_28`.`pedigreedescriptions` on((`germinate_template_5_26_01_28`.`pedigreedescriptions`.`id` = `germinate_template_5_26_01_28`.`pedigrees`.`pedigreedescription_id`))) left join `germinate_template_5_26_01_28`.`datasets` on((`germinate_template_5_26_01_28`.`datasets`.`id` = `germinate_template_5_26_01_28`.`pedigrees`.`dataset_id`))) left join `germinate_template_5_26_01_28`.`experiments` on((`germinate_template_5_26_01_28`.`experiments`.`id` = `germinate_template_5_26_01_28`.`datasets`.`experiment_id`)))"), where);
    }
    ...
    @Override
    public ViewTablePedigrees as(Table<?> alias) {
        return new ViewTablePedigrees(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public ViewTablePedigrees rename(Table<?> name) {
        return new ViewTablePedigrees(name.getQualifiedName(), null);
    }
     ...
     */
    @Override
    public ViewTablePedigrees where(Condition condition) {
        return new ViewTablePedigrees(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public ViewTablePedigrees where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public ViewTablePedigrees where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public ViewTablePedigrees where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public ViewTablePedigrees where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public ViewTablePedigrees where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public ViewTablePedigrees where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public ViewTablePedigrees where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public ViewTablePedigrees whereExists(Select<?> select) {
     ...
     */
    @Override
    public ViewTablePedigrees whereNotExists(Select<?> select) {
