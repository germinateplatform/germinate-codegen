...
public class Institutions extends TableImpl<InstitutionsRecord> {
    ...
    private static final long serialVersionUID = 1449199081;
    ...
    /**
     * The column <code>germinate_db.institutions.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.institutions.code</code>. If there is a defined ISO code for the institute this should be used here.
     */
    ...
    /**
     * The column <code>germinate_db.institutions.name</code>. The institute name.
     */
    ...
    /**
     * The column <code>germinate_db.institutions.acronym</code>. If there is an acronym for the institute.
     */
    ...
    /**
     * The column <code>germinate_db.institutions.country_id</code>. Foreign key to countries.id.
     */
    ...
    /**
     * The column <code>germinate_db.institutions.contact</code>. The contact at the institute which should be used for correspondence.
     */
    ...
    /**
     * The column <code>germinate_db.institutions.phone</code>. The telephone number for the institute.
     */
    ...
    /**
     * The column <code>germinate_db.institutions.email</code>. The email address to contact the institute.
     */
    ...
    /**
     * The column <code>germinate_db.institutions.address</code>. The postal address of the institute.
     */
    ...
    /**
     * The column <code>germinate_db.institutions.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.institutions.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    public Identity<InstitutionsRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Institutions.INSTITUTIONS, jhi.germinate.server.database.codegen.tables.Institutions.INSTITUTIONS.ID);
    }
    ...
    public UniqueKey<InstitutionsRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Institutions.INSTITUTIONS, "KEY_institutions_PRIMARY", jhi.germinate.server.database.codegen.tables.Institutions.INSTITUTIONS.ID);
    }
    ...
    public List<UniqueKey<InstitutionsRecord>> getKeys() {
        return Arrays.<UniqueKey<InstitutionsRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Institutions.INSTITUTIONS, "KEY_institutions_PRIMARY", jhi.germinate.server.database.codegen.tables.Institutions.INSTITUTIONS.ID)
        );
    }
