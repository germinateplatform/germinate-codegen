...
public class Datasetstates extends TableImpl<DatasetstatesRecord> {
    ...
    private static final long serialVersionUID = 1577439194;
    ...
    /**
     * The column <code>germinate_db.datasetstates.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.datasetstates.name</code>. Defines the datasetstate.
     */
    ...
    /**
     * The column <code>germinate_db.datasetstates.description</code>. Describes the datasetstate.
     */
    ...
    /**
     * The column <code>germinate_db.datasetstates.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.datasetstates.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    public Identity<DatasetstatesRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Datasetstates.DATASETSTATES, jhi.germinate.server.database.codegen.tables.Datasetstates.DATASETSTATES.ID);
    }
    ...
    public UniqueKey<DatasetstatesRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Datasetstates.DATASETSTATES, "KEY_datasetstates_PRIMARY", jhi.germinate.server.database.codegen.tables.Datasetstates.DATASETSTATES.ID);
    }
    ...
    public List<UniqueKey<DatasetstatesRecord>> getKeys() {
        return Arrays.<UniqueKey<DatasetstatesRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Datasetstates.DATASETSTATES, "KEY_datasetstates_PRIMARY", jhi.germinate.server.database.codegen.tables.Datasetstates.DATASETSTATES.ID)
        );
    }
