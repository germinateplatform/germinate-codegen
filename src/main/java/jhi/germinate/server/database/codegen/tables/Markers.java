...
public class Markers extends TableImpl<MarkersRecord> {
     ...
     */
    public final TableField<MarkersRecord, Timestamp> CREATED_ON = createField(DSL.name("created_on"), SQLDataType.TIMESTAMP(0).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.TIMESTAMP)), this, "When the record was created.\n");
    ...
    private Markers(Name alias, Table<MarkersRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment("Defines genetic markers within the database and assigns a type (markertypes)."), TableOptions.table(), where);
    }
    ...
    @Override
    public Markers as(Table<?> alias) {
        return new Markers(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public Markers rename(Table<?> name) {
        return new Markers(name.getQualifiedName(), null);
    }
     ...
     */
    @Override
    public Markers where(Condition condition) {
        return new Markers(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public Markers where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public Markers where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public Markers where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public Markers where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public Markers where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public Markers where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public Markers where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public Markers whereExists(Select<?> select) {
     ...
     */
    @Override
    public Markers whereNotExists(Select<?> select) {
