...
public class Markers extends TableImpl<MarkersRecord> {
    ...
    private static final long serialVersionUID = 799957037;
    ...
    /**
     * The column <code>germinate_db.markers.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.markers.markertype_id</code>. Foreign key to locations (locations.id).
     */
    ...
    /**
     * The column <code>germinate_db.markers.marker_name</code>. The name of the marker. This should be a unique name which identifies the marker.
     */
    ...
    /**
     * The column <code>germinate_db.markers.created_on</code>. When the record was created.
    ...
    /**
     * The column <code>germinate_db.markers.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    public Identity<MarkersRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Markers.MARKERS, jhi.germinate.server.database.codegen.tables.Markers.MARKERS.ID);
    }
    ...
    public UniqueKey<MarkersRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Markers.MARKERS, "KEY_markers_PRIMARY", jhi.germinate.server.database.codegen.tables.Markers.MARKERS.ID);
    }
    ...
    public List<UniqueKey<MarkersRecord>> getKeys() {
        return Arrays.<UniqueKey<MarkersRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Markers.MARKERS, "KEY_markers_PRIMARY", jhi.germinate.server.database.codegen.tables.Markers.MARKERS.ID)
        );
    }
