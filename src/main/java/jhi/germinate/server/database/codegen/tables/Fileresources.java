...
public class Fileresources extends TableImpl<FileresourcesRecord> {
    ...
    private static final long serialVersionUID = -912603292;
    ...
    /**
     * The column <code>germinate_db.fileresources.name</code>. The name of the file resource.
     */
    ...
    /**
     * The column <code>germinate_db.fileresources.path</code>. The file name of the actual data file.
     */
    ...
    /**
     * The column <code>germinate_db.fileresources.description</code>. A description of the file contents.
     */
    ...
    /**
     * The column <code>germinate_db.fileresources.filesize</code>. The file size in bytes.
     */
    ...
    /**
     * The column <code>germinate_db.fileresources.fileresourcetype_id</code>. Foreign key to fileresourcetypes.
     */
    ...
    /**
     * The column <code>germinate_db.fileresources.created_on</code>. When this record was created.
     */
    ...
    /**
     * The column <code>germinate_db.fileresources.updated_on</code>. When this record was last updated.
     */
    ...
    public Identity<FileresourcesRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Fileresources.FILERESOURCES, jhi.germinate.server.database.codegen.tables.Fileresources.FILERESOURCES.ID);
    }
    ...
    public UniqueKey<FileresourcesRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Fileresources.FILERESOURCES, "KEY_fileresources_PRIMARY", jhi.germinate.server.database.codegen.tables.Fileresources.FILERESOURCES.ID);
    }
    ...
    public List<UniqueKey<FileresourcesRecord>> getKeys() {
        return Arrays.<UniqueKey<FileresourcesRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Fileresources.FILERESOURCES, "KEY_fileresources_PRIMARY", jhi.germinate.server.database.codegen.tables.Fileresources.FILERESOURCES.ID)
        );
    }
