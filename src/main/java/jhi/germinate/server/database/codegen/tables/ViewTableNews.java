...
public class ViewTableNews extends TableImpl<ViewTableNewsRecord> {
    ...
    private static final long serialVersionUID = 481701356;
    ...
    /**
     * The column <code>germinate_db.view_table_news.news_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_news.news_title</code>. A title which is used to name this news item. This appears in the Germinate user interface if used.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_news.news_content</code>. The textual content of this news item.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_news.news_hyperlink</code>. HTML hyperlink to use for this news item. This can be a link to another source which contains more information or a link to the original source.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_news.news_image</code>. Image to use with this news item.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_news.newstype_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_news.newstype_name</code>. Name of the news type.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_news.newstype_description</code>. A longer description of the news type.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_news.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_news.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Create an aliased <code>germinate_db.view_table_news</code> table reference
     */
