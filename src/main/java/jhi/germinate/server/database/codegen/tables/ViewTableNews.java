...
public class ViewTableNews extends TableImpl<ViewTableNewsRecord> {
    ...
    private ViewTableNews(Name alias, Table<ViewTableNewsRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_news` as select `germinate_template_4_22_08_24`.`news`.`id` AS `news_id`,`germinate_template_4_22_08_24`.`news`.`title` AS `news_title`,`germinate_template_4_22_08_24`.`news`.`content` AS `news_content`,`germinate_template_4_22_08_24`.`news`.`hyperlink` AS `news_hyperlink`,`germinate_template_4_22_08_24`.`news`.`image` AS `news_image`,`germinate_template_4_22_08_24`.`newstypes`.`id` AS `newstype_id`,`germinate_template_4_22_08_24`.`newstypes`.`name` AS `newstype_name`,`germinate_template_4_22_08_24`.`newstypes`.`description` AS `newstype_description`,`germinate_template_4_22_08_24`.`news`.`created_on` AS `created_on`,`germinate_template_4_22_08_24`.`news`.`updated_on` AS `updated_on` from (`germinate_template_4_22_08_24`.`news` left join `germinate_template_4_22_08_24`.`newstypes` on((`germinate_template_4_22_08_24`.`newstypes`.`id` = `germinate_template_4_22_08_24`.`news`.`newstype_id`))) order by `germinate_template_4_22_08_24`.`news`.`created_on` desc"));
    }
