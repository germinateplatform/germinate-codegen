...
public class ViewTableNews extends TableImpl<ViewTableNewsRecord> {
    ...
    private ViewTableNews(Name alias, Table<ViewTableNewsRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.view("create view `view_table_news` as select `germinate_template_5_26_01_28`.`news`.`id` AS `news_id`,`germinate_template_5_26_01_28`.`news`.`title` AS `news_title`,`germinate_template_5_26_01_28`.`news`.`content` AS `news_content`,`germinate_template_5_26_01_28`.`news`.`hyperlink` AS `news_hyperlink`,`germinate_template_5_26_01_28`.`news`.`image` AS `news_image`,`germinate_template_5_26_01_28`.`news`.`image_fit` AS `news_image_fit`,`germinate_template_5_26_01_28`.`newstypes`.`id` AS `newstype_id`,`germinate_template_5_26_01_28`.`newstypes`.`name` AS `newstype_name`,`germinate_template_5_26_01_28`.`newstypes`.`description` AS `newstype_description`,`germinate_template_5_26_01_28`.`news`.`created_on` AS `created_on`,`germinate_template_5_26_01_28`.`news`.`updated_on` AS `updated_on` from (`germinate_template_5_26_01_28`.`news` left join `germinate_template_5_26_01_28`.`newstypes` on((`germinate_template_5_26_01_28`.`newstypes`.`id` = `germinate_template_5_26_01_28`.`news`.`newstype_id`))) order by `germinate_template_5_26_01_28`.`news`.`created_on` desc"), where);
    }
