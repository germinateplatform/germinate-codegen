...
public class Links extends TableImpl<LinksRecord> {
    ...
    private static final long serialVersionUID = -563768238;
    ...
    /**
     * The column <code>germinate_db.links.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.links.linktype_id</code>. Foreign key to linktypes (linktypes.id).
     */
    ...
    /**
     * The column <code>germinate_db.links.hyperlink</code>. The actual hyperlink.
     */
    ...
    /**
     * The column <code>germinate_db.links.description</code>. A description of the link.
     */
    ...
    /**
     * The column <code>germinate_db.links.visibility</code>. Determines if the link is visible or not: {0, 1}
     */
    ...
    /**
     * The column <code>germinate_db.links.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.links.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    public Identity<LinksRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Links.LINKS, jhi.germinate.server.database.codegen.tables.Links.LINKS.ID);
    }
    ...
    public UniqueKey<LinksRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Links.LINKS, "KEY_links_PRIMARY", jhi.germinate.server.database.codegen.tables.Links.LINKS.ID);
    }
    ...
    public List<UniqueKey<LinksRecord>> getKeys() {
        return Arrays.<UniqueKey<LinksRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Links.LINKS, "KEY_links_PRIMARY", jhi.germinate.server.database.codegen.tables.Links.LINKS.ID)
        );
    }
