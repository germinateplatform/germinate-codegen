...
public class NewstypesRecord extends UpdatableRecordImpl<NewstypesRecord> implements Record5<Integer, String, String, Timestamp, Timestamp> {
    ...
    private static final long serialVersionUID = 134292799;

    /**
     * Setter for <code>germinate_db.newstypes.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Getter for <code>germinate_db.newstypes.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Setter for <code>germinate_db.newstypes.name</code>. Name of the news type.
     */
    ...
    /**
     * Getter for <code>germinate_db.newstypes.name</code>. Name of the news type.
     */
    ...
    /**
     * Setter for <code>germinate_db.newstypes.description</code>. A longer description of the news type.
     */
    ...
    /**
     * Getter for <code>germinate_db.newstypes.description</code>. A longer description of the news type.
     */
    ...
    /**
     * Setter for <code>germinate_db.newstypes.created_on</code>. When the record was created.
     */
    ...
    /**
     * Getter for <code>germinate_db.newstypes.created_on</code>. When the record was created.
     */
    ...
    /**
     * Setter for <code>germinate_db.newstypes.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Getter for <code>germinate_db.newstypes.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
