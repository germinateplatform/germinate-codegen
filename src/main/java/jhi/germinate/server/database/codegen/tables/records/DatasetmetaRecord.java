...
public class DatasetmetaRecord extends UpdatableRecordImpl<DatasetmetaRecord> implements Record6<Integer, Integer, ULong, ULong, Timestamp, Timestamp> {
    ...
    private static final long serialVersionUID = -2105076678;

    /**
     * Setter for <code>germinate_db.datasetmeta.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Getter for <code>germinate_db.datasetmeta.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Setter for <code>germinate_db.datasetmeta.dataset_id</code>. Foreign key to [datasets] ([datasets].id).
     */
    ...
    /**
     * Getter for <code>germinate_db.datasetmeta.dataset_id</code>. Foreign key to [datasets] ([datasets].id).
     */
    ...
    /**
     * Setter for <code>germinate_db.datasetmeta.nr_of_data_objects</code>. The number of data objects contained in this dataset.
     */
    ...
    /**
     * Getter for <code>germinate_db.datasetmeta.nr_of_data_objects</code>. The number of data objects contained in this dataset.
     */
    ...
    /**
     * Setter for <code>germinate_db.datasetmeta.nr_of_data_points</code>. The number of individual data points contained in this dataset.
     */
    ...
    /**
     * Getter for <code>germinate_db.datasetmeta.nr_of_data_points</code>. The number of individual data points contained in this dataset.
     */
    ...
    /**
     * Setter for <code>germinate_db.datasetmeta.created_on</code>. When the record was created.
     */
    ...
    /**
     * Getter for <code>germinate_db.datasetmeta.created_on</code>. When the record was created.
     */
    ...
    /**
     * Setter for <code>germinate_db.datasetmeta.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Getter for <code>germinate_db.datasetmeta.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
