...
public class ViewTableDatasets extends TableImpl<ViewTableDatasetsRecord> {
    ...
    private ViewTableDatasets(Name alias, Table<ViewTableDatasetsRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_datasets` as select `germinate_template_4_22_05_04`.`datasets`.`id` AS `dataset_id`,`germinate_template_4_22_05_04`.`datasets`.`name` AS `dataset_name`,`germinate_template_4_22_05_04`.`datasets`.`description` AS `dataset_description`,`germinate_template_4_22_05_04`.`datasets`.`hyperlink` AS `hyperlink`,`germinate_template_4_22_05_04`.`datasets`.`source_file` AS `source_file`,`germinate_template_4_22_05_04`.`datasets`.`version` AS `version`,`germinate_template_4_22_05_04`.`datasettypes`.`description` AS `dataset_type`,`germinate_template_4_22_05_04`.`experiments`.`id` AS `experiment_id`,`germinate_template_4_22_05_04`.`experiments`.`experiment_name` AS `experiment_name`,`germinate_template_4_22_05_04`.`experiments`.`description` AS `experiment_description`,`germinate_template_4_22_05_04`.`datasets`.`datatype` AS `datatype`,`germinate_template_4_22_05_04`.`datasetstates`.`name` AS `dataset_state`,(select json_arrayagg(json_object('locationId',`germinate_template_4_22_05_04`.`locations`.`id`,'locationName',`germinate_template_4_22_05_04`.`locations`.`site_name`,'locationLatitude',`germinate_template_4_22_05_04`.`locations`.`latitude`,'locationLongitude',`germinate_template_4_22_05_04`.`locations`.`longitude`,'countryId',`germinate_template_4_22_05_04`.`countries`.`id`,'countryName',`germinate_template_4_22_05_04`.`countries`.`country_code2`)) from ((`germinate_template_4_22_05_04`.`datasetlocations` left join `germinate_template_4_22_05_04`.`locations` on((`germinate_template_4_22_05_04`.`locations`.`id` = `germinate_template_4_22_05_04`.`datasetlocations`.`location_id`))) left join `germinate_template_4_22_05_04`.`countries` on((`germinate_template_4_22_05_04`.`countries`.`id` = `germinate_template_4_22_05_04`.`locations`.`country_id`))) where ((`germinate_template_4_22_05_04`.`datasetlocations`.`dataset_id` = `germinate_template_4_22_05_04`.`datasets`.`id`) and (`germinate_template_4_22_05_04`.`locations`.`id` is not null)) group by `germinate_template_4_22_05_04`.`datasets`.`id`) AS `locations`,`germinate_template_4_22_05_04`.`licenses`.`id` AS `license_id`,`germinate_template_4_22_05_04`.`licenses`.`name` AS `license_name`,`germinate_template_4_22_05_04`.`datasets`.`contact` AS `contact`,`germinate_template_4_22_05_04`.`datasets`.`date_start` AS `start_date`,`germinate_template_4_22_05_04`.`datasets`.`date_end` AS `end_date`,`germinate_template_4_22_05_04`.`datasets`.`dublin_core` AS `dublin_core`,`germinate_template_4_22_05_04`.`datasets`.`created_on` AS `created_on`,`germinate_template_4_22_05_04`.`datasets`.`updated_on` AS `updated_on`,`germinate_template_4_22_05_04`.`datasetmeta`.`nr_of_data_objects` AS `data_object_count`,`germinate_template_4_22_05_04`.`datasetmeta`.`nr_of_data_points` AS `data_point_count`,`germinate_template_4_22_05_04`.`datasets`.`is_external` AS `is_external`,(select count(1) from `germinate_template_4_22_05_04`.`publicationdata` where ((`germinate_template_4_22_05_04`.`publicationdata`.`foreign_id` = `germinate_template_4_22_05_04`.`datasets`.`id`) and (`germinate_template_4_22_05_04`.`publicationdata`.`reference_type` = 'dataset'))) AS `publications`,(select count(1) from (`germinate_template_4_22_05_04`.`collaborators` left join `germinate_template_4_22_05_04`.`datasetcollaborators` on((`germinate_template_4_22_05_04`.`collaborators`.`id` = `germinate_template_4_22_05_04`.`datasetcollaborators`.`collaborator_id`))) where (`germinate_template_4_22_05_04`.`datasetcollaborators`.`dataset_id` = `germinate_template_4_22_05_04`.`datasets`.`id`)) AS `collaborators`,(select count(1) from (`germinate_template_4_22_05_04`.`attributes` left join `germinate_template_4_22_05_04`.`attributedata` on((`germinate_template_4_22_05_04`.`attributedata`.`attribute_id` = `germinate_template_4_22_05_04`.`attributes`.`id`))) where ((`germinate_template_4_22_05_04`.`attributes`.`target_table` = 'datasets') and (`germinate_template_4_22_05_04`.`attributedata`.`foreign_id` = `germinate_template_4_22_05_04`.`datasets`.`id`))) AS `attributes`,json_arrayagg(`germinate_template_4_22_05_04`.`licenselogs`.`user_id`) AS `accepted_by` from ((((((`germinate_template_4_22_05_04`.`datasets` left join `germinate_template_4_22_05_04`.`experiments` on((`germinate_template_4_22_05_04`.`experiments`.`id` = `germinate_template_4_22_05_04`.`datasets`.`experiment_id`))) left join `germinate_template_4_22_05_04`.`datasettypes` on((`germinate_template_4_22_05_04`.`datasettypes`.`id` = `germinate_template_4_22_05_04`.`datasets`.`datasettype_id`))) left join `germinate_template_4_22_05_04`.`licenses` on((`germinate_template_4_22_05_04`.`licenses`.`id` = `germinate_template_4_22_05_04`.`datasets`.`license_id`))) left join `germinate_template_4_22_05_04`.`datasetmeta` on((`germinate_template_4_22_05_04`.`datasetmeta`.`dataset_id` = `germinate_template_4_22_05_04`.`datasets`.`id`))) left join `germinate_template_4_22_05_04`.`datasetstates` on((`germinate_template_4_22_05_04`.`datasetstates`.`id` = `germinate_template_4_22_05_04`.`datasets`.`dataset_state_id`))) left join `germinate_template_4_22_05_04`.`licenselogs` on((`germinate_template_4_22_05_04`.`licenselogs`.`license_id` = `germinate_template_4_22_05_04`.`licenses`.`id`))) group by `germinate_template_4_22_05_04`.`datasets`.`id`,`germinate_template_4_22_05_04`.`datasetmeta`.`id`"));
    }
