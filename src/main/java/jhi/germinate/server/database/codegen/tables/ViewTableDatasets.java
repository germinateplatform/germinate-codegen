...
public class ViewTableDatasets extends TableImpl<ViewTableDatasetsRecord> {
    ...
    private ViewTableDatasets(Name alias, Table<ViewTableDatasetsRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_datasets` as select `germinate_template_4_22_08_10`.`datasets`.`id` AS `dataset_id`,`germinate_template_4_22_08_10`.`datasets`.`name` AS `dataset_name`,`germinate_template_4_22_08_10`.`datasets`.`description` AS `dataset_description`,`germinate_template_4_22_08_10`.`datasets`.`hyperlink` AS `hyperlink`,`germinate_template_4_22_08_10`.`datasets`.`source_file` AS `source_file`,`germinate_template_4_22_08_10`.`datasets`.`version` AS `version`,`germinate_template_4_22_08_10`.`datasettypes`.`description` AS `dataset_type`,`germinate_template_4_22_08_10`.`experiments`.`id` AS `experiment_id`,`germinate_template_4_22_08_10`.`experiments`.`experiment_name` AS `experiment_name`,`germinate_template_4_22_08_10`.`experiments`.`description` AS `experiment_description`,`germinate_template_4_22_08_10`.`datasets`.`datatype` AS `datatype`,`germinate_template_4_22_08_10`.`datasetstates`.`name` AS `dataset_state`,(select json_arrayagg(json_object('locationId',`germinate_template_4_22_08_10`.`locations`.`id`,'locationName',`germinate_template_4_22_08_10`.`locations`.`site_name`,'locationLatitude',`germinate_template_4_22_08_10`.`locations`.`latitude`,'locationLongitude',`germinate_template_4_22_08_10`.`locations`.`longitude`,'countryId',`germinate_template_4_22_08_10`.`countries`.`id`,'countryName',`germinate_template_4_22_08_10`.`countries`.`country_code2`)) from ((`germinate_template_4_22_08_10`.`datasetlocations` left join `germinate_template_4_22_08_10`.`locations` on((`germinate_template_4_22_08_10`.`locations`.`id` = `germinate_template_4_22_08_10`.`datasetlocations`.`location_id`))) left join `germinate_template_4_22_08_10`.`countries` on((`germinate_template_4_22_08_10`.`countries`.`id` = `germinate_template_4_22_08_10`.`locations`.`country_id`))) where ((`germinate_template_4_22_08_10`.`datasetlocations`.`dataset_id` = `germinate_template_4_22_08_10`.`datasets`.`id`) and (`germinate_template_4_22_08_10`.`locations`.`id` is not null)) group by `germinate_template_4_22_08_10`.`datasets`.`id`) AS `locations`,`germinate_template_4_22_08_10`.`licenses`.`id` AS `license_id`,`germinate_template_4_22_08_10`.`licenses`.`name` AS `license_name`,`germinate_template_4_22_08_10`.`datasets`.`contact` AS `contact`,`germinate_template_4_22_08_10`.`datasets`.`date_start` AS `start_date`,`germinate_template_4_22_08_10`.`datasets`.`date_end` AS `end_date`,`germinate_template_4_22_08_10`.`datasets`.`dublin_core` AS `dublin_core`,`germinate_template_4_22_08_10`.`datasets`.`created_on` AS `created_on`,`germinate_template_4_22_08_10`.`datasets`.`updated_on` AS `updated_on`,`germinate_template_4_22_08_10`.`datasetmeta`.`nr_of_data_objects` AS `data_object_count`,`germinate_template_4_22_08_10`.`datasetmeta`.`nr_of_data_points` AS `data_point_count`,`germinate_template_4_22_08_10`.`datasets`.`is_external` AS `is_external`,(select count(1) from `germinate_template_4_22_08_10`.`publicationdata` where ((`germinate_template_4_22_08_10`.`publicationdata`.`foreign_id` = `germinate_template_4_22_08_10`.`datasets`.`id`) and (`germinate_template_4_22_08_10`.`publicationdata`.`reference_type` = 'dataset'))) AS `publications`,(select json_arrayagg(`germinate_template_4_22_08_10`.`datasetfileresources`.`fileresource_id`) from `germinate_template_4_22_08_10`.`datasetfileresources` where (`germinate_template_4_22_08_10`.`datasetfileresources`.`dataset_id` = `germinate_template_4_22_08_10`.`datasets`.`id`)) AS `fileresource_ids`,(select count(1) from (`germinate_template_4_22_08_10`.`collaborators` left join `germinate_template_4_22_08_10`.`datasetcollaborators` on((`germinate_template_4_22_08_10`.`collaborators`.`id` = `germinate_template_4_22_08_10`.`datasetcollaborators`.`collaborator_id`))) where (`germinate_template_4_22_08_10`.`datasetcollaborators`.`dataset_id` = `germinate_template_4_22_08_10`.`datasets`.`id`)) AS `collaborators`,(select count(1) from (`germinate_template_4_22_08_10`.`attributes` left join `germinate_template_4_22_08_10`.`attributedata` on((`germinate_template_4_22_08_10`.`attributedata`.`attribute_id` = `germinate_template_4_22_08_10`.`attributes`.`id`))) where ((`germinate_template_4_22_08_10`.`attributes`.`target_table` = 'datasets') and (`germinate_template_4_22_08_10`.`attributedata`.`foreign_id` = `germinate_template_4_22_08_10`.`datasets`.`id`))) AS `attributes`,json_arrayagg(`germinate_template_4_22_08_10`.`licenselogs`.`user_id`) AS `accepted_by` from (((((((`germinate_template_4_22_08_10`.`datasets` left join `germinate_template_4_22_08_10`.`experiments` on((`germinate_template_4_22_08_10`.`experiments`.`id` = `germinate_template_4_22_08_10`.`datasets`.`experiment_id`))) left join `germinate_template_4_22_08_10`.`datasettypes` on((`germinate_template_4_22_08_10`.`datasettypes`.`id` = `germinate_template_4_22_08_10`.`datasets`.`datasettype_id`))) left join `germinate_template_4_22_08_10`.`licenses` on((`germinate_template_4_22_08_10`.`licenses`.`id` = `germinate_template_4_22_08_10`.`datasets`.`license_id`))) left join `germinate_template_4_22_08_10`.`datasetmeta` on((`germinate_template_4_22_08_10`.`datasetmeta`.`dataset_id` = `germinate_template_4_22_08_10`.`datasets`.`id`))) left join `germinate_template_4_22_08_10`.`datasetstates` on((`germinate_template_4_22_08_10`.`datasetstates`.`id` = `germinate_template_4_22_08_10`.`datasets`.`dataset_state_id`))) left join `germinate_template_4_22_08_10`.`licenselogs` on((`germinate_template_4_22_08_10`.`licenselogs`.`license_id` = `germinate_template_4_22_08_10`.`licenses`.`id`))) left join `germinate_template_4_22_08_10`.`datasetfileresources` on((`germinate_template_4_22_08_10`.`datasetfileresources`.`dataset_id` = `germinate_template_4_22_08_10`.`datasets`.`id`))) group by `germinate_template_4_22_08_10`.`datasets`.`id`,`germinate_template_4_22_08_10`.`datasetmeta`.`id`"));
    }
