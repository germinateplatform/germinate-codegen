...
public class ViewTableDatasets extends TableImpl<ViewTableDatasetsRecord> {
    ...
    private ViewTableDatasets(Name alias, Table<ViewTableDatasetsRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.view("create view `view_table_datasets` as select `germinate_template_5_26_01_28`.`datasets`.`id` AS `dataset_id`,`germinate_template_5_26_01_28`.`datasets`.`name` AS `dataset_name`,`germinate_template_5_26_01_28`.`datasets`.`description` AS `dataset_description`,`germinate_template_5_26_01_28`.`datasets`.`hyperlink` AS `hyperlink`,`germinate_template_5_26_01_28`.`datasets`.`source_file` AS `source_file`,`germinate_template_5_26_01_28`.`datasets`.`version` AS `version`,`germinate_template_5_26_01_28`.`datasettypes`.`description` AS `dataset_type`,`germinate_template_5_26_01_28`.`experiments`.`id` AS `experiment_id`,`germinate_template_5_26_01_28`.`experiments`.`experiment_name` AS `experiment_name`,`germinate_template_5_26_01_28`.`experiments`.`description` AS `experiment_description`,`germinate_template_5_26_01_28`.`projects`.`id` AS `project_id`,`germinate_template_5_26_01_28`.`projects`.`name` AS `project_name`,`germinate_template_5_26_01_28`.`projects`.`description` AS `project_description`,`germinate_template_5_26_01_28`.`datasets`.`datatype` AS `datatype`,`germinate_template_5_26_01_28`.`datasetstates`.`name` AS `dataset_state`,(select json_arrayagg(json_object('locationId',`germinate_template_5_26_01_28`.`locations`.`id`,'locationName',`germinate_template_5_26_01_28`.`locations`.`site_name`,'locationLatitude',`germinate_template_5_26_01_28`.`locations`.`latitude`,'locationLongitude',`germinate_template_5_26_01_28`.`locations`.`longitude`,'countryId',`germinate_template_5_26_01_28`.`countries`.`id`,'countryCode',`germinate_template_5_26_01_28`.`countries`.`country_code2`)) from ((`germinate_template_5_26_01_28`.`datasetlocations` left join `germinate_template_5_26_01_28`.`locations` on((`germinate_template_5_26_01_28`.`locations`.`id` = `germinate_template_5_26_01_28`.`datasetlocations`.`location_id`))) left join `germinate_template_5_26_01_28`.`countries` on((`germinate_template_5_26_01_28`.`countries`.`id` = `germinate_template_5_26_01_28`.`locations`.`country_id`))) where ((`germinate_template_5_26_01_28`.`datasetlocations`.`dataset_id` = `germinate_template_5_26_01_28`.`datasets`.`id`) and (`germinate_template_5_26_01_28`.`locations`.`id` is not null)) group by `germinate_template_5_26_01_28`.`datasets`.`id`) AS `locations`,(select json_arrayagg(json_object('institutionId',`germinate_template_5_26_01_28`.`institutions`.`id`,'institutionName',`germinate_template_5_26_01_28`.`institutions`.`name`,'institutionCode',`germinate_template_5_26_01_28`.`institutions`.`code`,'countryId',`germinate_template_5_26_01_28`.`countries`.`id`,'countryName',`germinate_template_5_26_01_28`.`countries`.`country_code2`)) from (`germinate_template_5_26_01_28`.`institutions` left join `germinate_template_5_26_01_28`.`countries` on((`germinate_template_5_26_01_28`.`countries`.`id` = `germinate_template_5_26_01_28`.`institutions`.`country_id`))) where exists(select 1 from (`germinate_template_5_26_01_28`.`collaborators` left join `germinate_template_5_26_01_28`.`datasetcollaborators` on((`germinate_template_5_26_01_28`.`datasetcollaborators`.`collaborator_id` = `germinate_template_5_26_01_28`.`collaborators`.`id`))) where ((`germinate_template_5_26_01_28`.`datasetcollaborators`.`dataset_id` = `germinate_template_5_26_01_28`.`datasets`.`id`) and (`germinate_template_5_26_01_28`.`collaborators`.`institution_id` = `germinate_template_5_26_01_28`.`institutions`.`id`)))) AS `institutions`,`germinate_template_5_26_01_28`.`licenses`.`id` AS `license_id`,`germinate_template_5_26_01_28`.`licenses`.`name` AS `license_name`,`germinate_template_5_26_01_28`.`datasets`.`contact` AS `contact`,`germinate_template_5_26_01_28`.`datasets`.`date_start` AS `start_date`,`germinate_template_5_26_01_28`.`datasets`.`date_end` AS `end_date`,`germinate_template_5_26_01_28`.`datasets`.`dublin_core` AS `dublin_core`,`germinate_template_5_26_01_28`.`datasets`.`created_on` AS `created_on`,`germinate_template_5_26_01_28`.`datasets`.`updated_on` AS `updated_on`,`germinate_template_5_26_01_28`.`datasetmeta`.`nr_of_data_objects` AS `data_object_count`,`germinate_template_5_26_01_28`.`datasetmeta`.`nr_of_data_points` AS `data_point_count`,`germinate_template_5_26_01_28`.`datasets`.`is_external` AS `is_external`,(select count(1) from `germinate_template_5_26_01_28`.`publicationdata` where ((`germinate_template_5_26_01_28`.`publicationdata`.`foreign_id` = `germinate_template_5_26_01_28`.`datasets`.`id`) and (`germinate_template_5_26_01_28`.`publicationdata`.`reference_type` = 'dataset'))) AS `publications`,(select json_arrayagg(`germinate_template_5_26_01_28`.`datasetfileresources`.`fileresource_id`) from `germinate_template_5_26_01_28`.`datasetfileresources` where (`germinate_template_5_26_01_28`.`datasetfileresources`.`dataset_id` = `germinate_template_5_26_01_28`.`datasets`.`id`)) AS `fileresource_ids`,(select count(1) from (`germinate_template_5_26_01_28`.`collaborators` left join `germinate_template_5_26_01_28`.`datasetcollaborators` on((`germinate_template_5_26_01_28`.`collaborators`.`id` = `germinate_template_5_26_01_28`.`datasetcollaborators`.`collaborator_id`))) where (`germinate_template_5_26_01_28`.`datasetcollaborators`.`dataset_id` = `germinate_template_5_26_01_28`.`datasets`.`id`)) AS `collaborators`,(select count(1) from (`germinate_template_5_26_01_28`.`attributes` left join `germinate_template_5_26_01_28`.`attributedata` on((`germinate_template_5_26_01_28`.`attributedata`.`attribute_id` = `germinate_template_5_26_01_28`.`attributes`.`id`))) where ((`germinate_template_5_26_01_28`.`attributes`.`target_table` = 'datasets') and (`germinate_template_5_26_01_28`.`attributedata`.`foreign_id` = `germinate_template_5_26_01_28`.`datasets`.`id`))) AS `attributes`,json_arrayagg(`germinate_template_5_26_01_28`.`licenselogs`.`user_id`) AS `accepted_by` from ((((((((`germinate_template_5_26_01_28`.`datasets` left join `germinate_template_5_26_01_28`.`experiments` on((`germinate_template_5_26_01_28`.`experiments`.`id` = `germinate_template_5_26_01_28`.`datasets`.`experiment_id`))) left join `germinate_template_5_26_01_28`.`projects` on((`germinate_template_5_26_01_28`.`projects`.`id` = `germinate_template_5_26_01_28`.`experiments`.`project_id`))) left join `germinate_template_5_26_01_28`.`datasettypes` on((`germinate_template_5_26_01_28`.`datasettypes`.`id` = `germinate_template_5_26_01_28`.`datasets`.`datasettype_id`))) left join `germinate_template_5_26_01_28`.`licenses` on((`germinate_template_5_26_01_28`.`licenses`.`id` = `germinate_template_5_26_01_28`.`datasets`.`license_id`))) left join `germinate_template_5_26_01_28`.`datasetmeta` on((`germinate_template_5_26_01_28`.`datasetmeta`.`dataset_id` = `germinate_template_5_26_01_28`.`datasets`.`id`))) left join `germinate_template_5_26_01_28`.`datasetstates` on((`germinate_template_5_26_01_28`.`datasetstates`.`id` = `germinate_template_5_26_01_28`.`datasets`.`dataset_state_id`))) left join `germinate_template_5_26_01_28`.`licenselogs` on((`germinate_template_5_26_01_28`.`licenselogs`.`license_id` = `germinate_template_5_26_01_28`.`licenses`.`id`))) left join `germinate_template_5_26_01_28`.`datasetfileresources` on((`germinate_template_5_26_01_28`.`datasetfileresources`.`dataset_id` = `germinate_template_5_26_01_28`.`datasets`.`id`))) group by `germinate_template_5_26_01_28`.`datasets`.`id`,`germinate_template_5_26_01_28`.`datasetmeta`.`id`"), where);
    }
