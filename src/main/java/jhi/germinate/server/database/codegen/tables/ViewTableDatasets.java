...
public class ViewTableDatasets extends TableImpl<ViewTableDatasetsRecord> {
    ...
    /**
     * The column <code>germinate_db.view_table_datasets.fileresources</code>.
     */
    public final TableField<ViewTableDatasetsRecord, Long> FILERESOURCES = createField(DSL.name("fileresources"), SQLDataType.BIGINT, this, "");
