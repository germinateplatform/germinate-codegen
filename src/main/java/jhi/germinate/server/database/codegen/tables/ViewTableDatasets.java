...
public class ViewTableDatasets extends TableImpl<ViewTableDatasetsRecord> {
    ...
    private ViewTableDatasets(Name alias, Table<ViewTableDatasetsRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_datasets` as select `germinate_template_4_23_02_08`.`datasets`.`id` AS `dataset_id`,`germinate_template_4_23_02_08`.`datasets`.`name` AS `dataset_name`,`germinate_template_4_23_02_08`.`datasets`.`description` AS `dataset_description`,`germinate_template_4_23_02_08`.`datasets`.`hyperlink` AS `hyperlink`,`germinate_template_4_23_02_08`.`datasets`.`source_file` AS `source_file`,`germinate_template_4_23_02_08`.`datasets`.`version` AS `version`,`germinate_template_4_23_02_08`.`datasettypes`.`description` AS `dataset_type`,`germinate_template_4_23_02_08`.`experiments`.`id` AS `experiment_id`,`germinate_template_4_23_02_08`.`experiments`.`experiment_name` AS `experiment_name`,`germinate_template_4_23_02_08`.`experiments`.`description` AS `experiment_description`,`germinate_template_4_23_02_08`.`datasets`.`datatype` AS `datatype`,`germinate_template_4_23_02_08`.`datasetstates`.`name` AS `dataset_state`,(select json_arrayagg(json_object('locationId',`germinate_template_4_23_02_08`.`locations`.`id`,'locationName',`germinate_template_4_23_02_08`.`locations`.`site_name`,'locationLatitude',`germinate_template_4_23_02_08`.`locations`.`latitude`,'locationLongitude',`germinate_template_4_23_02_08`.`locations`.`longitude`,'countryId',`germinate_template_4_23_02_08`.`countries`.`id`,'countryName',`germinate_template_4_23_02_08`.`countries`.`country_code2`)) from ((`germinate_template_4_23_02_08`.`datasetlocations` left join `germinate_template_4_23_02_08`.`locations` on((`germinate_template_4_23_02_08`.`locations`.`id` = `germinate_template_4_23_02_08`.`datasetlocations`.`location_id`))) left join `germinate_template_4_23_02_08`.`countries` on((`germinate_template_4_23_02_08`.`countries`.`id` = `germinate_template_4_23_02_08`.`locations`.`country_id`))) where ((`germinate_template_4_23_02_08`.`datasetlocations`.`dataset_id` = `germinate_template_4_23_02_08`.`datasets`.`id`) and (`germinate_template_4_23_02_08`.`locations`.`id` is not null)) group by `germinate_template_4_23_02_08`.`datasets`.`id`) AS `locations`,`germinate_template_4_23_02_08`.`licenses`.`id` AS `license_id`,`germinate_template_4_23_02_08`.`licenses`.`name` AS `license_name`,`germinate_template_4_23_02_08`.`datasets`.`contact` AS `contact`,`germinate_template_4_23_02_08`.`datasets`.`date_start` AS `start_date`,`germinate_template_4_23_02_08`.`datasets`.`date_end` AS `end_date`,`germinate_template_4_23_02_08`.`datasets`.`dublin_core` AS `dublin_core`,`germinate_template_4_23_02_08`.`datasets`.`created_on` AS `created_on`,`germinate_template_4_23_02_08`.`datasets`.`updated_on` AS `updated_on`,`germinate_template_4_23_02_08`.`datasetmeta`.`nr_of_data_objects` AS `data_object_count`,`germinate_template_4_23_02_08`.`datasetmeta`.`nr_of_data_points` AS `data_point_count`,`germinate_template_4_23_02_08`.`datasets`.`is_external` AS `is_external`,(select count(1) from `germinate_template_4_23_02_08`.`publicationdata` where ((`germinate_template_4_23_02_08`.`publicationdata`.`foreign_id` = `germinate_template_4_23_02_08`.`datasets`.`id`) and (`germinate_template_4_23_02_08`.`publicationdata`.`reference_type` = 'dataset'))) AS `publications`,(select json_arrayagg(`germinate_template_4_23_02_08`.`datasetfileresources`.`fileresource_id`) from `germinate_template_4_23_02_08`.`datasetfileresources` where (`germinate_template_4_23_02_08`.`datasetfileresources`.`dataset_id` = `germinate_template_4_23_02_08`.`datasets`.`id`)) AS `fileresource_ids`,(select count(1) from (`germinate_template_4_23_02_08`.`collaborators` left join `germinate_template_4_23_02_08`.`datasetcollaborators` on((`germinate_template_4_23_02_08`.`collaborators`.`id` = `germinate_template_4_23_02_08`.`datasetcollaborators`.`collaborator_id`))) where (`germinate_template_4_23_02_08`.`datasetcollaborators`.`dataset_id` = `germinate_template_4_23_02_08`.`datasets`.`id`)) AS `collaborators`,(select count(1) from (`germinate_template_4_23_02_08`.`attributes` left join `germinate_template_4_23_02_08`.`attributedata` on((`germinate_template_4_23_02_08`.`attributedata`.`attribute_id` = `germinate_template_4_23_02_08`.`attributes`.`id`))) where ((`germinate_template_4_23_02_08`.`attributes`.`target_table` = 'datasets') and (`germinate_template_4_23_02_08`.`attributedata`.`foreign_id` = `germinate_template_4_23_02_08`.`datasets`.`id`))) AS `attributes`,json_arrayagg(`germinate_template_4_23_02_08`.`licenselogs`.`user_id`) AS `accepted_by` from (((((((`germinate_template_4_23_02_08`.`datasets` left join `germinate_template_4_23_02_08`.`experiments` on((`germinate_template_4_23_02_08`.`experiments`.`id` = `germinate_template_4_23_02_08`.`datasets`.`experiment_id`))) left join `germinate_template_4_23_02_08`.`datasettypes` on((`germinate_template_4_23_02_08`.`datasettypes`.`id` = `germinate_template_4_23_02_08`.`datasets`.`datasettype_id`))) left join `germinate_template_4_23_02_08`.`licenses` on((`germinate_template_4_23_02_08`.`licenses`.`id` = `germinate_template_4_23_02_08`.`datasets`.`license_id`))) left join `germinate_template_4_23_02_08`.`datasetmeta` on((`germinate_template_4_23_02_08`.`datasetmeta`.`dataset_id` = `germinate_template_4_23_02_08`.`datasets`.`id`))) left join `germinate_template_4_23_02_08`.`datasetstates` on((`germinate_template_4_23_02_08`.`datasetstates`.`id` = `germinate_template_4_23_02_08`.`datasets`.`dataset_state_id`))) left join `germinate_template_4_23_02_08`.`licenselogs` on((`germinate_template_4_23_02_08`.`licenselogs`.`license_id` = `germinate_template_4_23_02_08`.`licenses`.`id`))) left join `germinate_template_4_23_02_08`.`datasetfileresources` on((`germinate_template_4_23_02_08`.`datasetfileresources`.`dataset_id` = `germinate_template_4_23_02_08`.`datasets`.`id`))) group by `germinate_template_4_23_02_08`.`datasets`.`id`,`germinate_template_4_23_02_08`.`datasetmeta`.`id`"));
    }
