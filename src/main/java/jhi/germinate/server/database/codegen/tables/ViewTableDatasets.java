...
public class ViewTableDatasets extends TableImpl<ViewTableDatasetsRecord> {
    ...
    private ViewTableDatasets(Name alias, Table<ViewTableDatasetsRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.view("create view `view_table_datasets` as select `germinate_template_4_25_03_05`.`datasets`.`id` AS `dataset_id`,`germinate_template_4_25_03_05`.`datasets`.`name` AS `dataset_name`,`germinate_template_4_25_03_05`.`datasets`.`description` AS `dataset_description`,`germinate_template_4_25_03_05`.`datasets`.`hyperlink` AS `hyperlink`,`germinate_template_4_25_03_05`.`datasets`.`source_file` AS `source_file`,`germinate_template_4_25_03_05`.`datasets`.`version` AS `version`,`germinate_template_4_25_03_05`.`datasettypes`.`description` AS `dataset_type`,`germinate_template_4_25_03_05`.`experiments`.`id` AS `experiment_id`,`germinate_template_4_25_03_05`.`experiments`.`experiment_name` AS `experiment_name`,`germinate_template_4_25_03_05`.`experiments`.`description` AS `experiment_description`,`germinate_template_4_25_03_05`.`projects`.`id` AS `project_id`,`germinate_template_4_25_03_05`.`projects`.`name` AS `project_name`,`germinate_template_4_25_03_05`.`projects`.`description` AS `project_description`,`germinate_template_4_25_03_05`.`datasets`.`datatype` AS `datatype`,`germinate_template_4_25_03_05`.`datasetstates`.`name` AS `dataset_state`,(select json_arrayagg(json_object('locationId',`germinate_template_4_25_03_05`.`locations`.`id`,'locationName',`germinate_template_4_25_03_05`.`locations`.`site_name`,'locationLatitude',`germinate_template_4_25_03_05`.`locations`.`latitude`,'locationLongitude',`germinate_template_4_25_03_05`.`locations`.`longitude`,'countryId',`germinate_template_4_25_03_05`.`countries`.`id`,'countryCode',`germinate_template_4_25_03_05`.`countries`.`country_code2`)) from ((`germinate_template_4_25_03_05`.`datasetlocations` left join `germinate_template_4_25_03_05`.`locations` on((`germinate_template_4_25_03_05`.`locations`.`id` = `germinate_template_4_25_03_05`.`datasetlocations`.`location_id`))) left join `germinate_template_4_25_03_05`.`countries` on((`germinate_template_4_25_03_05`.`countries`.`id` = `germinate_template_4_25_03_05`.`locations`.`country_id`))) where ((`germinate_template_4_25_03_05`.`datasetlocations`.`dataset_id` = `germinate_template_4_25_03_05`.`datasets`.`id`) and (`germinate_template_4_25_03_05`.`locations`.`id` is not null)) group by `germinate_template_4_25_03_05`.`datasets`.`id`) AS `locations`,(select json_arrayagg(json_object('institutionId',`germinate_template_4_25_03_05`.`institutions`.`id`,'institutionName',`germinate_template_4_25_03_05`.`institutions`.`name`,'institutionCode',`germinate_template_4_25_03_05`.`institutions`.`code`,'countryId',`germinate_template_4_25_03_05`.`countries`.`id`,'countryName',`germinate_template_4_25_03_05`.`countries`.`country_code2`)) from (`germinate_template_4_25_03_05`.`institutions` left join `germinate_template_4_25_03_05`.`countries` on((`germinate_template_4_25_03_05`.`countries`.`id` = `germinate_template_4_25_03_05`.`institutions`.`country_id`))) where exists(select 1 from (`germinate_template_4_25_03_05`.`collaborators` left join `germinate_template_4_25_03_05`.`datasetcollaborators` on((`germinate_template_4_25_03_05`.`datasetcollaborators`.`collaborator_id` = `germinate_template_4_25_03_05`.`collaborators`.`id`))) where ((`germinate_template_4_25_03_05`.`datasetcollaborators`.`dataset_id` = `germinate_template_4_25_03_05`.`datasets`.`id`) and (`germinate_template_4_25_03_05`.`collaborators`.`institution_id` = `germinate_template_4_25_03_05`.`institutions`.`id`)))) AS `institutions`,`germinate_template_4_25_03_05`.`licenses`.`id` AS `license_id`,`germinate_template_4_25_03_05`.`licenses`.`name` AS `license_name`,`germinate_template_4_25_03_05`.`datasets`.`contact` AS `contact`,`germinate_template_4_25_03_05`.`datasets`.`date_start` AS `start_date`,`germinate_template_4_25_03_05`.`datasets`.`date_end` AS `end_date`,`germinate_template_4_25_03_05`.`datasets`.`dublin_core` AS `dublin_core`,`germinate_template_4_25_03_05`.`datasets`.`created_on` AS `created_on`,`germinate_template_4_25_03_05`.`datasets`.`updated_on` AS `updated_on`,`germinate_template_4_25_03_05`.`datasetmeta`.`nr_of_data_objects` AS `data_object_count`,`germinate_template_4_25_03_05`.`datasetmeta`.`nr_of_data_points` AS `data_point_count`,`germinate_template_4_25_03_05`.`datasets`.`is_external` AS `is_external`,(select count(1) from `germinate_template_4_25_03_05`.`publicationdata` where ((`germinate_template_4_25_03_05`.`publicationdata`.`foreign_id` = `germinate_template_4_25_03_05`.`datasets`.`id`) and (`germinate_template_4_25_03_05`.`publicationdata`.`reference_type` = 'dataset'))) AS `publications`,(select json_arrayagg(`germinate_template_4_25_03_05`.`datasetfileresources`.`fileresource_id`) from `germinate_template_4_25_03_05`.`datasetfileresources` where (`germinate_template_4_25_03_05`.`datasetfileresources`.`dataset_id` = `germinate_template_4_25_03_05`.`datasets`.`id`)) AS `fileresource_ids`,(select count(1) from (`germinate_template_4_25_03_05`.`collaborators` left join `germinate_template_4_25_03_05`.`datasetcollaborators` on((`germinate_template_4_25_03_05`.`collaborators`.`id` = `germinate_template_4_25_03_05`.`datasetcollaborators`.`collaborator_id`))) where (`germinate_template_4_25_03_05`.`datasetcollaborators`.`dataset_id` = `germinate_template_4_25_03_05`.`datasets`.`id`)) AS `collaborators`,(select count(1) from (`germinate_template_4_25_03_05`.`attributes` left join `germinate_template_4_25_03_05`.`attributedata` on((`germinate_template_4_25_03_05`.`attributedata`.`attribute_id` = `germinate_template_4_25_03_05`.`attributes`.`id`))) where ((`germinate_template_4_25_03_05`.`attributes`.`target_table` = 'datasets') and (`germinate_template_4_25_03_05`.`attributedata`.`foreign_id` = `germinate_template_4_25_03_05`.`datasets`.`id`))) AS `attributes`,json_arrayagg(`germinate_template_4_25_03_05`.`licenselogs`.`user_id`) AS `accepted_by` from ((((((((`germinate_template_4_25_03_05`.`datasets` left join `germinate_template_4_25_03_05`.`experiments` on((`germinate_template_4_25_03_05`.`experiments`.`id` = `germinate_template_4_25_03_05`.`datasets`.`experiment_id`))) left join `germinate_template_4_25_03_05`.`projects` on((`germinate_template_4_25_03_05`.`projects`.`id` = `germinate_template_4_25_03_05`.`experiments`.`project_id`))) left join `germinate_template_4_25_03_05`.`datasettypes` on((`germinate_template_4_25_03_05`.`datasettypes`.`id` = `germinate_template_4_25_03_05`.`datasets`.`datasettype_id`))) left join `germinate_template_4_25_03_05`.`licenses` on((`germinate_template_4_25_03_05`.`licenses`.`id` = `germinate_template_4_25_03_05`.`datasets`.`license_id`))) left join `germinate_template_4_25_03_05`.`datasetmeta` on((`germinate_template_4_25_03_05`.`datasetmeta`.`dataset_id` = `germinate_template_4_25_03_05`.`datasets`.`id`))) left join `germinate_template_4_25_03_05`.`datasetstates` on((`germinate_template_4_25_03_05`.`datasetstates`.`id` = `germinate_template_4_25_03_05`.`datasets`.`dataset_state_id`))) left join `germinate_template_4_25_03_05`.`licenselogs` on((`germinate_template_4_25_03_05`.`licenselogs`.`license_id` = `germinate_template_4_25_03_05`.`licenses`.`id`))) left join `germinate_template_4_25_03_05`.`datasetfileresources` on((`germinate_template_4_25_03_05`.`datasetfileresources`.`dataset_id` = `germinate_template_4_25_03_05`.`datasets`.`id`))) group by `germinate_template_4_25_03_05`.`datasets`.`id`,`germinate_template_4_25_03_05`.`datasetmeta`.`id`"), where);
    }
