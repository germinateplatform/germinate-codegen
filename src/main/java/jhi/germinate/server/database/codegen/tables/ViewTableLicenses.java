...
public class ViewTableLicenses extends TableImpl<ViewTableLicensesRecord> {
    ...
    private ViewTableLicenses(Name alias, Table<ViewTableLicensesRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_licenses` as select `germinate_template_4_24_10_07`.`licenses`.`id` AS `license_id`,`germinate_template_4_24_10_07`.`licenses`.`name` AS `license_name`,`germinate_template_4_24_10_07`.`licenses`.`description` AS `license_description`,json_objectagg(`germinate_template_4_24_10_07`.`locales`.`name`,`germinate_template_4_24_10_07`.`licensedata`.`content`) AS `license_content`,`germinate_template_4_24_10_07`.`datasets`.`id` AS `dataset_id`,json_arrayagg(`germinate_template_4_24_10_07`.`licenselogs`.`user_id`) AS `accepted_by` from ((((`germinate_template_4_24_10_07`.`licenses` left join `germinate_template_4_24_10_07`.`licensedata` on((`germinate_template_4_24_10_07`.`licensedata`.`license_id` = `germinate_template_4_24_10_07`.`licenses`.`id`))) left join `germinate_template_4_24_10_07`.`locales` on((`germinate_template_4_24_10_07`.`locales`.`id` = `germinate_template_4_24_10_07`.`licensedata`.`locale_id`))) left join `germinate_template_4_24_10_07`.`datasets` on((`germinate_template_4_24_10_07`.`datasets`.`license_id` = `germinate_template_4_24_10_07`.`licenses`.`id`))) left join `germinate_template_4_24_10_07`.`licenselogs` on((`germinate_template_4_24_10_07`.`licenselogs`.`license_id` = `germinate_template_4_24_10_07`.`licenses`.`id`))) group by `germinate_template_4_24_10_07`.`licenses`.`id`,`germinate_template_4_24_10_07`.`datasets`.`id`"));
    }
