...
public class ViewTableLicenses extends TableImpl<ViewTableLicensesRecord> {
    ...
    private ViewTableLicenses(Name alias, Table<ViewTableLicensesRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_licenses` as select `germinate_template_4_22_05_04`.`licenses`.`id` AS `license_id`,`germinate_template_4_22_05_04`.`licenses`.`name` AS `license_name`,`germinate_template_4_22_05_04`.`licenses`.`description` AS `license_description`,`germinate_template_4_22_05_04`.`licensedata`.`content` AS `license_content`,`germinate_template_4_22_05_04`.`locales`.`name` AS `locale_name`,`germinate_template_4_22_05_04`.`locales`.`description` AS `locale_description`,`germinate_template_4_22_05_04`.`datasets`.`id` AS `dataset_id`,json_arrayagg(`germinate_template_4_22_05_04`.`licenselogs`.`user_id`) AS `accepted_by` from ((((`germinate_template_4_22_05_04`.`licenses` left join `germinate_template_4_22_05_04`.`licensedata` on((`germinate_template_4_22_05_04`.`licensedata`.`license_id` = `germinate_template_4_22_05_04`.`licenses`.`id`))) left join `germinate_template_4_22_05_04`.`locales` on((`germinate_template_4_22_05_04`.`locales`.`id` = `germinate_template_4_22_05_04`.`licensedata`.`locale_id`))) left join `germinate_template_4_22_05_04`.`datasets` on((`germinate_template_4_22_05_04`.`datasets`.`license_id` = `germinate_template_4_22_05_04`.`licenses`.`id`))) left join `germinate_template_4_22_05_04`.`licenselogs` on((`germinate_template_4_22_05_04`.`licenselogs`.`license_id` = `germinate_template_4_22_05_04`.`licenses`.`id`))) group by `germinate_template_4_22_05_04`.`licenses`.`id`,`germinate_template_4_22_05_04`.`locales`.`id`,`germinate_template_4_22_05_04`.`licensedata`.`id`,`germinate_template_4_22_05_04`.`datasets`.`id`"));
    }
