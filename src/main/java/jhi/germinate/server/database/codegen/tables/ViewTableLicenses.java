...
public class ViewTableLicenses extends TableImpl<ViewTableLicensesRecord> {
    ...
    private ViewTableLicenses(Name alias, Table<ViewTableLicensesRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.view("create view `view_table_licenses` as select `germinate_template_5_26_08_13`.`licenses`.`id` AS `license_id`,`germinate_template_5_26_08_13`.`licenses`.`name` AS `license_name`,`germinate_template_5_26_08_13`.`licenses`.`description` AS `license_description`,json_objectagg(`germinate_template_5_26_08_13`.`locales`.`name`,`germinate_template_5_26_08_13`.`licensedata`.`content`) AS `license_content`,`germinate_template_5_26_08_13`.`datasets`.`id` AS `dataset_id`,json_arrayagg(`germinate_template_5_26_08_13`.`licenselogs`.`user_id`) AS `accepted_by` from ((((`germinate_template_5_26_08_13`.`licenses` left join `germinate_template_5_26_08_13`.`licensedata` on((`germinate_template_5_26_08_13`.`licensedata`.`license_id` = `germinate_template_5_26_08_13`.`licenses`.`id`))) left join `germinate_template_5_26_08_13`.`locales` on((`germinate_template_5_26_08_13`.`locales`.`id` = `germinate_template_5_26_08_13`.`licensedata`.`locale_id`))) left join `germinate_template_5_26_08_13`.`datasets` on((`germinate_template_5_26_08_13`.`datasets`.`license_id` = `germinate_template_5_26_08_13`.`licenses`.`id`))) left join `germinate_template_5_26_08_13`.`licenselogs` on((`germinate_template_5_26_08_13`.`licenselogs`.`license_id` = `germinate_template_5_26_08_13`.`licenses`.`id`))) group by `germinate_template_5_26_08_13`.`licenses`.`id`,`germinate_template_5_26_08_13`.`datasets`.`id`"), where);
    }
