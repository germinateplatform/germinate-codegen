...
public class ViewTableInstitutionDatasets extends TableImpl<ViewTableInstitutionDatasetsRecord> {
    ...
    private ViewTableInstitutionDatasets(Name alias, Table<ViewTableInstitutionDatasetsRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.view("create view `view_table_institution_datasets` as select `germinate_template_5_26_01_28`.`institutions`.`id` AS `institution_id`,`germinate_template_5_26_01_28`.`institutions`.`code` AS `institution_code`,`germinate_template_5_26_01_28`.`institutions`.`name` AS `institution_name`,`germinate_template_5_26_01_28`.`institutions`.`acronym` AS `institution_acronym`,`germinate_template_5_26_01_28`.`countries`.`country_name` AS `country_name`,`germinate_template_5_26_01_28`.`countries`.`country_code2` AS `country_code2`,`germinate_template_5_26_01_28`.`countries`.`country_code3` AS `country_code3`,`germinate_template_5_26_01_28`.`institutions`.`contact` AS `institution_contact`,`germinate_template_5_26_01_28`.`institutions`.`phone` AS `institution_phone`,`germinate_template_5_26_01_28`.`institutions`.`email` AS `institution_email`,`germinate_template_5_26_01_28`.`institutions`.`address` AS `institution_address`,(select json_arrayagg(`d`.`id`) from `germinate_template_5_26_01_28`.`datasets` `d` where exists(select 1 from (`germinate_template_5_26_01_28`.`datasetcollaborators` `dc` left join `germinate_template_5_26_01_28`.`collaborators` `c` on((`c`.`id` = `dc`.`collaborator_id`))) where ((`dc`.`dataset_id` = `d`.`id`) and (`c`.`institution_id` = `germinate_template_5_26_01_28`.`institutions`.`id`)))) AS `all_dataset_ids`,(select json_arrayagg(`d`.`id`) from `germinate_template_5_26_01_28`.`datasets` `d` where (exists(select 1 from (`germinate_template_5_26_01_28`.`datasetcollaborators` `dc` left join `germinate_template_5_26_01_28`.`collaborators` `c` on((`c`.`id` = `dc`.`collaborator_id`))) where ((`dc`.`dataset_id` = `d`.`id`) and (`c`.`institution_id` = `germinate_template_5_26_01_28`.`institutions`.`id`))) and (`d`.`datasettype_id` = 3))) AS `trials_dataset_ids`,(select json_arrayagg(`d`.`id`) from `germinate_template_5_26_01_28`.`datasets` `d` where (exists(select 1 from (`germinate_template_5_26_01_28`.`datasetcollaborators` `dc` left join `germinate_template_5_26_01_28`.`collaborators` `c` on((`c`.`id` = `dc`.`collaborator_id`))) where ((`dc`.`dataset_id` = `d`.`id`) and (`c`.`institution_id` = `germinate_template_5_26_01_28`.`institutions`.`id`))) and (`d`.`datasettype_id` = 1))) AS `genotype_dataset_ids`,(select json_arrayagg(`d`.`id`) from `germinate_template_5_26_01_28`.`datasets` `d` where (exists(select 1 from (`germinate_template_5_26_01_28`.`datasetcollaborators` `dc` left join `germinate_template_5_26_01_28`.`collaborators` `c` on((`c`.`id` = `dc`.`collaborator_id`))) where ((`dc`.`dataset_id` = `d`.`id`) and (`c`.`institution_id` = `germinate_template_5_26_01_28`.`institutions`.`id`))) and (`d`.`datasettype_id` = 5))) AS `climate_dataset_ids`,(select json_arrayagg(`d`.`id`) from `germinate_template_5_26_01_28`.`datasets` `d` where (exists(select 1 from (`germinate_template_5_26_01_28`.`datasetcollaborators` `dc` left join `germinate_template_5_26_01_28`.`collaborators` `c` on((`c`.`id` = `dc`.`collaborator_id`))) where ((`dc`.`dataset_id` = `d`.`id`) and (`c`.`institution_id` = `germinate_template_5_26_01_28`.`institutions`.`id`))) and (`d`.`datasettype_id` = 7))) AS `pedigree_dataset_ids` from (`germinate_template_5_26_01_28`.`institutions` left join `germinate_template_5_26_01_28`.`countries` on((`germinate_template_5_26_01_28`.`countries`.`id` = `germinate_template_5_26_01_28`.`institutions`.`country_id`))) having (`all_dataset_ids` is not null)"), where);
    }
    ...
    @Override
    public ViewTableInstitutionDatasets as(Table<?> alias) {
        return new ViewTableInstitutionDatasets(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public ViewTableInstitutionDatasets rename(Table<?> name) {
        return new ViewTableInstitutionDatasets(name.getQualifiedName(), null);
    }
     ...
     */
    @Override
    public ViewTableInstitutionDatasets where(Condition condition) {
        return new ViewTableInstitutionDatasets(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public ViewTableInstitutionDatasets where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public ViewTableInstitutionDatasets where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public ViewTableInstitutionDatasets where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public ViewTableInstitutionDatasets where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public ViewTableInstitutionDatasets where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public ViewTableInstitutionDatasets where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public ViewTableInstitutionDatasets where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public ViewTableInstitutionDatasets whereExists(Select<?> select) {
     ...
     */
    @Override
    public ViewTableInstitutionDatasets whereNotExists(Select<?> select) {
