...
public class ViewTableClimates extends TableImpl<ViewTableClimatesRecord> {
    ...
    private ViewTableClimates(Name alias, Table<ViewTableClimatesRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_climates` as select `germinate_template_4_25_01_14`.`climates`.`id` AS `climate_id`,`germinate_template_4_25_01_14`.`climates`.`name` AS `climate_name`,`germinate_template_4_25_01_14`.`climates`.`short_name` AS `climate_name_short`,`germinate_template_4_25_01_14`.`climates`.`description` AS `climate_description`,`germinate_template_4_25_01_14`.`climates`.`datatype` AS `data_type`,`germinate_template_4_25_01_14`.`units`.`id` AS `unit_id`,`germinate_template_4_25_01_14`.`units`.`unit_name` AS `unit_name`,`germinate_template_4_25_01_14`.`units`.`unit_description` AS `unit_description`,(select count(1) from `germinate_template_4_25_01_14`.`mapoverlays` where ((`germinate_template_4_25_01_14`.`mapoverlays`.`reference_table` = 'climates') and (`germinate_template_4_25_01_14`.`mapoverlays`.`foreign_id` = `germinate_template_4_25_01_14`.`climates`.`id`))) AS `overlays`,`germinate_template_4_25_01_14`.`units`.`unit_abbreviation` AS `unit_abbreviation`,(select count(1) from `germinate_template_4_25_01_14`.`climatedata` where (`germinate_template_4_25_01_14`.`climatedata`.`climate_id` = `germinate_template_4_25_01_14`.`climates`.`id`)) AS `count` from (`germinate_template_4_25_01_14`.`climates` left join `germinate_template_4_25_01_14`.`units` on((`germinate_template_4_25_01_14`.`units`.`id` = `germinate_template_4_25_01_14`.`climates`.`unit_id`))) group by `germinate_template_4_25_01_14`.`climates`.`id`"));
    }
