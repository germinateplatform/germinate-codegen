...
public class ViewTableClimates extends TableImpl<ViewTableClimatesRecord> {
    ...
    /**
     * The column <code>germinate_db.view_table_climates.climate_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_climates.climate_name</code>. Describes the climate.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_climates.climate_name_short</code>. Shortened version of the climate name which is used in some table headers.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_climates.climate_description</code>. A longer description of the climate.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_climates.unit_name</code>. The name of the unit. This should be the name of the unit in full.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_climates.unit_description</code>. A description of the unit. If the unit is not a standard SI unit then it is beneficial to have a description which explains what the unit it, how it is derived and any other information which would help identifiy it.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_climates.unit_abbreviation</code>. This should be the unit abbreviation.
     */
    ...
    /**
     * Create an aliased <code>germinate_db.view_table_climates</code> table reference
     */
