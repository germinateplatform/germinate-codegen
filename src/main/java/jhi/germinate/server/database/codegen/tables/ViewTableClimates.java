...
public class ViewTableClimates extends TableImpl<ViewTableClimatesRecord> {
    ...
    @Override
    public ViewTableClimates as(Table<?> alias) {
        return new ViewTableClimates(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public ViewTableClimates rename(Table<?> name) {
        return new ViewTableClimates(name.getQualifiedName(), null);
    }
     ...
     */
    @Override
    public ViewTableClimates where(Condition condition) {
        return new ViewTableClimates(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public ViewTableClimates where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public ViewTableClimates where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public ViewTableClimates where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public ViewTableClimates where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public ViewTableClimates where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public ViewTableClimates where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public ViewTableClimates where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public ViewTableClimates whereExists(Select<?> select) {
     ...
     */
    @Override
    public ViewTableClimates whereNotExists(Select<?> select) {
