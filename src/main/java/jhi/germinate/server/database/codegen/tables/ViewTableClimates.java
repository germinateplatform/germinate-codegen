...
public class ViewTableClimates extends TableImpl<ViewTableClimatesRecord> {
    ...
    private ViewTableClimates(Name alias, Table<ViewTableClimatesRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_climates` as select `germinate_template_4_22_08_18`.`climates`.`id` AS `climate_id`,`germinate_template_4_22_08_18`.`climates`.`name` AS `climate_name`,`germinate_template_4_22_08_18`.`climates`.`short_name` AS `climate_name_short`,`germinate_template_4_22_08_18`.`climates`.`description` AS `climate_description`,`germinate_template_4_22_08_18`.`climates`.`datatype` AS `data_type`,`germinate_template_4_22_08_18`.`units`.`id` AS `unit_id`,`germinate_template_4_22_08_18`.`units`.`unit_name` AS `unit_name`,`germinate_template_4_22_08_18`.`units`.`unit_description` AS `unit_description`,(select count(1) from `germinate_template_4_22_08_18`.`climateoverlays` where (`germinate_template_4_22_08_18`.`climateoverlays`.`climate_id` = `germinate_template_4_22_08_18`.`climates`.`id`)) AS `overlays`,`germinate_template_4_22_08_18`.`units`.`unit_abbreviation` AS `unit_abbreviation`,(select count(1) from `germinate_template_4_22_08_18`.`climatedata` where (`germinate_template_4_22_08_18`.`climatedata`.`climate_id` = `germinate_template_4_22_08_18`.`climates`.`id`)) AS `count` from (`germinate_template_4_22_08_18`.`climates` left join `germinate_template_4_22_08_18`.`units` on((`germinate_template_4_22_08_18`.`units`.`id` = `germinate_template_4_22_08_18`.`climates`.`unit_id`))) group by `germinate_template_4_22_08_18`.`climates`.`id`"));
    }
