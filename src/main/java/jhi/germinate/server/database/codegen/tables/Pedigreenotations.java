...
public class Pedigreenotations extends TableImpl<PedigreenotationsRecord> {
    ...
    private static final long serialVersionUID = -135096490;
    ...
    /**
     * The column <code>germinate_db.pedigreenotations.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.pedigreenotations.name</code>. Name of the reference notation source.
     */
    ...
    /**
     * The column <code>germinate_db.pedigreenotations.description</code>. A longer description about the reference notation source.
     */
    ...
    /**
     * The column <code>germinate_db.pedigreenotations.reference_url</code>. Hyperlink to the notation source.
     */
    ...
    /**
     * The column <code>germinate_db.pedigreenotations.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.pedigreenotations.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Create an aliased <code>germinate_db.pedigreenotations</code> table reference
     */
    ...
    public Identity<PedigreenotationsRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Pedigreenotations.PEDIGREENOTATIONS, jhi.germinate.server.database.codegen.tables.Pedigreenotations.PEDIGREENOTATIONS.ID);
    }
    ...
    public UniqueKey<PedigreenotationsRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Pedigreenotations.PEDIGREENOTATIONS, "KEY_pedigreenotations_PRIMARY", jhi.germinate.server.database.codegen.tables.Pedigreenotations.PEDIGREENOTATIONS.ID);
    }
    ...
    public List<UniqueKey<PedigreenotationsRecord>> getKeys() {
        return Arrays.<UniqueKey<PedigreenotationsRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Pedigreenotations.PEDIGREENOTATIONS, "KEY_pedigreenotations_PRIMARY", jhi.germinate.server.database.codegen.tables.Pedigreenotations.PEDIGREENOTATIONS.ID)
        );
    }
