...
public class ViewStatsBiologicalstatus extends TableImpl<ViewStatsBiologicalstatusRecord> {
    ...
    private ViewStatsBiologicalstatus(Name alias, Table<ViewStatsBiologicalstatusRecord> aliased, Field<?>[] parameters, Condition where) {
        super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.view("create view `view_stats_biologicalstatus` as select substring_index(`germinate_template_5_26_08_13`.`biologicalstatus`.`sampstat`,' (',1) AS `biologicalstatus`,`germinate_template_5_26_08_13`.`taxonomies`.`genus` AS `genus`,count(1) AS `count` from (((`germinate_template_5_26_08_13`.`mcpd` left join `germinate_template_5_26_08_13`.`biologicalstatus` on((`germinate_template_5_26_08_13`.`mcpd`.`sampstat` = `germinate_template_5_26_08_13`.`biologicalstatus`.`id`))) left join `germinate_template_5_26_08_13`.`germinatebase` on((`germinate_template_5_26_08_13`.`germinatebase`.`id` = `germinate_template_5_26_08_13`.`mcpd`.`germinatebase_id`))) left join `germinate_template_5_26_08_13`.`taxonomies` on((`germinate_template_5_26_08_13`.`taxonomies`.`id` = `germinate_template_5_26_08_13`.`germinatebase`.`taxonomy_id`))) group by `germinate_template_5_26_08_13`.`biologicalstatus`.`id`,`germinate_template_5_26_08_13`.`taxonomies`.`genus` having (`biologicalstatus` is not null) order by `germinate_template_5_26_08_13`.`taxonomies`.`genus` desc,`count` desc"), where);
    }
