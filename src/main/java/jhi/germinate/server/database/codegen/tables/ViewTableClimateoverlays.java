...
public class ViewTableClimateoverlays extends TableImpl<ViewTableClimateoverlaysRecord> {
    ...
    private static final long serialVersionUID = -1229562013;

    /**
     * The reference instance of <code>germinate_db.view_table_climateoverlays</code>
     */
    ...
    /**
     * The column <code>germinate_db.view_table_climateoverlays.climate_overlay_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_climateoverlays.climate_id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_climateoverlays.climate_name</code>. Describes the climate.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_climateoverlays.is_legend</code>. The legend for the image. What colours represent in the overlays. This is not required but used if present. 
     */
    ...
    /**
     * The column <code>germinate_db.view_table_climateoverlays.bottom_left_latitude</code>. Allows the allignment of images against OpenStreetMap API.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_climateoverlays.bottom_left_longitude</code>. Allows the allignment of images against OpenStreetMap API.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_climateoverlays.top_right_latitude</code>. Allows the allignment of images against OpenStreetMap API.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_climateoverlays.top_right_longitude</code>. Allows the allignment of images against OpenStreetMap API.
     */
    ...
    /**
     * The column <code>germinate_db.view_table_climateoverlays.filename</code>. This is the path for holding images which can be used as overlays for the Google Maps representation in Germinate. The path is relative.
     */
    ...
    /**
     * Create a <code>germinate_db.view_table_climateoverlays</code> table reference
     */
    ...
    /**
     * Create an aliased <code>germinate_db.view_table_climateoverlays</code> table reference
     */
