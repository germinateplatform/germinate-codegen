...
public class ViewTableClimateoverlays extends TableImpl<ViewTableClimateoverlaysRecord> {
    ...
    private ViewTableClimateoverlays(Name alias, Table<ViewTableClimateoverlaysRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_climateoverlays` as select `germinate_template_4_22_05_04`.`climateoverlays`.`id` AS `climate_overlay_id`,`germinate_template_4_22_05_04`.`climates`.`id` AS `climate_id`,`germinate_template_4_22_05_04`.`climates`.`name` AS `climate_name`,`germinate_template_4_22_05_04`.`climateoverlays`.`is_legend` AS `is_legend`,`germinate_template_4_22_05_04`.`climateoverlays`.`bottom_left_latitude` AS `bottom_left_latitude`,`germinate_template_4_22_05_04`.`climateoverlays`.`bottom_left_longitude` AS `bottom_left_longitude`,`germinate_template_4_22_05_04`.`climateoverlays`.`top_right_latitude` AS `top_right_latitude`,`germinate_template_4_22_05_04`.`climateoverlays`.`top_right_longitude` AS `top_right_longitude`,`germinate_template_4_22_05_04`.`climateoverlays`.`path` AS `filename` from (`germinate_template_4_22_05_04`.`climateoverlays` left join `germinate_template_4_22_05_04`.`climates` on((`germinate_template_4_22_05_04`.`climates`.`id` = `germinate_template_4_22_05_04`.`climateoverlays`.`climate_id`)))"));
    }
