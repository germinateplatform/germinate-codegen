...
public class ExperimentsRecord extends UpdatableRecordImpl<ExperimentsRecord> implements Record7<Integer, String, Integer, String, Date, Timestamp, Timestamp> {
    ...
    private static final long serialVersionUID = 1147702738;

    /**
     * Setter for <code>germinate_db.experiments.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Getter for <code>germinate_db.experiments.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Setter for <code>germinate_db.experiments.experiment_name</code>. The name of the experiment.
     */
    ...
    /**
     * Getter for <code>germinate_db.experiments.experiment_name</code>. The name of the experiment.
     */
    ...
    /**
     * Setter for <code>germinate_db.experiments.user_id</code>. Foreign key to Gatekeeper users (Gatekeeper users.id).
    ...
    /**
     * Getter for <code>germinate_db.experiments.user_id</code>. Foreign key to Gatekeeper users (Gatekeeper users.id).
    ...
    /**
     * Setter for <code>germinate_db.experiments.description</code>. Describes the experiment.
     */
    ...
    /**
     * Getter for <code>germinate_db.experiments.description</code>. Describes the experiment.
     */
    ...
    /**
     * Setter for <code>germinate_db.experiments.experiment_date</code>. The date that the experiment was carried out.
     */
    ...
    /**
     * Getter for <code>germinate_db.experiments.experiment_date</code>. The date that the experiment was carried out.
     */
    ...
    /**
     * Setter for <code>germinate_db.experiments.created_on</code>. When the record was created.
     */
    ...
    /**
     * Getter for <code>germinate_db.experiments.created_on</code>. When the record was created.
     */
    ...
    /**
     * Setter for <code>germinate_db.experiments.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Getter for <code>germinate_db.experiments.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
