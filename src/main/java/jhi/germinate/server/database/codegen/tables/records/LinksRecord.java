...
public class LinksRecord extends UpdatableRecordImpl<LinksRecord> implements Record8<Integer, Integer, Integer, String, String, Boolean, Timestamp, Timestamp> {
    ...
    private static final long serialVersionUID = 588073653;

    /**
     * Setter for <code>germinate_db.links.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Getter for <code>germinate_db.links.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * Setter for <code>germinate_db.links.linktype_id</code>. Foreign key to linktypes (linktypes.id).
     */
    ...
    /**
     * Getter for <code>germinate_db.links.linktype_id</code>. Foreign key to linktypes (linktypes.id).
     */
    ...
    /**
     * Setter for <code>germinate_db.links.hyperlink</code>. The actual hyperlink.
     */
    ...
    /**
     * Getter for <code>germinate_db.links.hyperlink</code>. The actual hyperlink.
     */
    ...
    /**
     * Setter for <code>germinate_db.links.description</code>. A description of the link.
     */
    ...
    /**
     * Getter for <code>germinate_db.links.description</code>. A description of the link.
     */
    ...
    /**
     * Setter for <code>germinate_db.links.visibility</code>. Determines if the link is visible or not: {0, 1}
     */
    ...
    /**
     * Getter for <code>germinate_db.links.visibility</code>. Determines if the link is visible or not: {0, 1}
     */
    ...
    /**
     * Setter for <code>germinate_db.links.created_on</code>. When the record was created.
     */
    ...
    /**
     * Getter for <code>germinate_db.links.created_on</code>. When the record was created.
     */
    ...
    /**
     * Setter for <code>germinate_db.links.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Getter for <code>germinate_db.links.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
