...
public class Usergroupmembers extends TableImpl<UsergroupmembersRecord> {
    ...
    private static final long serialVersionUID = -565628803;
    ...
    /**
     * The column <code>germinate_db.usergroupmembers.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.usergroupmembers.updated_on</code>. When the record was updated. This may be different from the created on date if changes have been made subsequently to the underlying record.
     */
    ...
    /**
     * Create an aliased <code>germinate_db.usergroupmembers</code> table reference
     */
    ...
    public Identity<UsergroupmembersRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Usergroupmembers.USERGROUPMEMBERS, jhi.germinate.server.database.codegen.tables.Usergroupmembers.USERGROUPMEMBERS.ID);
    }
    ...
    public UniqueKey<UsergroupmembersRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Usergroupmembers.USERGROUPMEMBERS, "KEY_usergroupmembers_PRIMARY", jhi.germinate.server.database.codegen.tables.Usergroupmembers.USERGROUPMEMBERS.ID);
    }
    ...
    public List<UniqueKey<UsergroupmembersRecord>> getKeys() {
        return Arrays.<UniqueKey<UsergroupmembersRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Usergroupmembers.USERGROUPMEMBERS, "KEY_usergroupmembers_PRIMARY", jhi.germinate.server.database.codegen.tables.Usergroupmembers.USERGROUPMEMBERS.ID)
        );
    }
