...
public class Locationtypes extends TableImpl<LocationtypesRecord> {
    ...
    private static final long serialVersionUID = 894029707;
    ...
    /**
     * The column <code>germinate_db.locationtypes.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.locationtypes.name</code>. The name of the location type. 
     */
    ...
    /**
     * The column <code>germinate_db.locationtypes.description</code>. A description of the location type.
     */
    ...
    /**
     * The column <code>germinate_db.locationtypes.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.locationtypes.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    public Identity<LocationtypesRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Locationtypes.LOCATIONTYPES, jhi.germinate.server.database.codegen.tables.Locationtypes.LOCATIONTYPES.ID);
    }
    ...
    public UniqueKey<LocationtypesRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Locationtypes.LOCATIONTYPES, "KEY_locationtypes_PRIMARY", jhi.germinate.server.database.codegen.tables.Locationtypes.LOCATIONTYPES.ID);
    }
    ...
    public List<UniqueKey<LocationtypesRecord>> getKeys() {
        return Arrays.<UniqueKey<LocationtypesRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Locationtypes.LOCATIONTYPES, "KEY_locationtypes_PRIMARY", jhi.germinate.server.database.codegen.tables.Locationtypes.LOCATIONTYPES.ID)
        );
    }
