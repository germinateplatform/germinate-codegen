...
public class ViewTableFileresourcesRecord extends TableRecordImpl<ViewTableFileresourcesRecord> implements Record10<Integer, String, String, String, Long, Timestamp, Timestamp, Integer, String, String> {
    ...
    private static final long serialVersionUID = -1892293749;

    /**
     * Setter for <code>germinate_db.view_table_fileresources.fileresource_id</code>. The primary id.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_fileresources.fileresource_id</code>. The primary id.
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_fileresources.fileresource_name</code>. The name of the file resource.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_fileresources.fileresource_name</code>. The name of the file resource.
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_fileresources.fileresource_path</code>. The file name of the actual data file.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_fileresources.fileresource_path</code>. The file name of the actual data file.
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_fileresources.fileresource_description</code>. A description of the file contents.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_fileresources.fileresource_description</code>. A description of the file contents.
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_fileresources.fileresource_size</code>. The file size in bytes.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_fileresources.fileresource_size</code>. The file size in bytes.
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_fileresources.fileresource_created_on</code>. When this record was created.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_fileresources.fileresource_created_on</code>. When this record was created.
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_fileresources.fileresource_updated_on</code>. When this record was last updated.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_fileresources.fileresource_updated_on</code>. When this record was last updated.
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_fileresources.fileresourcetype_id</code>. The primary id.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_fileresources.fileresourcetype_id</code>. The primary id.
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_fileresources.fileresourcetype_name</code>. The name of the file type.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_fileresources.fileresourcetype_name</code>. The name of the file type.
     */
    ...
    /**
     * Setter for <code>germinate_db.view_table_fileresources.fileresourcetype_description</code>. The description of the file type.
     */
    ...
    /**
     * Getter for <code>germinate_db.view_table_fileresources.fileresourcetype_description</code>. The description of the file type.
     */
