...
public class ViewTableCollaborators extends TableImpl<ViewTableCollaboratorsRecord> {
    ...
    private ViewTableCollaborators(Name alias, Table<ViewTableCollaboratorsRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_collaborators` as select `germinate_template_4_22_08_23`.`collaborators`.`id` AS `collaborator_id`,`germinate_template_4_22_08_23`.`collaborators`.`first_name` AS `collaborator_first_name`,`germinate_template_4_22_08_23`.`collaborators`.`last_name` AS `collaborator_last_name`,`germinate_template_4_22_08_23`.`collaborators`.`external_id` AS `collaborator_external_id`,`germinate_template_4_22_08_23`.`collaborators`.`email` AS `collaborator_email`,`germinate_template_4_22_08_23`.`collaborators`.`phone` AS `collaborator_phone`,`germinate_template_4_22_08_23`.`datasetcollaborators`.`collaborator_roles` AS `collaborator_roles`,`germinate_template_4_22_08_23`.`institutions`.`id` AS `institution_id`,`germinate_template_4_22_08_23`.`institutions`.`name` AS `institution_name`,`germinate_template_4_22_08_23`.`institutions`.`address` AS `institution_address`,`germinate_template_4_22_08_23`.`datasets`.`id` AS `dataset_id`,`germinate_template_4_22_08_23`.`countries`.`id` AS `country_id`,`germinate_template_4_22_08_23`.`countries`.`country_name` AS `country_name`,`germinate_template_4_22_08_23`.`countries`.`country_code2` AS `country_code2`,`germinate_template_4_22_08_23`.`countries`.`country_code3` AS `country_code3` from ((((`germinate_template_4_22_08_23`.`collaborators` left join `germinate_template_4_22_08_23`.`institutions` on((`germinate_template_4_22_08_23`.`institutions`.`id` = `germinate_template_4_22_08_23`.`collaborators`.`institution_id`))) left join `germinate_template_4_22_08_23`.`countries` on((`germinate_template_4_22_08_23`.`countries`.`id` = `germinate_template_4_22_08_23`.`institutions`.`country_id`))) left join `germinate_template_4_22_08_23`.`datasetcollaborators` on((`germinate_template_4_22_08_23`.`datasetcollaborators`.`collaborator_id` = `germinate_template_4_22_08_23`.`collaborators`.`id`))) left join `germinate_template_4_22_08_23`.`datasets` on((`germinate_template_4_22_08_23`.`datasets`.`id` = `germinate_template_4_22_08_23`.`datasetcollaborators`.`dataset_id`)))"));
    }
