...
public class ViewTableCollaborators extends TableImpl<ViewTableCollaboratorsRecord> {
    ...
    private ViewTableCollaborators(Name alias, Table<ViewTableCollaboratorsRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_collaborators` as select `germinate_template_4_22_09_02`.`collaborators`.`id` AS `collaborator_id`,`germinate_template_4_22_09_02`.`collaborators`.`first_name` AS `collaborator_first_name`,`germinate_template_4_22_09_02`.`collaborators`.`last_name` AS `collaborator_last_name`,`germinate_template_4_22_09_02`.`collaborators`.`external_id` AS `collaborator_external_id`,`germinate_template_4_22_09_02`.`collaborators`.`email` AS `collaborator_email`,`germinate_template_4_22_09_02`.`collaborators`.`phone` AS `collaborator_phone`,`germinate_template_4_22_09_02`.`datasetcollaborators`.`collaborator_roles` AS `collaborator_roles`,`germinate_template_4_22_09_02`.`institutions`.`id` AS `institution_id`,`germinate_template_4_22_09_02`.`institutions`.`name` AS `institution_name`,`germinate_template_4_22_09_02`.`institutions`.`address` AS `institution_address`,`germinate_template_4_22_09_02`.`datasets`.`id` AS `dataset_id`,`germinate_template_4_22_09_02`.`countries`.`id` AS `country_id`,`germinate_template_4_22_09_02`.`countries`.`country_name` AS `country_name`,`germinate_template_4_22_09_02`.`countries`.`country_code2` AS `country_code2`,`germinate_template_4_22_09_02`.`countries`.`country_code3` AS `country_code3` from ((((`germinate_template_4_22_09_02`.`collaborators` left join `germinate_template_4_22_09_02`.`institutions` on((`germinate_template_4_22_09_02`.`institutions`.`id` = `germinate_template_4_22_09_02`.`collaborators`.`institution_id`))) left join `germinate_template_4_22_09_02`.`countries` on((`germinate_template_4_22_09_02`.`countries`.`id` = `germinate_template_4_22_09_02`.`institutions`.`country_id`))) left join `germinate_template_4_22_09_02`.`datasetcollaborators` on((`germinate_template_4_22_09_02`.`datasetcollaborators`.`collaborator_id` = `germinate_template_4_22_09_02`.`collaborators`.`id`))) left join `germinate_template_4_22_09_02`.`datasets` on((`germinate_template_4_22_09_02`.`datasets`.`id` = `germinate_template_4_22_09_02`.`datasetcollaborators`.`dataset_id`)))"));
    }
