...
public class ViewTableCollaborators extends TableImpl<ViewTableCollaboratorsRecord> {
    ...
    private ViewTableCollaborators(Name alias, Table<ViewTableCollaboratorsRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_collaborators` as select `germinate_template_4_22_05_04`.`collaborators`.`id` AS `collaborator_id`,`germinate_template_4_22_05_04`.`collaborators`.`first_name` AS `collaborator_first_name`,`germinate_template_4_22_05_04`.`collaborators`.`last_name` AS `collaborator_last_name`,`germinate_template_4_22_05_04`.`collaborators`.`external_id` AS `collaborator_external_id`,`germinate_template_4_22_05_04`.`collaborators`.`email` AS `collaborator_email`,`germinate_template_4_22_05_04`.`collaborators`.`phone` AS `collaborator_phone`,`germinate_template_4_22_05_04`.`datasetcollaborators`.`collaborator_roles` AS `collaborator_roles`,`germinate_template_4_22_05_04`.`institutions`.`id` AS `institution_id`,`germinate_template_4_22_05_04`.`institutions`.`name` AS `institution_name`,`germinate_template_4_22_05_04`.`institutions`.`address` AS `institution_address`,`germinate_template_4_22_05_04`.`datasets`.`id` AS `dataset_id`,`germinate_template_4_22_05_04`.`countries`.`id` AS `country_id`,`germinate_template_4_22_05_04`.`countries`.`country_name` AS `country_name`,`germinate_template_4_22_05_04`.`countries`.`country_code2` AS `country_code2`,`germinate_template_4_22_05_04`.`countries`.`country_code3` AS `country_code3` from ((((`germinate_template_4_22_05_04`.`collaborators` left join `germinate_template_4_22_05_04`.`institutions` on((`germinate_template_4_22_05_04`.`institutions`.`id` = `germinate_template_4_22_05_04`.`collaborators`.`institution_id`))) left join `germinate_template_4_22_05_04`.`countries` on((`germinate_template_4_22_05_04`.`countries`.`id` = `germinate_template_4_22_05_04`.`institutions`.`country_id`))) left join `germinate_template_4_22_05_04`.`datasetcollaborators` on((`germinate_template_4_22_05_04`.`datasetcollaborators`.`collaborator_id` = `germinate_template_4_22_05_04`.`collaborators`.`id`))) left join `germinate_template_4_22_05_04`.`datasets` on((`germinate_template_4_22_05_04`.`datasets`.`id` = `germinate_template_4_22_05_04`.`datasetcollaborators`.`dataset_id`)))"));
    }
