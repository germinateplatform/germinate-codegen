...
public class ViewTableCollaborators extends TableImpl<ViewTableCollaboratorsRecord> {
    ...
    private ViewTableCollaborators(Name alias, Table<ViewTableCollaboratorsRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("VIEW"), TableOptions.view("create view `view_table_collaborators` as select `germinate_template_4_24_10_07`.`collaborators`.`id` AS `collaborator_id`,`germinate_template_4_24_10_07`.`collaborators`.`first_name` AS `collaborator_first_name`,`germinate_template_4_24_10_07`.`collaborators`.`last_name` AS `collaborator_last_name`,`germinate_template_4_24_10_07`.`collaborators`.`external_id` AS `collaborator_external_id`,`germinate_template_4_24_10_07`.`collaborators`.`email` AS `collaborator_email`,`germinate_template_4_24_10_07`.`collaborators`.`phone` AS `collaborator_phone`,`germinate_template_4_24_10_07`.`datasetcollaborators`.`collaborator_roles` AS `collaborator_roles`,`germinate_template_4_24_10_07`.`institutions`.`id` AS `institution_id`,`germinate_template_4_24_10_07`.`institutions`.`name` AS `institution_name`,`germinate_template_4_24_10_07`.`institutions`.`address` AS `institution_address`,`germinate_template_4_24_10_07`.`datasets`.`id` AS `dataset_id`,`germinate_template_4_24_10_07`.`countries`.`id` AS `country_id`,`germinate_template_4_24_10_07`.`countries`.`country_name` AS `country_name`,`germinate_template_4_24_10_07`.`countries`.`country_code2` AS `country_code2`,`germinate_template_4_24_10_07`.`countries`.`country_code3` AS `country_code3`,(select json_arrayagg(`germinate_template_4_24_10_07`.`projectcollaborators`.`project_id`) from `germinate_template_4_24_10_07`.`projectcollaborators` where (`germinate_template_4_24_10_07`.`projectcollaborators`.`collaborator_id` = `germinate_template_4_24_10_07`.`collaborators`.`id`) group by `germinate_template_4_24_10_07`.`projectcollaborators`.`collaborator_id`) AS `project_ids` from ((((`germinate_template_4_24_10_07`.`collaborators` left join `germinate_template_4_24_10_07`.`institutions` on((`germinate_template_4_24_10_07`.`institutions`.`id` = `germinate_template_4_24_10_07`.`collaborators`.`institution_id`))) left join `germinate_template_4_24_10_07`.`countries` on((`germinate_template_4_24_10_07`.`countries`.`id` = `germinate_template_4_24_10_07`.`institutions`.`country_id`))) left join `germinate_template_4_24_10_07`.`datasetcollaborators` on((`germinate_template_4_24_10_07`.`datasetcollaborators`.`collaborator_id` = `germinate_template_4_24_10_07`.`collaborators`.`id`))) left join `germinate_template_4_24_10_07`.`datasets` on((`germinate_template_4_24_10_07`.`datasets`.`id` = `germinate_template_4_24_10_07`.`datasetcollaborators`.`dataset_id`)))"));
    }
