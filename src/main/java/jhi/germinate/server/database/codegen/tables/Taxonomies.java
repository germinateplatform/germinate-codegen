...
public class Taxonomies extends TableImpl<TaxonomiesRecord> {
    ...
    private static final long serialVersionUID = -1864895752;
    ...
    /**
     * The column <code>germinate_db.taxonomies.id</code>. Primary id for this table. This uniquely identifies the row.
     */
    ...
    /**
     * The column <code>germinate_db.taxonomies.genus</code>. Genus name for the species.
     */
    ...
    /**
     * The column <code>germinate_db.taxonomies.species</code>. Species name in lowercase.
     */
    ...
    /**
     * The column <code>germinate_db.taxonomies.species_author</code>. also known as spauthor in the Multi Crop Passport Descriptors (MCPD V2 2012). Describes the authority for the species name.
     */
    ...
    /**
     * The column <code>germinate_db.taxonomies.subtaxa_author</code>. also known as subtauthor in the Multi Crop Passport Descriptors (MCPD V2 2012).
     */
    ...
    /**
     * The column <code>germinate_db.taxonomies.cropname</code>. The name of the crop. This should be the common name. Examples would include barley, maize, wheat, rice and so on.
     */
    ...
    /**
     * The column <code>germinate_db.taxonomies.ploidy</code>. Defines the ploidy level for the species. Use numbers to reference ploidy for example diploid = 2, tetraploid = 4.
     */
    ...
    /**
     * The column <code>germinate_db.taxonomies.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.taxonomies.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    public Identity<TaxonomiesRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Taxonomies.TAXONOMIES, jhi.germinate.server.database.codegen.tables.Taxonomies.TAXONOMIES.ID);
    }
    ...
    public UniqueKey<TaxonomiesRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Taxonomies.TAXONOMIES, "KEY_taxonomies_PRIMARY", jhi.germinate.server.database.codegen.tables.Taxonomies.TAXONOMIES.ID);
    }
    ...
    public List<UniqueKey<TaxonomiesRecord>> getKeys() {
        return Arrays.<UniqueKey<TaxonomiesRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Taxonomies.TAXONOMIES, "KEY_taxonomies_PRIMARY", jhi.germinate.server.database.codegen.tables.Taxonomies.TAXONOMIES.ID)
        );
    }
