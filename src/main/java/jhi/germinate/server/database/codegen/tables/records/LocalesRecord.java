...
public class LocalesRecord extends UpdatableRecordImpl<LocalesRecord> implements Record5<Integer, String, String, Timestamp, Timestamp> {
    ...
    private static final long serialVersionUID = 982675313;
    ...
    /**
     * Setter for <code>germinate_db.locales.created_on</code>. When the record was created.
     */
    ...
    /**
     * Getter for <code>germinate_db.locales.created_on</code>. When the record was created.
     */
    ...
    /**
     * Setter for <code>germinate_db.locales.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
    ...
    /**
     * Getter for <code>germinate_db.locales.updated_on</code>. When the record was updated. This may be different from the created on date if subsequent changes have been made to the underlying record.
     */
