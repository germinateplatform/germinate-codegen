...
public class Usergroups extends TableImpl<UsergroupsRecord> {
    ...
    private static final long serialVersionUID = 1050355156;
    ...
    /**
     * The column <code>germinate_db.usergroups.name</code>. The name of the user group.
     */
    ...
    /**
     * The column <code>germinate_db.usergroups.description</code>. A description of the user group.
     */
    ...
    /**
     * The column <code>germinate_db.usergroups.created_on</code>. When the record was created.
     */
    ...
    /**
     * The column <code>germinate_db.usergroups.updated_on</code>. When the record was updated. This may be different from the created on date if changes have been made subsequently to the underlying record.
     */
    ...
    public Identity<UsergroupsRecord, Integer> getIdentity() {
        return Internal.createIdentity(jhi.germinate.server.database.codegen.tables.Usergroups.USERGROUPS, jhi.germinate.server.database.codegen.tables.Usergroups.USERGROUPS.ID);
    }
    ...
    public UniqueKey<UsergroupsRecord> getPrimaryKey() {
        return Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Usergroups.USERGROUPS, "KEY_usergroups_PRIMARY", jhi.germinate.server.database.codegen.tables.Usergroups.USERGROUPS.ID);
    }
    ...
    public List<UniqueKey<UsergroupsRecord>> getKeys() {
        return Arrays.<UniqueKey<UsergroupsRecord>>asList(
              Internal.createUniqueKey(jhi.germinate.server.database.codegen.tables.Usergroups.USERGROUPS, "KEY_usergroups_PRIMARY", jhi.germinate.server.database.codegen.tables.Usergroups.USERGROUPS.ID)
        );
    }
